...
export const substanceName = "Tetrazepam";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Tetrazepam.json","displayName":"Protest Kit","size":3468},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Tetrazepam.md","displayName":"TripSit Factsheets","size":686},{"id":"wikipedia","fileName":"WIKIPEDIA - Tetrazepam.md","displayName":"Wikipedia","size":5807}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/tetrazepam",
  "experiencesUrl": "https://www.reddit.com/search/?q=Tetrazepam",
  "name": "Tetrazepam",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# Tetrazepam
*Source: TripSit Factsheets (tripsit.me)*

## Summary

A benzodiazepine that has anticonvulsant, anxiolytic, muscle relaxant, and slightly hypnotic properties. The drug was taken off the market in 2013 due to cutaneous toxicity and allergic reactions, among other reasons. The drug has been noted to be more euphoric than similar ones of it's type.
...
*Source: https://en.wikipedia.org/wiki/Tetrazepam*
