...
export const substanceName = "LSD";
export const sources = [{"id":"disregardeverythingisay","fileName":"DISREGARDEVERYTHINGISAY - LSD.md","displayName":"DEIA","size":11378},{"id":"dmturner","fileName":"DMTURNER - LSD.md","displayName":"D.M. Turner","size":12939},{"id":"drugbank","fileName":"DRUGBANK - LSD.md","displayName":"DrugBank","size":14514},{"id":"drugusersbible","fileName":"DRUGUSERSBIBLE - LSD.md","displayName":"Drug Users Bible","size":3998},{"id":"erowid","fileName":"EROWID - LSD.md","displayName":"Erowid","size":43578},{"id":"isomerdesign","fileName":"ISOMERDESIGN - LSD.md","displayName":"Isomer Design","size":33921},{"id":"protestkit","fileName":"PROTESTKIT - LSD.json","displayName":"Protest Kit","size":5401},{"id":"psychonautwiki","fileName":"PSYCHONAUTWIKI - LSD.md","displayName":"PsychonautWiki","size":133892},{"id":"saferparty","fileName":"SAFERPARTY - LSD.md","displayName":"Safer Party","size":3784},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - LSD.md","displayName":"TripSit Factsheets","size":1817},{"id":"tripsit-wiki","fileName":"TRIPSIT_WIKI - LSD.md","displayName":"TripSit Wiki","size":5146},{"id":"wikipedia","fileName":"WIKIPEDIA - LSD.md","displayName":"Wikipedia","size":70312}];
export const contents: Record<string, string> = {
  "disregardeverythingisay": `# LSD
*Source: https://disregardeverythingisay.com/post/34000922763/lsd-broken-down-and-described*

*Disregard Everything I Say - LSD, broken down and described*
...
The LSD experience contains a complex and wide array of effects which based on the predefined potential subjective effects index found [here](http://psychonautwiki.org/wiki/Subjective_effects_index), I will now begin to breakdown and describe.
...
- **Visual drifting** (*Melting, Breathing, Morphing and Flowing*) - In comparison to other psychedelics, this effect can be described as highly detailed yet cartoon in its appearance. The distortions are slow and smooth in motion and fleeting in their appearance.
- **Tracers**
- **After images**
- **Texture repetition**
- **Colour shifting**
...
The visual geometry that is present throughout this trip can be described as more similar in appearance to that of 2C-B and the 2C-x family as a whole than psilocin, LSA, or DMT. They can be comprehensively described as unstructured in their organization, algorithmic and digital in geometric style, intricate in complexity, large in size, fast and smooth in motion, multicoloured in scheme, bright and flat in colour, and sharp in their edges with extremely angular corners. At higher dosages they consistently result in states of Level 7A visual geometry.
...
The auditory effects of LSD are common in their occurrence and exhibit a full range of effects which commonly include:
...
Similar to other psychedelic drugs, there are relatively few physical side effects associated with LSD acute exposure. Various studies have shown that in reasonable doses in a careful context, it presents no negative cognitive, psychiatric, or toxic physical consequences of any sort. The median lethal dose or dosage at which 50% of participants die (LD50) of LSD for human beings has never been reached in any setting and is predicted to be roughly 12,000 micrograms, based on studies involving rats whereas the active dosage is between 100 and 500 micrograms. This means that assuming a person has unusually potent tabs, each of which are 200 micrograms in strength each, they would have to consume at least 60 of them to reach a potentially lethal dosage. Keep in mind that your average tab of LSD found on the street is 100 micrograms or less in strength and anything stronger than this is particularly rare.

It’s important to note that LSD is non habit-forming and that the desire to use it can actually decrease with use, it is most often self-regulating. You also build an almost immediate tolerance to LSD after ingestion, preventing you from experiencing its full effects more often than every 4-7 days (unless you increase your dose significantly). 

**Legal Issues:**

- LSD is Schedule I in the United States according to the Controlled Substances Act of 1970.[112] This means LSD is illegal to manufacture, buy, possess, process, or distribute without a DEA license.
- In Canada, LSD is a controlled substance under Schedule III of the Controlled Drugs and Substances Act. Any person who is found in possession of LSD is entitled to imprisonment for a term not exceeding 3 years. Possession for purpose of trafficking is an indictable offense punishable by imprisonment for 10 years.
- In the United Kingdom, LSD is a class ‘A’ drug. This means possession of the drug without a license is punishable with 7 years imprisonment and/or an unlimited fine, and trafficking is punishable with life imprisonment and an unlimited fine.

The United Nations Convention on Psychotropic Substances (adopted in 1971) requires its parties to prohibit LSD. Hence, it is illegal in all parties to the convention, which include the United States, Australia, New Zealand, and most of Europe. However, enforcement of extant laws varies from country to country. Medical and scientific research with LSD in humans is permitted under the 1971 UN Convention.

If you want to try LSD you will have to find it through a street dealer or order it online through many various vendors which I can not legally ever mention the name of.

**Reader submitted trip reports:**

- [300ug - the pyramid universe](http://psychonautwiki.org/wiki/Experience:300ug_-_the_pyramid_universe) by *[Anonymous](http://psychonautwiki.org/wiki/Anonymous)*
- [300ug - Profound religious experience](http://psychonautwiki.org/wiki/Experience:300ug_-_Profound_religious_experience) by *[Oscarette](http://psychonautwiki.org/wiki/User:Oscarette)*
- [5 tabs with weed and nitrous oxide - A lovers ego death](http://psychonautwiki.org/wiki/Experience:5_tabs_with_weed_and_nitrous_oxide_-_A_lovers_ego_death) by *[Anonymous](http://psychonautwiki.org/wiki/Anonymous)*
- [4x 200ug tabs - You do not need to understand](http://psychonautwiki.org/wiki/Experience:4x_200ug_tabs_-_You_do_not_need_to_understand) by *[Gregasaurus](http://psychonautwiki.org/wiki/User:Gregasaurus)*
- [unknown dosage - My experiences with LSD and anorexia/bulemia](http://psychonautwiki.org/wiki/Experience:Unknown_dosage_-_My_experiences_with_LSD_and_anorexia/bulemia) by *[Anonymous](http://psychonautwiki.org/wiki/Anonymous)*
- [2 x 150 LSD tabs](http://psychonautwiki.org/wiki/Experience:2_x_150_LSD_tabs) by *[Anonymous](http://psychonautwiki.org/wiki/Anonymous)*

**Conclusion:**

LSD was the first psychedelic I ever tried and the first psychedelic I ever fully explored. It has benefited me and the people around me in so many personal ways through its deep states of introspection. It is amazingly therapeutic but eventually loses its novelty due to its complete lack of hallucinatory states and consistent unchanging visuals in a way that other psychedelics such as mushrooms simply do not.

LSD is a psychedelic that eventually loses its magic, becoming something which can be better enjoyed as an enhancer of recreational activities. Thanks to its long lasting, stimulating and euphoric nature, it is probably the best psychedelic for this purpose.

Click **[here](http://psychonautwiki.org/wiki/LSD)** for a more comprehensive breakdown.`,
  "dmturner": `# LSD
...
3 to 7 for most experiences.

### MATERIAL

LSD is a synthetic compound. It is
derived from Iysergic acid which is found in Hawaiian Woodrose and Morning
Glory seeds, or Ergot fungus, which can grow on rye, wheat, and other grams.
Lysergic acid is also psychoactive, although not nearly as potent as LSD,
and has been consumed for millennia in the form of the above mentioned
plant sources. The most common street name for LSD is "acid."
### HISTORY

LSD was first synthesized in 1938
by Dr. Albert Hofmann of Sandoz Pharmaceutical Company in Switzerland.
Hofmann was also the first human to experience LSD when he inadvertently
absorbed some through his fingertips in 1943. Three days later he took
the first intentional dose of LSD.
During the next 20 years LSD was promoted
as a psychiatric aid and numerous experiments were performed in clinical
settings. The CIA and other covert agencies were likewise experimenting
with LSD to determine its effectiveness in brainwashing and mind control.
In the early Sixties Timothy Leary
and friends began spreading the word that LSD produces magnificent spiritual
experiences. The revolution that sprang from this is legendary. It has
had a major impact on western culture, its music and art, and has contributed
to the expanded acceptance of different philosophies, religions, and lifestyles
in our country, as well as to the development of a high tech information
society [1].
### DOSAGE

LSD is extremely potent by weight
and the amount required for a single dose is barely visible to the naked
eye. LSD is usually sold on blotter paper, in tablets, or in liquid. With
all of these forms it is impossible to tell the amount of LSD one is actually
consuming. Frequently people will say that each dose contains 100 mcg.,
200 mcg., etc. But unless they've worked with the solid crystalline substance
to produce the consumable form, their information is just hearsay or a
personal estimate. Even after many years and several hundred doses of LSD,
I have never had an accurate gauge to measure dosage. My description of
dosage levels is an estimate from what I've been told over the years, matched
up to levels of intensity described by users of Sandoz LSD which was packaged
in certified amounts.
100 mcg. of LSD is considered a minimum
psychedelic dose. (one microgram (mcg.) = one millionth of a gram.) This
amount should produce a low-level psychedelic experience, not overwhelming,
and without hallucinations. 200 mcg. is the minimum dose required to produce
a full psychedelic experience, complete with visuals and hallucinations,
although it will take most people more than 200 mcg. to experience these
full effects. The average dose of acid on the streets these days is in
the 50 to 100 mcg. range.
The amount of LSD required to break
into a full-on psychedelic state varies with each individual, and even
each experience. As one gains familiarity with the experience it is likely
that they will require a larger dose to achieve a "transformational state."
I typically take about 500 mcg. and estimate my larger doses to be in the
1000+ mcg. range, and I've heard of people taking much more than that.
Other factors such as the amount of food in one's stomach will affect the
intensity of LSD and most other psychedelics, dosing on an empty stomach
producing the stronger experience. Like most other psychedelics, LSD produces
a tolerance lasting two or three days. Consuming an equivalent amount during
this period will not get one as high the second time.
Larger doses make it more likely that
one will have a full blown trip, but sometimes the intensity can be too
much and feel like neural overload. (By the end of many high-dose acid
trips I've wished I could turn down the intensity level of my senses.)
The next section explains more about the range of LSD experiences.
### THE HIGH

Ecstatic feelings of love and happiness,
affinity for other people, feeling of being at home with one's self and
the universe, flowing visions with more intricacy, beauty, and color than
anything found in nature, sound which one can taste and feel with heart
and soul, a sense of suspension in time and feeling akin with eternity
and infinity, a brilliantly lucid mind able to see itself from vast and
novel perspectives, an overwhelming tide of emotions... These are the feelings
that are common with LSD and most other psychedelics. One should also be
prepared for the negative side: confusion, frightful visions and images,
fear of dying or losing control, feeling controlled by and unable to escape
from the definitions one has grown accustomed to, or being overwhelmed
by the immensity of life.
The possible experiences on psychedelics
are endless, and no two are ever the same. In the definitions I give for
"THE HIGH" of each substance, I will try to describe the attributes
that are frequently felt and distinguish the experiences produced by the
different psychedelics.
LSD is the most transparent of the
psychedelics. It has the least "signature" to it. Most users report that
their first few trips are like a ride through the funhouse. Everything
seems bizarre and completely unlike normal reality. After becoming familiar
with the experience some people drop acid to perform complex computer programming,
perform live music on stage, or do other tasks that require control and
a strong connection with the physical plane. Frequent users may be able
to blink their eyes, snap out of the high, and see things as they do in
regular consciousness while on the peak of a 500 mcg. trip.
LSD's transparency makes it possible
to have almost any type of experience. Users may guide themselves toward
a particular flavor of experience using either internal focus, like meditation,
or external stimulus like music or art. LSD's intensity is also quite variable.
A 200 mcg. trip may feel more intense than a 500 mcg. trip from the same
batch, and intensity can fade in and out during a session. Generally one
will feel "higher" if taking the same amount of LSD, or any other psychedelic,
in an unfamiliar environment. One aspect of dosage that seems consistent
is the length of the trip. 100 mcg. Iasts me 5 to 6 hours, 200 mcg. - 8
to 10 hours, large doses have lasted up to 20 hours.
LSD has the ability of allowing one's
mind to penetrate things very deeply. I find this most prevalent listening
to music, looking at artwork, or making love. With LSD one can "lock on"
to something like a piece of music and allow it to guide them on a sensual
journey through a garden of liquid sound. One can lavish a feeling, thought
pattern, or emotion with similar intensity. It's also possible to latch
on to negative feelings. If one finds themself on a downward spiral they
can usually redirect their awareness to something else with little effort.
Most people tend to spend the majority of their experience in a positive
groove, because once in it they can remain there effortlessly for hours.
The negative aspects of LSD's signature that many users report are a "
metallic edge " (a slight grating on the nerves), and sometimes an overbearing
intensity that some psychedelics, such as mushrooms, tend not to produce.
To get an idea of how diverse LSD experiences
can be, (or psychedelic experiences in general) I've listed several publications
in the bibliography that contain lucid descriptions of powerful experiences.
One such description that I've included here is the first LSD experience
of Stanislav Grof. Stan Grof became one of the premier psychiatric LSD
researchers during the early Sixties. His current non-drug therapy, known
as Holotropic Breathwork, has produced powerful "transpersonal" experiences
in many people. Following is Grof's description of his first LSD experience
in 1956 [2].
"I couldn't believe how much I learned
about my psyche in those few hours. I experienced a fantastic display of
colorful visions, some abstract and geometrical, others figurative and
filled with symbolic import. The sheer intensity of the array of emotions
I felt simply amazed me. I was hit by a radiance that seemed comparable
to the epicenter of a nuclear explosion, or perhaps the light of supernatural
brilliance said in oriental scriptures to appear to us at the moment of
death. This thunderbolt catapulted me out of my body. First I lost my awareness
of my immediate surroundings, then the psychiatric clinic, then Prague
(Czechoslovakia), and finally the planet. At an inconceivable speed my
consciousness expanded to cosmic dimensions. I experienced the Big Bang,
passed through black holes and white holes in the universe, identified
with exploding supernovas, and witnessed many other strange phenomena that
seemed to be pulsars, quasars, and other cosmic events."
During his LSD session Grof instantaneously
grasped that the experience he was having resembled those described in
the great mystical scriptures of the world. "I was able to see the irony
and paradox of the situation. The divine manifested itself and took me
over in a modern scientific laboratory in the middle of a scientific experiment
conducted in a communist country with a substance produced in the test
tube of a 20th-century chemist."
Occasionally with large doses of LSD,
and less frequently with other psychedelics, one will encounter what is
known as the "Clear Light" or "White Light." This is perceived as a supernaturally
brilliant and blazing pure light which radiates from within. The feeling
which accompanies being in the presence of the Clear Light is almost always
described as divine bliss. The experience of the Clear Light can only be
attained by going through a full ego death. This process is described in
detail in the book The Psychedelic Experience.
### COMBINATIONS

HARMALA ALKALOIDS - Harmala
will add a unique dimension to an acid experience. I find that it infuses
the trip with a mystical and ancient quality. While on acid I normally
feel like I'm interfacing with my own mind, but with Harmala it feels like
I'm in contact with the invisible world of Spirits. An even greater degree
of synergism exists between Harmala and the tryptamine psychedelics, psilocybin
and DMT.
DMT - I've had some powerfully
enlightening experiences smoking N,N-DMT while on acid. The DMT
experience overwhelms the acid experience during its short duration. I
usually find myself immersed in the flowing, intricate visuals which are
characteristic of DMT. The acid essentially puts me on a higher platform
for launching into the DMT. And the "open mind" state produced by the acid
allows me to experience the DMT that much more. See the chapter on DMT.
NITROUS OXIDE - A blast of nitrous
usually puts me in a pleasurable, altered state of mind, this is amplified
if I'm already high. A single breath of nitrous, as is generally consumed
for recreational use, will produce a one to two minute "disassociative"
state, during which I feel somewhat out of my body. I have found that nitrous
works well with every psychedelic I've tried it with. It can put an additional
peak in my peak, or it can be used to "break up" a state of mind so I can
switch my focus to something else.
LUDIOMIL - I got inspiration
to try LSD with Ludiomil (an anti-depressant) after reading an article
in Psychedelic Monographs and Essays where the experimenter reported
having lucid dreams after using this combination. This perked my interest
as I've been a practitioner of lucid dreaming for the past few years.
The experience was quite enjoyable
and exceeded my expectations. During the experience I found that Ludiomil
nearly doubled the strength of the acid, while slightly altering the experience.
I felt as though there was a thin invisible membrane between myself and
anything my senses touched upon. This felt novel but did not allow me to
feel completely "merged with the experience" as is common while on acid.
My thought flow also seemed a bit different including what felt like "bleed
through" from the dream state.
I didn't experience anything unusual
during my sleep the first night. But on the next night I had some 25 to
30 highly vivid dreams. I continued having these vivid dreams, in decreasing
numbers, for the next three or four nights. One point to note here is that
the dreams I experienced, although quite vivid, did not fit the definition
of Lucid Dreams as defined by Stephen LaBerge or others in the Lucid
Dreaming field. LaBerge uses Lucid Dream to mean a dream in which you are
aware that you are dreaming, frequently have access to the memories of
your normal waking consciousness, and may be able to manipulate the events
in your dream.
See the Ecstasy
and Multiple Combinations chapters.
1. See Gentleman's Quarterly,
July 1991.
2. See Yoga Journal July/August 1990`,
  "drugbank": `# Lysergic acid diethylamide
*Source: https://go.drugbank.com/drugs/DB04829*
...
1,2-Benzodiazepine
The risk or severity of CNS depression can be increased when Lysergic acid diethylamide is combined with 1,2-Benzodiazepine.
Abametapir
The serum concentration of Lysergic acid diethylamide can be increased when it is combined with Abametapir.
Abatacept
The metabolism of Lysergic acid diethylamide can be increased when combined with Abatacept.
Abiraterone
The metabolism of Lysergic acid diethylamide can be decreased when combined with Abiraterone.
Acebutolol
Acebutolol may increase the vasoconstricting activities of Lysergic acid diethylamide.
...
**IUPAC Name:** (4R,7R)-N,N-diethyl-6-methyl-6,11-diazatetracyclo[7.6.1.0^{2,7}.0^{12,16}]hexadeca-1(16),2,9,12,14-pentaene-4-carboxamide
...
organic heterotetracyclic compound, monocarboxylic acid amide, ergoline alkaloid (
CHEBI:6605
)
/
Indole alkaloids (
...
GREINER T, BURCH NR, EDELBERG R: Psychopathology and psychophysiology of minimal LSD-25 dosage; a preliminary dosage-response spectrum. AMA Arch Neurol Psychiatry. 1958 Feb;79(2):208-10. [
Article
]
AGHAJANIAN GK, BING OH: PERSISTENCE OF LYSERGIC ACID DIETHYLAMIDE IN THE PLASMA OF HUMAN SUBJECTS. Clin Pharmacol Ther. 1964 Sep-Oct;5:611-4. [
Article
]
Papac DI, Foltz RL: Measurement of lysergic acid diethylamide (LSD) in human plasma by gas chromatography/negative ion chemical ionization mass spectrometry. J Anal Toxicol. 1990 May-Jun;14(3):189-90. [
Article
]
Nichols DE: Hallucinogens. Pharmacol Ther. 2004 Feb;101(2):131-81. [
Article
]
Jacobs BL, Heym J, Rasmussen K: Raphe neurons: firing rate correlates with size of drug response. Eur J Pharmacol. 1983 Jun 3;90(2-3):275-8. [
Article
]
...
GC-MS Spectrum - EI-B
GC-MS
splash10-00di-2974000000-f1e2685ff289086cda8e
Mass Spectrum (Electron Ionization)
MS
splash10-00di-1894000000-61a7a87f966b104602ec
Predicted MS/MS Spectrum - 10V, Positive (Annotated)
Predicted LC-MS/MS
splash10-00di-0029000000-76da022d959c61a78f5b
Predicted MS/MS Spectrum - 10V, Negative (Annotated)
Predicted LC-MS/MS
splash10-00di-0009000000-4c48c43c81071adec5cd
Predicted MS/MS Spectrum - 20V, Positive (Annotated)
Predicted LC-MS/MS
splash10-0fk9-0094000000-80d967ead8b660e91345
Predicted MS/MS Spectrum - 20V, Negative (Annotated)
Predicted LC-MS/MS
splash10-00di-6059000000-6daf4093b958b1579630
Predicted MS/MS Spectrum - 40V, Positive (Annotated)
Predicted LC-MS/MS
splash10-00ur-1590000000-b78d73ba46f8d510788d
Predicted MS/MS Spectrum - 40V, Negative (Annotated)
Predicted LC-MS/MS
splash10-05fr-2190000000-ad326adff9154565c790
...
*Section 2.2.19 - CHEMSCAPE: A Chemical Journey*
...
Famously discovered by Albert Hoffman in 1938, the recreational use of LSD
exploded in the 1960’s. It was central to the counterculture revolution, having a
profound influence which spanned far beyond art and music, and eventually touched
most facets of society.

Its value in the fields of psychiatry and psychology as an agent to alleviate human
misery was quickly established. Countless studies emerged as research flourished,
particularly across the United States.

This all came to an abrupt end, courtesy of Richard Milhous Nixon and the war on
drugs. Indeed, LSD was made an initial and prime target. Research was
unceremoniously halted, thousands were imprisoned and psychedelic study and
exploration was driven underground.

My own experience with LSD unfolded during the folly of youth. I managed to
acquire two blotters, and consumed one of them on a clear warm Sunday afternoon. I
remained indoors waiting for something to happen.

After an indeterminate period of time I deemed that the blotter must have been a
dud, and I swallowed the second. Within perhaps ten minutes a trip started to
materialise. My immediate reaction was to panic: what if this was the first blotter
taking effect?

Fortunately, after being informed that I was an idiot, I was reassured by my less than
impressed sitter, and I calmed down considerably.

My recollections are somewhat vague, but a fascination with various shapes, patterns
and materials was memorable. I also recall that there was some horn present at one
point. More radical was my experience when I was eventually taken on an evening
walk.

The perspective was something akin to the dollhouse effect, in which the exterior
appeared to be so tranquil that I perceived it as part of a giant interior. I noticed
chimneys, telegraph poles, and items not normally on my conscious visible radar.
The sky appeared as a ceiling, almost touchable, and was totally non-threatening.

I felt no nausea or negativity at all. It was a pleasant experience, albeit a gentle one.

This was my first foray into the realms of psychedelia and it would leave a long term
impression, although not as a result of any form of trauma or extreme stimulation. It
was profound: the temporary shift in perception was to have a permanent and
positive influence on my worldview.

Now, many years later, I can align elements of this trip with more recent
experimentation with 1p-LSD and other lysergamides. That intimate relationship
with the outdoors and nature, the wonderment of the visuals, the delicate excitation
of the other senses, the aura of the headspace: all ebb and flow to differing degrees
between each experience.

As LSD is almost indistinguishable from 1p-LSD, I have attempted to more fully
document the trip experience itself within the entry for the latter. Needless to say, I
hope to have many more encounters in the future.

[Shulgin Reference: TiHKAL #26, p490]

\`\`\`
“I believe it’s true to say that everyone who has experienced LSD or
another psychedelic would look on that experience, especially the first
one, as a major life-changing event.” ~ Ralph Metzner
\`\`\`

BLOTTER ART
LSD tabs are usually decorated by what has become known as blotter art. This can
sometimes be extremely complex in nature, and indeed, entire collections exist,
which have even been exhibited in galleries and museums.

The above sheet, which consists of 1200 individual blotters, was produced for
promotional purposes in 2019. It presents the front cover of the second edition of
this book, but alas, doesn’t contain any LSD.
`,
  "erowid": `# LSD
*Source: https://www.erowid.org/chemicals/lsd/lsd.shtml*

## Basics
[CHEMICALS](https://erowid.org/chemicals/)
 
[lsd](https://erowid.org/chemicals/lsd/)
...
[LSD Images](https://erowid.org/lsd_images.shtml)
 
LSD is one of the most commonly used 'psychedelic' or 'hallucinogenic' substances. It comes in a variety of forms, but is virtually always taken orally. Today, LSD is most commonly found in the form of small squares of paper called 'blotter' (full sheets of paper are decorated with [artwork or designs](https://erowid.org/lsd_images_gallery1.shtml) , perforated, then soaked in liquid LSD solution and dried). Other forms include pills, gelatin sheets or shapes (pyramids, cubes, etc), liquid, liquid sugar cubes, and powder. Blotter is most common because it is easily produced, easily concealable and the format allows for few adulterant chemicals. 
 
[ [Main LSD Vault](https://erowid.org/lsd.shtml) ]
 
[Dose](https://erowid.org/lsd_dose.shtml) #
...
[Law](https://erowid.org/lsd_law.shtml) #
...
[Chemistry](https://erowid.org/lsd_chemistry.shtml) #
 
d-lysergic acid diethylamide (LSD) is a synthetic chemical derived from ergot alkaloids which are produced by the [ergot fungus](https://erowid.org/plants/ergot/ergot.shtml) which grows on rye.
...
[History](https://erowid.org/lsd_timeline.php) #
...
LSD (Lyserg-Saeure-Diethylamid in German); Acid; Cid; L; Blotter (on paper); Tabs (on paper); LAD; Doses; Trips; Microdots (small tablets).
 
The Experience:
 
Tripping; Flying; Frying.
 
[EFFECTS](https://erowid.org/lsd_effects.shtml) #
...
Depending on how much and how recently one has eaten food, LSD generally takes 20 - 60 minutes (though sometimes as long as 2 hrs) to take effect.
...
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to lsd](https://erowid.org/chemicals/lsd/) ]
 
- Created by Erowid - Jan 24, 2000 | Created by Erowid - Jan 24, 2000 | Modified - Sep 6, 2017
**Created by Erowid - Jan 24, 2000**
...
- LSD Duration Oral Total Duration6 - 11 hrs Onset20 - 60 mins Coming Up15 - 30 mins Plateau3 - 6 hrs Coming Down3 - 5 hrs After Effects2 - 5 hrs Hangover / Day After- - - | LSD Duration | Oral | Total Duration | 6 - 11 hrs | Onset | 20 - 60 mins | Coming Up | 15 - 30 mins | Plateau | 3 - 6 hrs | Coming Down | 3 - 5 hrs | After Effects | 2 - 5 hrs | Hangover / Day After | - - -
**LSD Duration**
**Oral**
...
- Profound life-changing spiritual experiences or personal revelations
...
- slight increase in body temperature (including warm body, sweaty palms, increased perspiration, warm face)
...
- delusions, delusional thinking, & fanciful ideation taken as fact
...
- PTSD-style flashbacks or vivid memories of unpleasant visions, memories, or thoughts
...
- Created by Erowid - Mar 03, 1998 | Created by Erowid - Mar 03, 1998 | Modified - Sep 19, 2020
...
[Low Dose LSD References](https://erowid.org/lsd_dose1.shtml)
 
[LSD Fatalities /Deaths](https://erowid.org/lsd_death.shtml)
 
[LSD Health](https://erowid.org/lsd_health.shtml)
 
[25I-NBOMe Fatalities /Deaths](https://erowid.org/chemicals/2ci_nbome/2ci_nbome_death.shtml)
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to lsd](https://erowid.org/chemicals/lsd/) ]
 
- Created by Erowid - 1997 | Created by Erowid - 1997 | Modified - Feb 20, 2017
...
Less than a handful of deaths have been directly attributed in the medical literature to the pharmacological effects of LSD, and *none* of these have been unquestionably attributable to LSD's actions. Estimates of what could be a potentially lethal dose of LSD are higher than 10 mg orally, a dose that is more than 100 times the common, moderate dose of LSD (100 ug). The administration of this amount would require the ingestion of more than 200 units of street blotter, which typically contain about 50 ug of LSD (as of late 2010). 
 ...
 See [LSD Deaths](https://erowid.org/lsd_death.shtml) for a discussion of documented LSD-related fatalities.
...
[LSD Dose Information](https://erowid.org/lsd_dose.shtml)
 
[LSD Deaths](https://erowid.org/lsd_death.shtml)
 
[Interactions Between LSD and Antidepressants](https://erowid.org/lsd_health3.shtml)
 
[Definition of Hallucinogen Persisting Perception Disorder](https://erowid.org/lsd_health2.shtml)
 
HEALTH MYTHS #
 
[LSD Does Not Stay in your Body Forever](https://erowid.org/lsd_myth1.shtml) (Erowid 2006)
 
[Take LSD 7 Times & You're Legally Insane?](https://erowid.org/lsd_myth8.shtml) (Erowid 2003)
 
[Bogus Science: LSD and Chromosome Damage](https://erowid.org/lsd_health4.shtml) (Erowid 2002)
 
[Is Strychnine in LSD?](https://erowid.org/lsd_myth2.shtml) (Erowid 1997)
 
References #
 
1. Nichols DE. " [Hallucinogens](https://erowid.org/references/refs_view.php?ID=6318) ". *Pharmacol Therapeut* . 2004;101:131-81.
2. Erowid. " [Reported LSD-Related Death was Not LSD](https://erowid.org/lsd_media2.shtml) ". Erowid.org. Jul 2007. Erowid.org/chemicals/lsd/lsd_media2.shtml
3. Brown M. " [Interactions Between LSD and Antidepressants](https://erowid.org/chemicals/lsd/lsd_health3.shtml) ". Erowid.org. Apr 6, 2002. Erowid.org/chemicals/lsd/lsd_health3.shtml
4. Various Authors "Erowid Experience Reports: IDs [31861](https://erowid.org/experiences/exp.php?ID=31861) , [42999](https://erowid.org/experiences/exp.php?ID=42999) , [75153](https://erowid.org/experiences/exp.php?ID=75153) , [37002](https://erowid.org/experiences/exp.php?ID=37002) , [81932](https://erowid.org/experiences/exp.php?ID=81932) ". Erowid.org. 2004-2009.
5. Various Authors "Erowid Experience Reports: IDs [64918](https://erowid.org/experiences/exp.php?ID=64918) , [5549](https://erowid.org/experiences/exp.php?ID=5549) , [14788](https://erowid.org/experiences/exp.php?ID=14788) , [4426](https://erowid.org/experiences/exp.php?ID=4426) , [32413](https://erowid.org/experiences/exp.php?ID=32413) ". Erowid.org. 2001-2008.
6. Friedman SA, Hirsch SE. " [Extreme Hyperthermia After LSD Ingestion](https://erowid.org/references/refs_view.php?ID=5197) ". *JAMA* . 1971;217:1549-50.
7. Psilo, Erowid E. " [How Long After Ingesting LSD is it Safe to Breast Feed?](https://erowid.org/ask/ask.php?ID=231) ". *Ask Erowid* . Dec 4, 2000. Erowid.org/ask/ask.php?ID=231
8. Erowid. "Cluster Headache Treatment with Psilocybin Mushrooms & LSD". Erowid.org. Dec 17 2000.
9. Grof S. " [LSD Psychotherapy](https://erowid.org/library/books/lsd_psychotherapy.shtml) ". Hunter House. 1994.
10. Leavitt F. " [Drugs and Behavior](https://erowid.org/library/books/drugs_and_behavior.shtml) ". Sage Publications. 1995.
11. Johnson MW, Richards WA, Griffiths RR. ["Human Hallucinogen Research: Guidelines for Safety".](https://erowid.org/references/refs_view.php?ID=7355) *J Psychopharmacol* . Jul 1, 2008.
12. Strassman RJ. ["Adverse Reactions to Psychedelic Drugs. A Review of the Literature".](https://erowid.org/references/refs_view.php?ID=1238) *J Nerv Ment Dis* . 1984 Oct;172(10):577-95.
13. Erowid E . ["Bogus Science: LSD and Chromosome Damage"](https://erowid.org/chemicals/lsd/lsd_health4.shtml) . *Erowid Extracts* . Oct 2002;3:12-15.
14. Eisner BG, Cohen S. ["Psychotherapy with lysergic acid diethylamide".](https://erowid.org/references/refs_view.php?ID=1733) *J Nerv Ment Dis* . 1958;127:528.
15. Erowid F, Erowid E. ["Erowid Visitors on LSD: The Results of Eight LSD-Related Surveys. Conducted on Erowid Between Oct 2005 and Jan 2006"](https://erowid.org/chemicals/lsd/lsd_survey1.shtml) . *Erowid Extracts* . Jun 2006;10:10-12.
16. Erowid. ["Comments from LSD Survey 8 'How Has LSD Affected Your Life?'"](https://erowid.org/general/survey/survey_lsd8_quotes1.shtml) . Erowid.org. Jun 2006.
17. Sewell RA, Halpern JH, Pope HG Jr. " [Response of Cluster Headache to Psilocybin and LSD](https://erowid.org/references/refs_view.php?ID=6690) ". *Neurology* . Jun 27, 2006;66(12):1920-2.
18. Van Dusen W, Wilson W, Miners W, Hook H. ["Treatment of Alcoholism with Lysergide"](https://erowid.org/references/refs_view.php?ID=3900) *Quart. J. Stud. Alcohol* . 1967;28:295-303.
19. Pahnke WN, Kurland AA, Goodman LE, Richards WA. ["LSD-Assisted Psychotherapy with Terminal Cancer Patients"](https://erowid.org/references/refs_view.php?ID=5013) *Psychedelic Drugs* . 1969;33-42.
20. Bonson KR, Buckholtz JW, Murphy DL. ["Chronic Administration of Serotonergic Antidepressants Attenuates the Subjective Effects of LSD in Humans"](https://erowid.org/references/refs_view.php?ID=6207) *Neuropsychopharmacology* . 1996 Jun;14(6):425-36.
21. Mangini M. ["Treatment of alcoholism using psychedelic drugs: a review of the program of research"](https://erowid.org/references/refs_view.php?ID=6982) *J Psychoactive Drugs* . 1998 Oct-Dec;30(4):381-418.
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to lsd](https://erowid.org/chemicals/lsd/) ]
 
- Created by Erowid - Sep 2, 2010 | Created by Erowid - Sep 2, 2010 | Modified - Feb 10, 2015
**Created by Erowid - Sep 2, 2010**
...
[Hand-Crafted Glass Molecules! Donate \$150+ and get an art glass molecule. (Pick caffeine, DMT, dopamine, ethanol, harmine, MDMA, mescaline, serotonin, tryptamine, nitrous, THC, or psilocybin)](https://erowid.org/donations/incentives_special1.php?src=ms44)
...
LSD has been illegal since 1971 when it was added to paragraph (Schedule) I of the German Drug Law (BtmG) See [ref](https://erowid.org/references/refs_view.php?ID=6928) . (thanks xDCx)
...
LSD is list I / schedule I in the Netherlands. This makes it illegal to possess, distribute, and produce without a license. The use of LSD is not illegal. Source: [http://www.trimbos.nl/default14550.html](http://www.trimbos.nl/default14550.html) . (thanks A)
 
New Zealand #
 
LSD is Schedule I (Class A) in New Zealand [ [reference](https://erowid.org/psychoactives/law/countries/nz/law_nz_info1.shtml) ].
 
Norway #
 
LSD is Schedule I in Norway and illegal to buy or possess without a special license. [See Norway Law](https://erowid.org/psychoactives/law/countries/countries.shtml#norway) . (thanks Y)
 
Portugal #
 
Effective July 2001, personal use of LSD was decriminalized by Law 30/2000 (see [text of law](https://erowid.org/psychoactives/law/countries/portugal/lei30-2000.pdf) ). Possession of less than 500 ug is not regarded as a criminal offense, though the substance is liable to be seized and the possessor can be referred to mandatory treatment. Sale, or possession of quantities greater than the personal possession limit, are criminal offenses punishable by jail time. (thanks P)
 
Russia #
 
LSD is controlled and illegal to possess without a research license in Russia. Some news in 2005 has suggested that there is a move towards changing the law. See [Pravda's Jul 19 2005 story : "Psychedelic drug, LSD-25, likely to be legalized in Russian medicine"](http://english.pravda.ru/science/19/94/377/15825_LSD.html) .
 
U.K. #
 
LSD is [Schedule I/Class A](https://erowid.org/psychoactives/law/countries/uk/uk_law_definitions.shtml) in the U.K., making it illegal to sell, buy, or possess without a license.
...
[LSA Law](https://erowid.org/chemicals/lsa/lsa_law.shtml)
 
[Ergot Law](https://erowid.org/plants/ergot/ergot_law.shtml)
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to lsd](https://erowid.org/chemicals/lsd/) ]
 
- Created by Erowid - Jul 31, 1997 | Created by Erowid - Jul 31, 1997 | Modified - Feb 10, 2015
 ...
 **INFORMATION** 
 [LSD Data Sheet](https://erowid.org/lsd_data_sheet.shtml) - Occupational Health Services 
 [Compare LSD molecule to another chemical](https://erowid.org/psychoactives/chemistry/chemistry_compare.php?rm=&lm=lsd_3d) 
 [PubChem: LSD](http://pubchem.ncbi.nlm.nih.gov/summary/summary.cgi?cid=5761) 
 
 
 Pharmacology: 
 [Papac 1990](https://erowid.org/references/refs_view.php?ID=6265) found peak plasma levels occuring at around 3 hours after oral ingestion and half-life around 5 hours. 
 
 [Canezin 2001](https://erowid.org/references/refs_view.php?ID=6266) found LSD, iso-LSD, 2-oxo-3-hydroxy-LSD (O-H-LSD), Nor-iso-LSD, lysergic acid ethylamide (LAE), trioxylated-LSD, lysergic acid ethyl-2-hydroxyethylamide (LEO) and 13 and 14-hydroxy-LSD in urine after LSD ingestion.
...
There are many synthetic methods developed and reported for the preparation of LSD. All of them start with lysergic acid, and for that reason it has been listed as a Schedule III controlled drug, as a depressant, under Federal law. The amide lysergamide, a component of several varieties of morning glory seed, is also a controlled drug and, by law, a depressant. The earliest syntheses of LSD involved the use used of an azide intermediate (the original Hofmann process, 1955), mixed anhydrides with trifluoroacetic anhydride (1956) or sulfuric anhydride (SO3-DMF on the lithium salt, 1959), with the peptide condensation agent N,Nâ²-carbonyldiimidazole (1960), or with the acid chloride as the active intermediate with POCl3, PCl5 or thionyl chloride (1963) or just phosphorus oxychloride (1973). Most methods are faulted due to excessive moisture sensitivity, generation of side-products, or epimerization or inversion at the 8-position carbon to form d-iso-LSD. The POCl3 procedure is clean and fast, and is the preferred process today for the synthesis of a wide variety of substituted lysergamides.

The term LSD comes from the initials of the German for lysergic acid diethylamide, or LyserSÃ¤ure DiÃ¤thylamid LysersÃ¤ure Diethylamid. The number â25â following it has many myths attached to it, such as it was the 25th form of LSD that Hofmann tried, or it was his 25th attempt to make LSD. From my own experience with chemical companies that are allied with pharmaceutical houses, I had assumed that the chemical name (which might be a mouthful for the pharmacologist) was simply replaced with a pronounceable code number equivalent. But the answer here is yet simpler. Hofmann, in his LSD, My Problem Child wrote: âIn 1938, I produced the twenty fifth substance in a series of lysergic acid derivatives: lysergic acid diethylamide, abbreviated LSD-25â¦ for laboratory usage.â
...
There are some suggestions that an intravenous intervenous route may be more effective. I have heard of effects being noted at maybe a milligram and a short (2â3 hour) intoxication intoxicaion following 20 milligrams administered over a 20 minute period. I was involved many years ago in a study of radio-labelled BOL-148 which was made by the bromination of LSD. I was quite sure that the only radioactive material present was BOL-148, but there could well have been some unreacted LSD still present which would, of course, still be psychoactive. The synthesis is not cleanâI was tempted to make an entry for this compound if only to reproduce Albert Hofmannâs original published experimental procedure. He reacted 13.2 grams of N-bromosuccinimide (in 400 mL dioxane, with 1.2 liters of dioxane containing 25 grams of LSD. This gave 11 grams of crude product produce which had to be recrystallized. The radioactive syntheses uses effectively elemental bromine, and gave yields of from 5 to 15%. Visualize that reaction! A warm flask containing over a quart of warm solvent in which there was maybe half a million doses of LSD.
...
indole
â amide nitrogen substituents â
...
In the amides marked with â*â there has been the introduction of a new asymmetric center, which of course doubles the number of isomers that is possible. In each case the resulting two optical forms were prepared separately, and evaluated separately as to their pharmacology. 

This listing is not intended to be thorough, but it is shown to suggest the amount of synthetic effort that has been made towards the exploring and understanding the high potency associated with those two remarkably important ethyl groups on the amide nitrogen of LSD. I have given the Sandoz code names, again, as far as I know them. Although none of these really warrant a dedicated recipe, there is sufficient animal and human pharmacology reported to justify listing them below as separate items. Most of these reports appeared in the mid-1950âs but some studies are still being done and papers are published even today with new ideas but, sadly, only with animal pharmacology. I have been as guilty as the next person who has tried to mount all these compounds into a table with a âhuman potencyâ factor that compares them directly to LSD. This is an uncomfortable simplification. Here are the actual reported observations, and Iâll let the reader provide his own potency index.
...
`,
  ...
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_LSD.shtml",
  "name": "LSD",
  "aliases": [
    "acid",
    "blotter",
  ...
  "aliasesStr": "acid,blotter,cid,l,lsd-25,lucy,tabs",
  ...
  "roas": [
    {
      ...
      "duration": [
        ...
        {
          "name": "After effects",
          "value": "12.0 - 48.0 hours"
        }
      ],
      "bioavailability": "71% - 71%"
    },
    {
      "name": "Oral",
      "dosage": [
      ...
      "duration": [
        ...
        {
          "name": "Duration",
          "value": "9.0 - 14.0 hours"
        },
        {
          "name": "After effects",
          "value": "12.0 - 24.0 hours"
        }
      ]
    }
  ],
...
**DOC**
Only little information exists on DOC / 2,5-dimethoxy-4-chloroamphetamine. However, DOC can lead to chest pain and vasoconstriction. Due to the late onset of action, there is a risk of overdose. The very long duration of action of approx. 20 h should definitely be taken into account.
`,
  "tripsit-factsheets": `# LSD
*Source: https://tripbot.tripsit.me/api/tripsit/getDrug/lsd*

## Classification
- **Categories:** psychedelic, common
- **Also known as:** lsd-25, acid, cid, lucy
...
- **ghb/gbl** (Low Risk & Decrease)
- **maois** (Low Risk & Decrease)
- **ssris** (Low Risk & Decrease)
- **tramadol**: Tramadol is well known to lower seizure threshold and psychedelics also cause occasional seizures. (Unsafe)
...
*Source: https://wiki.tripsit.me/wiki/LSD*
...
See [Psychedelic Harm Reduction](https://wiki.tripsit.me/wiki/Psychedelics#Harm_Reduction) for general information.
...
A meta analysis concluded that a single dose was shown to be effective at reducing alcohol consumption in people suffering from alcoholism. LSD has also been studied in depression, anxiety, and drug dependence, with positive preliminary results.
Despite these results, LSD currently has no legally approved uses in medicine.
...
Alexander Shulgin did not include experience reports of LSD in his 1997 book TiHKAL (Tryptamines I Have Known and Loved) due to the thousands of reports that already existed in the literature.
...
LSD binds to most serotonin receptor subtypes except for the serotonin 5-HT3 and 5-HT4 receptors. However, some of these serotonin receptors may not be affected at typical brain concentrations of LSD. In humans, recreational doses of LSD may affect 5-HT1A, 5-HT2A, 5-HT2B, 5-HT2C, 5-HT5A, and 5-HT6 receptors. Although not present in humans, 5-HT5B receptors found in rodents also have a high affinity for LSD. The psychedelic effects of LSD are attributed to activation of 5-HT2A receptors. Many but not all serotonin 5-HT2A agonists are psychedelics and serotonin 5-HT2A antagonists block the psychedelic activity of LSD. LSD exhibits pronounced functional selectivity or biased agonism at the serotonin 5-HT2A and 5-HT2C receptors in that it activates the signal transduction enzyme phospholipase A2 instead of activating the enzyme phospholipase C as the endogenous ligand serotonin does, among other differences.
...
In terms of distribution, it is estimated that only about 1 to 1.5% of the drug reaches the brain both in animals and humans. Following a typical 100 μg dose in humans, this would be about 1 μg that is distributed into the brain. LSD levels in different brain areas have been found to vary in monkeys. Levels were equal in blood, cerebral cortex, cerebellum, and brainstem, whereas levels were 1.5 times higher in the thalamus and extrapyramidal system, 2 to 3 times higher in the hypothalamus and limbic system, 2 to 5 times higher in the auditory and visual cortex, 5 to 7 times higher in the posterior pituitary and pineal gland, and 10 times higher in the anterior pituitary gland. These varying concentrations in different brain areas may explain the profile of psychedelic effects of LSD. Bodily distribution of LSD has also been studied.
It has been said that there is a peculiar 40-minute lag before onset of the psychedelic effects of LSD when it is administered intravenously. This has been said to be related to time-dependent interactions of LSD with the serotonin 5-HT2A receptor. However, contradicting the preceding claims, other sources have stated that intravenous injection of LSD results in onset of effects within a few minutes. In a 2025 pharmacokinetic study comparing oral and intravenous LSD, the onset orally was about 45 minutes and the onset by intravenous injection was about 2.5 minutes. In addition, intrathecal injection (intraspinal injection) is reported to have a virtually instantaneous onset of action. However, in the 2025 study, time to maximal effects was about 2.5 hours orally and about 1.2 hours intravenously. In an earlier 2016 study, intravenous LSD effects similarly peaked after about 1.7 hours. For comparison, intravenous dimethyltryptamine (DMT) given as a bolus has been found to produce maximal effects after about 2 minutes and intravenous psilocybin given over 60 seconds after about 4 minutes. Doses of LSD are said to be similar by oral and injectable routes, with the exception of intrathecal injection in which the dose is reduced to about one-third of usual.

#### Metabolism

The metabolites of LSD include 2-oxo-3-hydroxy-LSD (O-H-LSD), 2-oxo-LSD, lysergic acid ethylamide (LAE), lysergic acid ethyl-2-hydroxyethylamide (LEO), nor-LSD, 13-hydroxy-LSD, 14-hydroxy-LSD, and the glucuronide conjugates of the 13- and 14-hydroxylated metabolites, among other possible metabolites. The major metabolite of LSD is O-H-LSD. Levels of O-H-LSD in urine have been found to be 4 to 40 times higher than those of LSD, indicating extensive metabolism of LSD into this compound. It is formed by cytochrome P450 enzymes, although the specific enzymes involved are unknown, and O-H-LSD's potential pharmacology is little-studied. However, it was found to have profoundly reduced activity at the serotonin 5-HT2 receptors relative to LSD in vitro. Little is known about the specific enzymes responsible for the formation of LSD metabolites.

#### Elimination

Only 1% of the drug was eliminated in urine unchanged, whereas 13% was eliminated as O-H-LSD within 24 hours.
Aghajanian and Bing (1964) found LSD had an elimination half-life of only 175 minutes (about 3 hours); however, using more accurate techniques, Papac and Foltz (1990) reported that 1 μg/kg oral LSD given to a single male volunteer had an apparent plasma half-life of 5.1 hours, with a peak plasma concentration of 5 ng/mL at 3 hours post-dose. In a more modern 2015 study, concentrations of LSD decreased following first-order kinetics with a half-life of 3.6 ± 0.9 hours and a terminal half-life of 8.9 ± 5.9 hours.
...
Blotter art designs printed on blotter paper can serve to identify dose strengths, different batches, or makers.
...
LSD is a psychoplastogen, a compound capable of promoting rapid and sustained neural plasticity, an action that hypothetically might be involved in its therapeutic benefits, although more research is needed to substantiate such notions.
