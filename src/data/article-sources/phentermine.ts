...
export const substanceName = "Phentermine";
export const sources = [{"id":"drugbank","fileName":"DRUGBANK - Phentermine.md","displayName":"DrugBank","size":28313},{"id":"protestkit","fileName":"PROTESTKIT - Phentermine.json","displayName":"Protest Kit","size":3095},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Phentermine.md","displayName":"TripSit Factsheets","size":390},{"id":"wikipedia","fileName":"WIKIPEDIA - Phentermine.md","displayName":"Wikipedia","size":13814}];
export const contents: Record<string, string> = {
  "drugbank": `# Phentermine
*Source: https://go.drugbank.com/drugs/DB00191*
...
Phentermine is a sympathomimetic amine anorectic agent and it was introduced in 1959 as part of an anti-obesity combination drug.
1
,
2
It is chemically related to amphetamine and it is commonly referred to as an atypical amphetamine.
4
Phentermine has not been reported an addictive potential which allows this agent to be classified under the Schedule IV drugs (low abuse potential).
3
Phentermine was FDA approved for short-term weight management in 1959 and it became widely used in 1960. This initial product, formed by the combination of phentermine with
fenfluramine
and
dexfenfluramine
was discontinued after finding several reports of abnormal valves in nearly 30% of the consumers.
6
,
8
Later on, phentermine was approved alone and in combination with topiramate in 2012 as a new alternative that required lower doses of phentermine to obtain the desired effect.
5
...
Phentermine shows a dose-dependent pharmacokinetic profile. After oral administration of a dose of 15 mg, the maximal concentration was achieved after 6 hours and its bioavailability was not affected by the consumption of high-fat meals.
4
...
The mean terminal half-life of phentermine is reported to be of approximately 20 hours.
4
In conditions where there is acidic urine (pH <5), the elimination half-life is of 7-8 hours.
9
...
Abametapir
The serum concentration of Phentermine can be increased when it is combined with Abametapir.
Acarbose
The therapeutic efficacy of Acarbose can be increased when used in combination with Phentermine.
Acebutolol
The therapeutic efficacy of Acebutolol can be decreased when used in combination with Phentermine.
Aceclofenac
The risk or severity of hypertension can be increased when Phentermine is combined with Aceclofenac.
Acemetacin
The risk or severity of hypertension can be increased when Phentermine is combined with Acemetacin.
...
**Synonyms:** alpha,alpha-Dimethylphenethylamine
Fentermina
Phentermine
Phentermine resin
Phenterminum
...
Phentermine
is a sympathomimetic anorectic agent used as a short-term adjunct therapy that is included in a regimen of weight reduction in cases of exogenous obesity.
...
Phentermine is an indirect-acting sympathomimetic agent that acts by releasing noradrenaline from the presynaptic vesicles in the lateral hypothalamus. This increase in noradrenaline concentration in the synaptic cleft results in the stimulation of beta2-adrenergic receptors.
3
Phentermine is classified as an indirect sympathomimetic due to the increase in the level of norepinephrine, dopamine and its indirect effect towards serotonin.
10
...
8
This combined effect produces a continuous flight-or-fight response in the body which reduces the hunger signal as this state is on the immediate need for energy.
8
...
FDA Approved Drug Products: Qsymia (phentermine and topiramate), extended-release capsules for oral use [
Link
]
...
Cost
Unit
Phentermine hcl powder
10.71USD
g
Ionamin 30 mg capsule sa
2.87USD
capsule
Adipex-P 37.5 mg capsule
2.2USD
capsule
...
1.54USD
tablet
Phentermine HCl 15 mg capsule
1.18USD
capsule
Phentermine HCl 30 mg capsule
1.17USD
capsule
Ionamin 15 mg capsule sa
1.15USD
capsule
Phentermine HCl 37.5 mg capsule
1.0USD
capsule
Phentermine HCl 37.5 mg tablet
1.0USD
tablet
...
boiling point (°C)
206 ºC
Barceloux D. (2012). Medical Toxicology of Drug Abuse.
water solubility
18.6 g/L
Gravey W. (2013). Expert Opin Drug Saf.
logP
1.90
Barceloux D. (2012). Medical Toxicology of Drug Abuse.
pKa
9.84
Suprenza - package insert. (2014)
...
Predicted GC-MS
splash10-0a4l-9000000000-4b4613b0051412392011
Mass Spectrum (Electron Ionization)
MS
splash10-0a4i-9100000000-7037d3f1fad22de72c33
Predicted MS/MS Spectrum - 10V, Positive (Annotated)
Predicted LC-MS/MS
splash10-001l-6900000000-f8d0a9cfb7825a46ea57
Predicted MS/MS Spectrum - 10V, Negative (Annotated)
Predicted LC-MS/MS
splash10-0019-9500000000-2302175e70d835931dec
Predicted MS/MS Spectrum - 20V, Positive (Annotated)
Predicted LC-MS/MS
splash10-0006-9100000000-5832052065e899dd83d6
Predicted MS/MS Spectrum - 20V, Negative (Annotated)
Predicted LC-MS/MS
splash10-052b-9700000000-2714b4962a5395a568ab
Predicted MS/MS Spectrum - 40V, Positive (Annotated)
Predicted LC-MS/MS
splash10-00kf-9000000000-8b6939ce324679f1ed7a
Predicted MS/MS Spectrum - 40V, Negative (Annotated)
Predicted LC-MS/MS
splash10-0006-9100000000-a6b30fc787b31548700e
1H NMR Spectrum
1D NMR
Not Applicable
13C NMR Spectrum
...
`,
  "protestkit": `{
  "url": "https://drugs.tripsit.me/phentermine",
  "experiencesUrl": "https://www.reddit.com/search/?q=Phentermine",
  "name": "Phentermine",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# Phentermine
*Source: TripSit Factsheets (tripsit.me)*

## Summary

Psychostimulant of the substituted amphetamine class. The drug is used medically as an appetite suppressant.

## Classification
- **Categories:** stimulant, tentative
...
*Source: https://en.wikipedia.org/wiki/Phentermine*
...
Phentermine has been found to be completely inactive as a ligand or agonist of the serotonin 5-HT2 receptors, including of the serotonin 5-HT2A, 5-HT2B, and 5-HT2C receptors. This is in contrast to the serotonin releasing agents (SRAs) fenfluramine, norfenfluramine, and to a lesser extent chlorphentermine. However, another study found that phentermine was a weak human serotonin 5-HT2C receptor partial agonist (EC50Tooltip half-maximal effective concentration = 1,394 nM, Vmax = 66%). In accordance with its lack of serotonin release and serotonin 5-HT2B receptor agonism, phentermine appears to show no risk of primary pulmonary hypertension (PPH) or valvular heart disease (VHD) in humans.
Phentermine has been found to be active as an agonist of the rat and human trace amine-associated receptor 1 (TAAR1). It appears to be a weak human TAAR1 partial agonist (EC50 = 5,470 nM and EmaxTooltip maximal efficacy = 68% in one study). The drug shows reduced activity as a TAAR1 agonist compared to amphetamine. TAAR1 agonism by amphetamines that possess this action may serve to auto-inhibit and constrain their effects.
Phentermine is a very weak monoamine oxidase inhibitor (MAOI) in vitro. It specifically inhibits monoamine oxidase A (MAO-A) (IC50Tooltip half-maximal inhibitory concentration = 85,000–143,000 nM) and monoamine oxidase B (MAO-B) (IC50 = 285,000 nM). However, its potency as a MAOI is far below its potency as a monoamine releasing agent. Relatedly, phentermine does not show neurochemical signs of MAOI activity in rodents in vivo. As such, the significance of phentermine as an MAOI in humans is questionable.
