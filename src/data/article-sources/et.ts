...
export const substanceName = "αET";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - αET.json","displayName":"Protest Kit","size":2133},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - αET.md","displayName":"TripSit Factsheets","size":1107},{"id":"wikipedia","fileName":"WIKIPEDIA - αET.md","displayName":"Wikipedia","size":10568}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/aet",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_AET.shtml",
  "name": "αET",
  "aliases": [
    "a-et",
    "a-ethyltryptamine",
  ...
  "aliasesStr": "a-et,a-ethyltryptamine,alpha-ethyl-tryptamine",
  ...
  "tripsit-factsheets": `# αET
*Source: TripSit Factsheets (tripsit.me)*

## Summary

A quite rare substance of the tryptamine class, was first made by Upjohn as an antidepressant. Please use extreme caution with this drug.

## Classification
- **Categories:** psychedelic, stimulant, research-chemical, tentative, empathogen
- **Also known as:** alpha-ethyl-tryptamine, a-et, a-ethyltryptamine
...
`,
  "wikipedia": `# Α-Ethyltryptamine
*Source: https://en.wikipedia.org/wiki/%CE%91-Ethyltryptamine*
...
In addition to acting as a monoamine releasing agent, αET acts as a serotonin receptor agonist. It is known to act as a weak partial agonist of the serotonin 5-HT2A receptor (EC50Tooltip half-maximal effective concentration > 10,000 nM; Emax = 21%). (–)-αET is inactive as a 5-HT2A receptor agonist at concentrations of up to 10 μM, whereas (+)-αET is a 5-HT2A receptor agonist with an EC50 value of 1,250 nM and an Emax value of 61%. αET has also been found to have weak affinity for the 5-HT1, 5-HT1E, 5-HT1F, and 5-HT2B receptors.

αET is a weak monoamine oxidase inhibitor (MAOI). It is specifically a selective and reversible inhibitor of monoamine oxidase A (MAO-A). An IC50Tooltip half-maximal inhibitory concentration value of 260 μM in vitro and 80 to 100% inhibition of MAO-A at a dose of 10 mg/kg in rats in vivo have been reported. αET is described as slightly more potent as an MAOI than dextroamphetamine. Both enantiomers of αET have similar activity as MAOIs, whereas αET's major metabolite 6-hydroxy-αET is inactive. The relatively weak MAOI actions of αET have been considered unlikely to be involved in its stimulant, antidepressant, and other psychoactive effects by certain sources.
The stimulant effects of αET have been said to lie primarily in (–)-αET, whereas hallucinogenic effects have been said to be present in (+)-αET. However, these claims appear to be based on animal drug discrimination studies and are not necessarily in accordance with functional studies. Generalization to DOMTooltip 2,5-dimethoxy-4-methylamphetamine may have been anomalous and due to the serotonin-releasing actions of αET rather than due to serotonin 5-HT2A receptor activation and associated psychedelic effects. Accordingly, αET does not produce the head-twitch response in rodents, unlike known psychedelics. However, in another study, low doses of αET (0.5–1.0 mg/kg) did not produce the head-twitch response but a high dose (5 mg/kg) did produce the response. Clear hallucinogenic effects of αET have never been documented in humans even at high doses, although the individual enantiomers of αET have never been studied in humans.
...
The chemical synthesis of αET has been described. It can be synthesised in a two-step synthesis with commercial chemicals via the Henry reaction aka Nitroadol condensation reaction between indole-3-carboxaldehyde and nitropropane under amine salt or ionic liquid catalysis which produces 3-(2-nitrobut-1-enyl)-1H-indole, 3-(2-nitrobut-1-enyl)-1H-indole can subsequently be reduced via a reducing like lithium aluminum hydride. to form α-ethyltryptamine.
