...
export const substanceName = "4-MTA";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - 4-MTA.json","displayName":"Protest Kit","size":2938},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - 4-MTA.md","displayName":"TripSit Factsheets","size":476},{"id":"wikipedia","fileName":"WIKIPEDIA - 4-MTA.md","displayName":"Wikipedia","size":8483}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/4-mta",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_4MTA.shtml",
  "name": "4-MTA",
  "aliases": [
    "4-methylthioamphetamine"
  ],
  "aliasesStr": "4-methylthioamphetamine",
  ...
  "tripsit-factsheets": `# 4-MTA
*Source: TripSit Factsheets (tripsit.me)*

## Summary

Empathogen with very low chronic toxicity but high risk of acute harm due to mixed serotonin release and MAOI action. There are some reports that indicate it does not have a notable euphoric effect.

## Classification
- **Categories:** research-chemical, empathogen, tentative
...
*Source: https://en.wikipedia.org/wiki/4-Methylthioamphetamine*
...
In addition to its MRA activity, 4-MTA is a potent monoamine oxidase A (MAO-A) inhibitor. Its IC50Tooltip half-maximal inhibitory concentration for MAO-A inhibition has been reported to be 250 nM. The combination of serotonin release induction and MAOI activity is likely responsible for the severe serotonergic toxicity and hyperthermia that has occurred with 4-MTA.
4-MTA shows significant affinity for the serotonin 5-HT2A and 5-HT2C receptors, but not for the serotonin 5-HT1A receptor. Its affinities for these receptors have been reported to be 1,500 nM, 1,800 nM, and >18,000 nM, respectively. 4-MTA is also a potent agonist of the mouse and rat trace amine-associated receptor 1 (TAAR1). However, it is inactive at the human TAAR1 (EC50Tooltip half-maximal effective concentration > 10,000 nM).
