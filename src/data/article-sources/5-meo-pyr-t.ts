...
export const substanceName = "5-MeO-PYR-T";
export const sources = [{"id":"isomerdesign","fileName":"ISOMERDESIGN - 5-MeO-PYR-T.md","displayName":"Isomer Design","size":6653},{"id":"protestkit","fileName":"PROTESTKIT - 5-MeO-PYR-T.json","displayName":"Protest Kit","size":3919},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - 5-MeO-PYR-T.md","displayName":"TripSit Factsheets","size":549}];
export const contents: Record<string, string> = {
  "isomerdesign": `# 5-MeO-PYR-T
...
`,
  "protestkit": `{
  "url": "https://drugs.tripsit.me/5-meo-pyr-t",
  "experiencesUrl": "https://www.reddit.com/search/?q=5-MeO-PYR-T",
  "name": "5-MeO-PYR-T",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# 5-MeO-PYR-T
*Source: TripSit Factsheets (tripsit.me)*

## Summary

The drug is a tryptamine that is atypical with its potency and more. There are reports of 3mg being vapourised that caused memory loss/blackouts.

## Classification
- **Categories:** tentative, research-chemical, psychedelic
