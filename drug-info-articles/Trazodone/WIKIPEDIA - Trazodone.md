# Trazodone
*Source: https://en.wikipedia.org/wiki/Trazodone*
...
Trazodone has a minor active metabolite known as meta-chlorophenylpiperazine (mCPP), and this metabolite may contribute to some degree to the pharmacological properties of trazodone. In contrast to trazodone, mCPP is an agonist of various serotonin receptors. It has relatively low affinity for α1-adrenergic receptors unlike trazodone, but does have high affinity for α2-adrenergic receptors and weak affinity for the H1 receptor. In addition to direct interactions with serotonin receptors, mCPP is a serotonin releasing agent similarly to agents like fenfluramine and MDMA. In contrast to these serotonin releasing agents however, mCPP does not appear to cause long-term serotonin depletion (a property thought to be related to serotonergic neurotoxicity).
