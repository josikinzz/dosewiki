...
export const substanceName = "Clorazepate";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Clorazepate.json","displayName":"Protest Kit","size":1688},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Clorazepate.md","displayName":"TripSit Factsheets","size":757},{"id":"wikipedia","fileName":"WIKIPEDIA - Clorazepate.md","displayName":"Wikipedia","size":9108}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/clorazepate",
  "experiencesUrl": "https://www.reddit.com/search/?q=Clorazepate",
  "name": "Clorazepate",
  "aliases": [
    "novo-clopate",
    "tranxene",
  ...
  "aliasesStr": "novo-clopate,tranxene,tranzene",
  ...
  "tripsit-factsheets": `# Clorazepate
...
- **Also known as:** tranxene, novo-clopate, tranzene
...
*Source: https://en.wikipedia.org/wiki/Clorazepate*
...
In September 2020, the U.S. Food and Drug Administration (FDA) required the boxed warning be updated for all benzodiazepine medicines to describe the risks of non-medical use, addiction, physical dependence, and withdrawal reactions consistently across all the medicines in the class.

### Tolerance, dependence and withdrawal

Delirium has been noted from discontinuation from clorazepate. 
...
Clorazepate can be synthesized starting from 2-amino-5-chlorobenzonitrile, which upon reaction with phenylmagnesium bromide is transformed into 2-amino-5-chlorbenzophenone imine.  Reacting this with aminomalonic ester gives a heterocyclization product, 7-chloro-1,3-dihydro-3-carbethoxy-5-phenyl-2H-benzodiazepin-2-one.  Upon hydrolysis using an alcoholic solution of potassium hydroxide forms a dipotassium salt, chlorazepate.
