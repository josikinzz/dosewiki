...
export const substanceName = "Aspirin";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Aspirin.json","displayName":"Protest Kit","size":1619},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Aspirin.md","displayName":"TripSit Factsheets","size":1099},{"id":"wikipedia","fileName":"WIKIPEDIA - Aspirin.md","displayName":"Wikipedia","size":54826}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/aspirin",
  "experiencesUrl": "https://www.reddit.com/search/?q=Aspirin",
  "name": "Aspirin",
  "aliases": [
    "acetylsalicylate"
  ],
  "aliasesStr": "acetylsalicylate",
  ...
  "tripsit-factsheets": `# Aspirin
*Source: TripSit Factsheets (tripsit.me)*

## Summary

A widely used anti-inflammatory and blood-thinner produced by acetylation of the naturally occurring salicyclic acid. Part of the nonsteroidal anti inflammatory class of drugs, a cyclooxygenase inhibitor. Very common over-the-counter pain reliever and fever reducer. Also used in smaller doses to lower risk of heart attack.
...
*Note:  NOTE: Aspirin is known to be dangerous in dosages of 4g and above. The duration is dose dependant: 2-3h (for low doses), 15-30h (for large doses)*
...
Aspirin's popularity grew over the first half of the 20th century, leading to competition between many brands and formulations. The word Aspirin was Bayer's brand name; however, its rights to the trademark were lost or sold in many countries. The name is ultimately a blend of the prefix a(cetyl) + spir, from Spirsäure, German for meadowsweet, the plant genus from which the aspirin precursor salicylic acid was first isolated (originally Spiraea, now Filipendula) + -in, the common suffix for drugs near the end of the 19th century.
...
Like flour mills, factories producing aspirin tablets must control the amount of the powder that becomes airborne inside the building, because the powder-air mixture can be explosive. The National Institute for Occupational Safety and Health (NIOSH) has set a recommended exposure limit in the United States of 5 mg/m3 (time-weighted average). In 1989, the US Occupational Safety and Health Administration (OSHA) set a legal permissible exposure limit for aspirin of 5 mg/m3, but this was vacated by the AFL-CIO v. OSHA decision in 1993.
...
Aspirin, an acetyl derivative of salicylic acid, is a white, crystalline, weakly acidic substance that melts at 136 °C (277 °F), and decomposes around 140 °C (284 °F). Its acid dissociation constant (pKa) is 3.5 at 25 °C (77 °F).
...
Aspirin is available in a variety of pharmaceutical formulations, each with distinct pharmacological and safety profiles. A key concern in aspirin therapy is the risk of gastrointestinal bleeding, prompting the development of formulations aimed at maintaining efficacy while minimizing gastrointestinal harm. Some formulations are also combined, for example, buffered aspirin with vitamin C. Formulation examples include:

Immediate-release tablets (IR-ASA): Commonly contain 75–100 mg or 300–320 mg of aspirin and are rapidly absorbed in the stomach.
Enteric-coated tablets (EC-ASA): Designed to dissolve in the higher pH environment of the small intestine, reducing gastric irritation but sometimes leading to erratic absorption.
Buffered formulations: Contain aspirin with buffering agents to reduce GI irritation; studies show similar mucosal injury rates to plain aspirin.
Aspirin combined with vitamin C (ASA-VitC): Reduces gastric damage and blood loss compared to plain aspirin.
Effervescent tablets are a specialized oral dosage form containing aspirin and an effervescent base—typically a combination of citric acid, tartaric acid, and sodium bicarbonate. When dissolved in water, these tablets produce a fizzy reaction that rapidly disperses the drug throughout the solution.
Phospholipid-aspirin complex liquid formulation (PL-ASA): Novel, FDA-approved and under further investigation for its ability to reduce GI injury while maintaining reliable platelet inhibition.
Aspirin formulations differ significantly in terms of pharmacokinetics, efficacy, and gastrointestinal safety. Enteric-coated (EC) aspirin, developed to reduce gastric irritation by delaying release until the small intestine, exhibits erratic absorption and reduced bioavailability, particularly in individuals with body weight over 70 kg. This can lead to suboptimal thromboxane A2 inhibition and decreased antiplatelet efficacy compared to plain aspirin. This diminished pharmacodynamic effect has been associated with reduced cardiovascular protection in heavier individuals. Although EC aspirin is associated with fewer gastric erosions in endoscopic studies, it does not significantly reduce gastrointestinal bleeding or ulceration, and may increase the risk of small bowel mucosal injury due to local topical effects
Buffered aspirin, which includes agents to neutralize gastric acid, similarly offers no clear safety advantage over plain aspirin.
...
In 1853, the chemist Charles Frédéric Gerhardt treated sodium salicylate with acetyl chloride to produce acetylsalicylic acid for the first time; in the second half of the 19th century, other academic chemists established the compound's chemical structure and devised more efficient methods of synthesis. In 1897, scientists at the drug and dye firm Bayer began investigating acetylsalicylic acid as a less-irritating replacement for standard common salicylate medicines, and identified a new way to synthesize it. That year, Felix Hoffmann (or Arthur Eichengrün) of Bayer was the first to produce acetylsalicylic acid in a pure, stable form.
...
Aspirin use may reduce the overall risk of both getting cancer and dying from cancer. There is substantial evidence for lowering the risk of colorectal cancer (CRC), but aspirin must be taken for at least 10–20 years to see this benefit. It may also slightly reduce the risk of endometrial cancer and prostate cancer.
