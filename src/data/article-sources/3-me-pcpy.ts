...
export const substanceName = "3-Me-PCPy";
export const sources = [{"id":"wikipedia","fileName":"WIKIPEDIA - 3-Me-PCPy.md","displayName":"Wikipedia","size":750}];
export const contents: Record<string, string> = {
  "wikipedia": `# 3-Methyl-PCPy
