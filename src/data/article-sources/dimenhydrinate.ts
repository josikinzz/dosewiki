...
export const substanceName = "Dimenhydrinate";
export const sources = [{"id":"drugbank","fileName":"DRUGBANK - Dimenhydrinate.md","displayName":"DrugBank","size":20010},{"id":"protestkit","fileName":"PROTESTKIT - Dimenhydrinate.json","displayName":"Protest Kit","size":3938},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Dimenhydrinate.md","displayName":"TripSit Factsheets","size":1242},{"id":"wikipedia","fileName":"WIKIPEDIA - Dimenhydrinate.md","displayName":"Wikipedia","size":5329}];
export const contents: Record<string, string> = {
  "drugbank": `# Dimenhydrinate
*Source: https://go.drugbank.com/drugs/DB00985*

## Overview

### Description

A medication used to prevent and treat nausea, vomiting, dizziness, and motion sickness.

### Background

Dimehydrinate was first described in the literature in 1949,
5
and patented in 1950.
11
...
in a salt form, with 53%-55.5% dried diphenhydramine, and 44%-47% died 8-chlorotheophylline.
10
The antiemetic properties of dimenhydrinate are primarily thought to be produced by diphenhydramine's antagonism of H1 histamine receptors in the vestibular system
2
while the excitatory effects are thought to be produced by 8-chlorotheophylline's adenosine receptor blockade.
3
...
,
10
It has a short duration of action of 4-8 hours.
4
...
A 50 mg oral film coated tablet reaches a C
max
of 72.6 ng/mL with a T
max
of 2.7 hours.
12
A 100 mg suppository reaches a C
max
of 112.2 ng/mL with a T
max
of 5.3 hours.
13
...
Dimenhydrinate is a theoclate salt that separates into
diphenhydramine
and
8-chlorotheophylline
.
...
Infants and children experiencing an overdose may lead to hallucinations, convulsions, or death.
10
...
In mice the oral LD
50
is 203 mg/kg, while in rats it is 1320 mg/kg.
10
The intraperitoneal LD
50
in mice is 149 mg/kg.
10
...
1,2-Benzodiazepine
The risk or severity of CNS depression can be increased when Dimenhydrinate is combined with 1,2-Benzodiazepine.
Acebutolol
The risk or severity of QTc prolongation can be increased when Dimenhydrinate is combined with Acebutolol.
Acetazolamide
The risk or severity of CNS depression can be increased when Acetazolamide is combined with Dimenhydrinate.
Acetophenazine
The risk or severity of CNS depression can be increased when Dimenhydrinate is combined with Acetophenazine.
Acrivastine
...
**Synonyms:** (O-benzhydryl(dimethylamino)ethanol) 8-chlorotheophyllinate
...
**IUPAC Name:** 8-chloro-1,3-dimethyl-2,3,6,9-tetrahydro-1H-purine-2,6-dione; [2-(diphenylmethoxy)ethyl]dimethylamine
...
Dimenhydrinate
is a medication used to prevent and treat nausea, vomiting, vertigo, and motion sickness.
...
InChI
Similar Structures
Structure for Dimenhydrinate (DB00985)
×
Close
...
,
13
While the exact mechanism of action is unknown, diphenhydramine is theorized to reduce disturbances to equilibrium through antimuscarinic effects or histamine H1 antagonism.
7
8-chlorotheophylline may produce excitation through blocking adenosine receptors, reducing the drowsiness produced by diphenhydramine.
13
Target
Actions
Organism
...
Dimenhydrinate is predominantly eliminated in the urine.
12
...
1999-07-29
Canada
Dimenhydrinate Injection 50mg/ml
Solution
50 mg / mL
...
Spealman RD: Psychomotor stimulant effects of methylxanthines in squirrel monkeys: relation to adenosine antagonism. Psychopharmacology (Berl). 1988;95(1):19-24. [
Article
]
Koch A, Cascorbi I, Westhofen M, Dafotakis M, Klapa S, Kuhtz-Buschbeck JP: The Neurophysiology and Treatment of Motion Sickness. Dtsch Arztebl Int. 2018 Oct 12;115(41):687-696. doi: 10.3238/arztebl.2018.0687. [
Article
]
FLEMING JF: New drug effective in motion sickness. Hosp Top. 1949 Mar;27(3):26. [
Article
]
...
FERMIN H, van DEINSE JB, HAMMELBURG E: The effect of dimenhydrinate upon the labyrinth; (an experimental study). Acta Otolaryngol. 1950 Dec;38(6):543-9. doi: 10.3109/00016485009118417. [
Article
]
FDA Approved Drug Products: Dimenhydrinate Oral Liquid (Discontinued) [
Link
]
Dailymed: Dimenhydrinate Oral Tablet [
Link
]
Dailymed: Dimenhydrinate Intramuscular and Intravenous Injection [
Link
]
US Patent: US2499058A [
Link
]
Sandoz Canada: Dimenhydrinate Intramuscular and Intravenous Injection [
Link
]
Heads of Medicines Agencies Public Assessment Report: Dimenhydrinate Oral Lozenge [
Link
]
...
Cost
Unit
Dimenhydrinate 50 mg/ml vial
5.7USD
ml
Dimenhydrinate I.M. 50 mg/ml
1.17USD
ml
...
0.42USD
tablet
Dimenhydrinate I.V. 10 mg/ml
0.32USD
ml
Dramamine 50 mg tablet
0.28USD
tablet
Novamine 15% iv solution
0.09USD
ml
Dimenhydrinate 100% powder
0.07USD
g
...
`,
  "protestkit": `{
  "url": "https://drugs.tripsit.me/dramamine",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_Dimenhydrinate.shtml",
  "name": "Dimenhydrinate",
  "aliases": [
    "gravol"
  ],
  ...
  "tripsit-factsheets": `# Dimenhydrinate
*Source: TripSit Factsheets (tripsit.me)*

## Summary

A combination of diphenhydramine and a mild stimulant to counteract the drowsiness accompanied by typical medical use of diphenhydramine. Roughly half the potency of diphenhydramine. Small doses can relieve motion sickness, reduce body load from opioids or dextromethorphan. The drug produces deliriant effects in higher doses, keeping the user awake and often causing dysphoric, realistic hallucinations.

## Classification
- **Categories:** depressant, deliriant, common
- **Also known as:** dimenhydrinate, gravol
...
*Note:  NOTE: Greater caution is recommended with this drug due to it being a deliriant.*
...
*Source: https://en.wikipedia.org/wiki/Dimenhydrinate*
...
The diphenhydramine component requires about 2 hours to reach peak concentration after either oral or sublingual administration of dimen­hydrinate, and has a half-life of 5 – 6 hours in healthy adults.
