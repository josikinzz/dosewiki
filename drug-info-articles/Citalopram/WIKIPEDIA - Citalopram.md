# Citalopram
*Source: https://en.wikipedia.org/wiki/Citalopram*
...
Citalopram has a ~6-fold higher affinity for H1 histamine receptors than (S)-citalopram (Ki = 257nM vs 1500nM), though the clinical significance of this difference is unknown. Both citalopram and escitalopram have similar affinities for the σ1 receptor (Ki = 50nM).
