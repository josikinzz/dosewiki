...
export const substanceName = "Khat";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Khat.json","displayName":"Protest Kit","size":1220},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Khat.md","displayName":"TripSit Factsheets","size":452},{"id":"wikipedia","fileName":"WIKIPEDIA - Khat.md","displayName":"Wikipedia","size":36587}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/khat",
  "experiencesUrl": "https://www.reddit.com/search/?q=Khat",
  "name": "Khat",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# Khat
*Source: TripSit Factsheets (tripsit.me)*

## Summary

A shrub whose leaves contain Cathinone and Cathine, they are typically chewed for the stimulant effect they provide. There is a very long history of human use for this drug.

## Classification
- **Categories:** habit-forming, stimulant
...
`,
  "wikipedia": `# Khat
*Source: https://en.wikipedia.org/wiki/Khat*
...
Khat is a slow-growing shrub or tree that typically attains a height of 1–5 meters (3 feet 3 inches – 16 feet 5 inches). However, it can reach heights of up to 10 m (33 ft) in equatorial areas. The plant usually grows in arid environments, at a temperature range of 5–35 degrees Celsius (41–95 degrees Fahrenheit). It has evergreen leaves, which are 5–10 centimeters (2–4 inches) long and 1–4 cm (0.39–1.6 in) broad.
...
In Taiwan, khat is illegal. It is classified as a narcotic drug.
...
In 2017, 5815 kg of khat was discovered by customs officials in Frankfurt. In June 2018, 324 kg of khat was discovered in packages from East Africa.

#### Greece

In the Hellenic Republic, khat is classified as an illegal narcotic under Law 3459/2006 (the Code of Laws on Narcotics).
In August 2025, Greek customs officials at Athens International Airport seized a record 500 kilograms of khat with an estimated street value of €1.5 million, underscoring its continued prohibition and enforcement.
