# Heroin - Testing Guide
*Source: https://www.protestkit.eu/how-to-test-heroin-opioids/*

*How to test HEROIN (opioids)? — PRO Test*
...
[0 Comments](https://protestkit.eu/how-to-test-heroin-opioids/#respond) 
29 September 2020
...
**How to test Heroin (opioids):** if you intend to use a psychoactive substance first you need a test kit to check purity. Pure heroin can’t be identified by appearance. Check your sample with a single or multi-use [heroin test kit](/heroin-en/).

### Heroin tester

### Recommended heroin testing kits

Recommended multi-use [Heroin Reagent Test Kit](/opioids-reagent-test-kit/) includes reagents Marquis, Mecke, Froehde and fentanyl test strips. Reagents are required to identify heroin or other opioids, while fentanyl test kit is irreplacable to detect presene of fentanyl, even if mixed in and present in trace amounts. To discover full ingredients and estimate heroin % pair reagents with the [Full TLC Purity Test Kit](/full-tlc-purity-test-kit/). To detect fentanyl use the [fent strips](/product/fentanyl-test-strips/).
...
![How to test HEROIN (opioids)?](data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width='0'%20height='0'%20viewBox=%270%200%200%200%27%3E%3C/svg%3E)

![How to test HEROIN (opioids)?](/wp-content/uploads/2020/12/protestkit_pictograms.webp)

### Watch how to test heroin with reagents:

### Watch how to test heroin with reagents:

**TL;DR:** Below is an image with a quick cheat sheet how to use [the Heroin Test Kit](/opioids-reagent-test-kit/) and further down you can check out more detailed guide how to test heroin. Use the heroin reagent test chart to see how to use [Marquis reagent](/marquis-reagent-test-kit/), [Mecke](/mecke-reagent-test-kit/) and [Froehde](/froehde-reagent-test-kit/). Check the expected results.

### Heroin test results chart:

| **TEST** | **Heroin** |
| --- | --- |
| [MARQUIS](/marquis-reagent-test-kit/) | Reddish purple |
| [MECKE](/mecke-reagent-test-kit/) | Green-blue |
| [MANDELIN](/mandelin-reagent-test-kit/) | Red > Dark brown |
| [LIEBERMANN](/liebermann-reagent-test-kit/) | Purple / black |
| [FROEHDE](/froehde-reagent-test-kit/) | Purple red > black |
...
| [ZIMMERMANN](/zimmermann-reagent-test-kit/) | No color change |
| [CANNABIS (4-AP) ](/cannabis-reagent-test-kit/) | No color change |

![Opioids Test Color Chart](data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width='0'%20height='0'%20viewBox=%270%200%200%200%27%3E%3C/svg%3E)

![Opioids Test Color Chart](/wp-content/uploads/2020/12/opioids_chart_2023.webp)
...
| --- | --- |
| HEROIN / CODEINE / O-DSMT /  2C-B /  MDMA / MDA / METH/AMPHETAMINE | Marquis Mecke Froehde single-use heroin test kit multiple-use heroin test kit |
...
- **[Froehde](../product/froehde-reagent-test-kit/)** – main test for most powders, secondary test for ketamine and amphetamines, long shelf life
- Single use [heroin test kit](/opioids-single/) includes Froehde reagent
- Multi use [heroin reagent test kit](/opioids-reagent-test-kit/) includes reagents Marquis, Mecke and Froehde

[Froehde reagent](/morris-reagent-test-kit/) is the main test for heroin as it can tell it apart from codeine. It should not be used alone, requires Marquis and Mecke to confrm presence of specific opioids.
...
![Marquis reagent tests for MDMA and 2C-B](/wp-content/uploads/2020/10/miniaturka-coca.webp)
...
Reagent tests can indicate PRESENCE, but not QUANTITY. Mixtures can be detected with reagents only if adulterant causes a darker color change than the expected substance. To detect all ingredients and estimate their amount pair reagents with a TLC purity test kit. 
 .accordion-content
- What is included in Opioids Reagent Test Kit? 
 .accordion-title 

Opioids Reagent Test Kit includes 4 fentanyl test strips, 3 reagents (Froehde, Marquis, Mecke), absorbent vermiculite, a porcelain reaction plate, a spatula, gloves, instructions and app for all test kits and over 800 substances. Every bottle contains 10 ml of crystals, 100 tests of each in total. High quality HDPE and brown amber glass protect reagents from light, plastic and moisture to ensure prolonged shelf life. Child-proof caps guarantee 0 spills. 
 .accordion-content
- What is each reagent test for? 
 .accordion-title 

Opioids Test Kit is best for heroin or other opioids but is also suitable for meth/amphetamines, MDxx and more.
...
Reagents can indicate PRESENCE, but not QUANTITY. Adulterants can be detected with reagents only if they cause a darker color change than the expected substance. To detect all ingredients and estimate their amount pair reagents with a TLC purity test kit. 
 .accordion-content
- How to use Opioids Reagent Test Kit? 
 .accordion-title 
...
Clean used reagent tools / testing surface with lots of running water and detergent, avoid contamination. 
 .accordion-content
- How to interpret Opioids Test Kit results? 
 .accordion-title 

Opioids Test Kit Chart
Expected opioids test kit results:

Marquis reagent – purple (heroin)
Mecke reagent – green (heroin)
Froehde reagent – purple (heroin)
...
 CHECK ALL REAGENT TEST REACTIONS IN RESULTS APP AT PROTESTKIT.EU/RESULTS 
 .accordion-content
- How to handle Opioids Test Kit? 
 .accordion-title 
...
Reagents deteriorate with time or due to contact with air, especially if exposed to sunlight or not refrigerated. If you are uncertain whether the reagent will work, test it with an already confirmed sample. 
 .accordion-content
- How to test opioids for fentanyl? 
 .accordion-title 
...
![How to test HEROIN (opioids)?](/wp-content/uploads/2020/09/TLC_pictograms.jpg)

### Watch how to test heroin with TLC:
