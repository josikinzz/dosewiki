...
export const substanceName = "Kola_Nut";
export const sources = [{"id":"drugusersbible","fileName":"DRUGUSERSBIBLE - Kola_Nut.md","displayName":"Drug Users Bible","size":1279},{"id":"wikipedia","fileName":"WIKIPEDIA - Kola_Nut.md","displayName":"Wikipedia","size":7552}];
export const contents: Record<string, string> = {
  "drugusersbible": `# Kola Nut
*Source: Drug Users Bible by Dominic Milton Trott*

*Section 3.3.10 - BOTSCAPE: A Botanical Journey*
...
In terms of oral consumption, botanical powders are not my thing. More specifically,
I tend to find that they frequently refuse to dissolve properly, and that their
constitution is less than agreeable. Whilst I struggled a little with kola nut, at least it
didn’t taste revolting (à la kratom) as I swigged the fine woody-like powder down the
hatch with water.

This is widely used in Africa, and it is claimed to increase both endurance and
concentration, as well as act as a mild aphrodisiac.

It had a definite coffee-like kick to it. It was not overwhelming at the dose I used, but
the strength was there. I felt clear, awake and a little energised, with a slightly jittery
edge. This lasted for some hours.

Note that I consumed in the morning, which I suspect was a good idea with respect
to retaining a sensible sleep pattern.
`,
  "wikipedia": `# Kola nut
*Source: https://en.wikipedia.org/wiki/Kola_nut*
...
About 5 centimetres (2 in) across, the kola nut is a nut of evergreen trees of the genus Cola, primarily of the species Cola acuminata and Cola nitida. Cola acuminata, an evergreen tree about 20 meters in height, has long, ovoid leaves pointed at both the ends with a leathery texture. The trees have cream-white flowers with purplish-brown striations, and star-shaped fruit consisting of usually five follicles. Inside each follicle, about a dozen prismatic seeds develop in a white seed-shell. The nut has a reddish or white color flesh on the inside, and has a sweet and rose-like aroma. 
...
In 2022, world production of kola nuts was 315,024 tonnes (694,509,000 lb), led by Nigeria with 55% of the total (table).
...
The nut was a major trade commodity in intra-African trade, being imported from the Ashanti region of Ghana by large caravans heading to further inland markets such as Kano and Bornu where their primary consumers were aristocrats and scholars. Kola nuts were used as an ingredient within Coca-Cola and Pepsi-Cola in 1886 and 1888 respectively. Kola nuts are an important part of the traditional spiritual practice, culture, and religion in West Africa, particularly Ghana, Niger, Nigeria, Sierra Leone, Democratic Republic of Congo and Liberia.
