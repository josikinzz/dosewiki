...
export const substanceName = "Opium";
export const sources = [{"id":"drugbank","fileName":"DRUGBANK - Opium.md","displayName":"DrugBank","size":15520},{"id":"drugusersbible","fileName":"DRUGUSERSBIBLE - Opium.md","displayName":"Drug Users Bible","size":2507},{"id":"protestkit","fileName":"PROTESTKIT - Opium.json","displayName":"Protest Kit","size":1664},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Opium.md","displayName":"TripSit Factsheets","size":941},{"id":"wikipedia","fileName":"WIKIPEDIA - Opium.md","displayName":"Wikipedia","size":67584}];
export const contents: Record<string, string> = {
  "drugbank": `# Opium
*Source: https://go.drugbank.com/drugs/DB11130*
...
Papaver somniferum
, which is more known as poppies. This plant is an integrant of the Papaveraceae family, and it is characterized by solitary leaves and capsulated fruits. Therefore, opium is a sticky brown resin obtained by collecting and drying the latex that exudes from the poppy pods.
13
...
14
Opium has gradually been superseded by a variety of synthetic opioids and general anesthetics. Some of the isolated derivatives of opium are morphine, noscapine, strychnine, veratrine, colchicine, codeine, and quinine.
2
Opium is a prohibited drug of abuse in most countries, but the illegal production of this drug and its derivatives keeps being registered. There is some legal production of opium in different countries for the obtention of alkaloids by extraction.
15
...
11
The direct use of opium is not common nowadays but the use of some of its derivatives such as morphine and codeine, as well as the use of a tincture of opium for severe diarrhea can be seen in medical practice.
12
...
After oral administration, opium bioavailability is poor.
9
In the form of opioid tincture, the Cmax and AUC of opium are between 16-24 mg/ml and 3237-6727 ng/ml.h, respectively.
4

### Metabolism

Opium contains 50 different alkaloid opiates. The most common metabolism of opiates is to be ultimately converted to morphine which is further converted to morphine-3,6-diglucuronide.
16
...
18
For years, because of this metabolism pathway, it was very hard to differentiate between illicit heroin users and involuntary exposure to poppy seeds. The original tests for this differentiations were based in the presence of morphine in urine without evidence of 6-monoacetylmorphine. Now it is known the presence of a glucuronide metabolite only in the consumption of heroin called ATM4G and this allows a clear differentiation of the consumption of illegal heroin and poppy seed ingestion.
6
...
1,2-Benzodiazepine
The risk or severity of adverse effects can be increased when Opium is combined with 1,2-Benzodiazepine.
Abacavir
Abacavir may decrease the excretion rate of Opium which could result in a higher serum level.
Abametapir
The serum concentration of Opium can be increased when it is combined with Abametapir.
Abatacept
The metabolism of Opium can be increased when combined with Abatacept.
Abiraterone
The metabolism of Opium can be decreased when combined with Abiraterone.
...
Opium
is a medication used to treat moderate to severe pain.
...
Opium is a mixture of different alkaloids including morphine and codeine. After a single ingestion of opium preparations, codeine and morphine can be found excreted in urine. The presence of codeine and morphine in urine seems to be detectable 2-12 hours and 2-36 hours post administration, respectively. The urinary excretion of morphine and codeine seems to be longer as the dose of opium is increased. After multiple dosages of opium, the presence of codeine and morphine in urine could be detected even after 48 and 84 hours post administration, respectively.
7
...
Source
boiling point (°C)
73.3ºC (Opium 2% tincture)
'MSDS'
water solubility
Soluble (Opium 2% tincture)
'MSDS'
...
`,
  "drugusersbible": `# Wild Lettuce
*Source: Drug Users Bible by Dominic Milton Trott*

*Section 3.4.24 - BOTSCAPE: A Botanical Journey*

## Quick Reference
- **Binomial / Botanical Name:** Lactuca Virosa
- **Street Names:** Bitter Lettuce; Laitue Vireuse; Opium
...
It is easy to confuse this with the common lettuce, as purchased from the
supermarket. Whilst I should categorically state that it is a different member of the
genus, I should add that there is more to the family itself than meets the eye.

I purchased a pack of wild lettuce in Australia, as a self-help remedy for jet lag. I
simply couldn’t sleep through the nights. My experiments with this were therefore
undertaken at unconventional times: I smoked it from a small pipe at 3am and 4am
respectively.

Did it work?

No, at least to the extent that it didn’t send me to sleep. I continued to toss and turn
hopelessly.

Was it psychoactive?

Yes. Even though I already felt rather strange, courtesy of the jet lag, this changed the
complexion of the feeling slightly.

There was a definite sedation, as there was the following day when I consumed this
as tea. It was more anxiolytic than sleep inducing, with a heady presence. Perhaps
the latter is what causes some users to claim that it has an opium type feel;
something which I didn’t really notice.

Although minor, a background form of sedating psychoactivity was certainly in play,
via both RoA’s.

THE IMPULSE OF YOUTH
As an aside, this was not my first experiment with the lettuce family. Many years ago,
I read somewhere that all lettuces were, to some degree, psychoactive.

Whether this was true or not, the impulse of youth drove me to purchase two whole
lettuces, and eat them, or at least, eat as much as I possibly could. This amounted to
approximately one lettuce and a half.

I have no idea which type of lettuce these were, but they were procured as normal
lettuces from a normal grocer.

I ate them in the evening, and dropped into a deep and extremely long sleep (10+
hours) a few hours later. At the time I was astonished, and never saw the humble
lettuce in the same light again.

During the research for this book, I discovered that perhaps there is something to it,
as lettuce is often promoted as a natural remedy for insomnia.
...
`,
  "protestkit": `{
  "url": "https://drugs.tripsit.me/opium",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_Opium.shtml",
  "name": "Opium",
  "aliases": [
    "o"
  ],
...
## Additional Information
- **Avoid:** The drug has a high rate of overdoses and it is strongly recommended against using foil to smoke it.

## External Links
- [experiences](https://www.erowid.org/experiences/subs/exp_Opium.shtml)
`,
  "wikipedia": `# Opium
*Source: https://en.wikipedia.org/wiki/Opium*
...
The production methods have not significantly changed since ancient times. Through selective breeding of the Papaver somniferum plant, the content of the phenanthrene alkaloids morphine, codeine, and to a lesser extent thebaine has been greatly increased. In modern times, much of the thebaine, which often serves as the raw material for the synthesis for oxycodone, hydrocodone, hydromorphone, and other semisynthetic opiates, originates from extracting Papaver orientale or Papaver bracteatum. In preparation for the Second World War, the U.S. Army contracted farmers in the State of Sinaloa, Mexico, to grow opium crops. This was to provide morphine (the gold standard of analgesia) for injured soldiers. Modern opium production, once widely prohibited, still involves large-scale cultivation—especially in Afghanistan—where it is harvested by scoring poppy pods to collect latex used for both illicit drugs and legal medicines, with recent Taliban-led reductions cutting cultivation in Afghanistan by over 95%.
...
In 2002, the price for one kilogram of opium was US\$300 for the farmer, US\$800 for purchasers in Afghanistan, and US\$16,000 on the streets of Europe before conversion into heroin.
...
Raw opium may be sold to a merchant or broker on the black market, but it usually does not travel far from the field before it is refined into morphine base, because the pungent, jelly-like form of raw opium is bulkier and harder to smuggle. Crude laboratories in the field are capable of refining opium into morphine base by a simple acid-base extraction. A sticky, brown paste, morphine base is pressed into bricks and sun-dried, and can either be smoked, prepared into other forms or processed into heroin.
...
In 2023 Burma overtook Afghanistan and became the world's largest producer of opium, producing 1080 metric tones according the UN Southeast Asia Opium Survey report.
...
In 2021, the International Agency for Research on Cancer concluded that opium is a Group 1 (sufficient evidence) human carcinogen, causing cancers of the larynx, lung, and urinary bladder.
