...
export const substanceName = "Jenkem";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Jenkem.json","displayName":"Protest Kit","size":743},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Jenkem.md","displayName":"TripSit Factsheets","size":124},{"id":"wikipedia","fileName":"WIKIPEDIA - Jenkem.md","displayName":"Wikipedia","size":8097}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/jenkem",
  "experiencesUrl": "https://www.reddit.com/search/?q=Jenkem",
  "name": "Jenkem",
  "aliases": [],
  "aliasesStr": "",
...
## Classification
- **Categories:** deliriant, tentative
`,
  "wikipedia": `# Jenkem
*Source: https://en.wikipedia.org/wiki/Jenkem*
...
In November 2007, there was a moral panic in the United States after widespread reports of jenkem becoming a popular recreational drug in middle and high schools across the country, though the validity of this claim has since been called into question. Several sources reported that the increase in American media coverage was based on a hoax and on faulty Internet research.
