...
export const substanceName = "DMT";
export const sources = [{"id":"disregardeverythingisay","fileName":"DISREGARDEVERYTHINGISAY - DMT.md","displayName":"DEIA","size":17653},{"id":"dmturner","fileName":"DMTURNER - DMT.md","displayName":"D.M. Turner","size":21481},{"id":"drugusersbible","fileName":"DRUGUSERSBIBLE - DMT.md","displayName":"Drug Users Bible","size":8261},{"id":"isomerdesign","fileName":"ISOMERDESIGN - DMT.md","displayName":"Isomer Design","size":28084},{"id":"protestkit","fileName":"PROTESTKIT - DMT.json","displayName":"Protest Kit","size":7936},{"id":"saferparty","fileName":"SAFERPARTY - DMT.md","displayName":"Safer Party","size":4136},{"id":"thedrugclassroom","fileName":"THEDRUGCLASSROOM - DMT.md","displayName":"The Drug Classroom","size":38463},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - DMT.md","displayName":"TripSit Factsheets","size":3281},{"id":"wikipedia","fileName":"WIKIPEDIA - DMT.md","displayName":"Wikipedia","size":60864}];
export const contents: Record<string, string> = {
  "disregardeverythingisay": `# DMT
*Source: https://disregardeverythingisay.com/post/21660249429/dmt-broken-down-and-described*

*Disregard Everything I Say - DMT, broken down and described*

![image](https://64.media.tumblr.com/d21f7104f2e66c6a2ae297fb15790667/tumblr_inline_p7j1kleN8O1qziutd_400.png)
...
It is so vastly different from anything else a person has previously experienced that not even the most extreme of sober circumstances could ever come close in terms of profoundness and intensity.

DMT is broken down by the digestive enzyme monoamine oxidase through a process called deamination and is therefore inactive if taken orally unless combined with a monoamine oxidase inhibitor (MAOI) such as harmaline or a reversible inhibitor of monoamine oxidase A (RIMA) such as harmine. This is how DMT is taken traditionally within Southern American tribes, through a mixed brew known as Ayahuasca, which has its own dedicated guide [here](http://www.disregardeverythingisay.com/post/16326142673/ayahuasca-broken-down-and-described).

The DMT experience contains a complex and wide array of effects which based on the predefined potential subjective effects index found [here](http://psychonautwiki.org/wiki/Subjective_effects_index), I will now begin to breakdown and describe.
...
- **Visual drifting** (*Melting, Breathing, Morphing and Flowing*) - In comparison to other psychedelics, this effect can be described as highly detailed, slow and smooth in motion and static in its appearance.
- **Tracers**
- **After images**
- **Texture repetition**
- **Colour shifting**
...
The visual geometry that is present throughout this trip can be described as more similar in appearance to that of psilocin than LSD. It can be comprehensively described as structured in its organization, organic in geometric style, intricate in complexity, large in size, fast and smooth in motion, colourful in scheme, glossy in colour, equal in blurred and sharp edges and equal in rounded and angular corners. At higher dosages, the geometry is significantly more likely to result in states of Level 7B visual geometry over Level 7A.
...
**The Second Stage: The Waiting Room**
...
This distinctive feeling has led me to speculate that this is some sort of psychedelic loading screen and it’s during this moment that the trip ahead of you is being generated and planned out.

The waiting room starts off quickly but immediately begins to slow down and form into the third and most important stage.

**The Third Stage: The Other Side**
...
If you are motivated to experience this drug, it is completely possible to make through some very simple kitchen based chemistry described in detail [here](http://disregardeverythingisay.tumblr.com/post/15411034779/simple-dmt-extraction-technique). The recipe requires only legal and freely available ingredients (all of which can be found through Google). 
 Keep in mind, however, that this is extremely illegal and I am in no way responsible for your actions.

**Misconceptions:**

Before I finish this article off I am going to address the extremely common misconceptions and borderline mysticism that surround this drug all over the internet. These misconceptions are the widely held belief that DMT is naturally produced in the pineal gland and is routinely released every night when we dream, at the moment of birth and at the moment of our death. There is not yet any conclusive scientific evidence that it is released during dreams, birth and death. Despite this however, many people on the internet claim it to be fact on a regular basis.
...
This is not something that the scientific consensus supports but as I mentioned earlier, it has been conclusively proven that trace amounts of DMT have been found in the blood, urine and cerebreal spineal fluid of some mammals including humans. A great little list of them can be found [here](http://en.wikipedia.org/wiki/Dimethyltryptamine#Endogenous_DMT). DMT has also been found within the pineal glands of rats, but this does not mean we have any reason to believe that it is released during birth, death and dreams.

Stopping the spread of pseudoscience and misinformation across the psychedelic community is important if we want our position to be taken seriously so this is not something that should be tolerated.

**Reader submitted trip reports:**

- [40mg (smoked) - The planet became a watermelon](http://psychonautwiki.org/wiki/Experience:40mg_(smoked)_-_The_planet_became_a_watermelon) by *[Gregasaurus](http://psychonautwiki.org/wiki/User:Gregasaurus)*
- [40mg smoked - Ego death and unity with a friend](http://psychonautwiki.org/wiki/Experience:40mg_smoked_-_Ego_death_and_unity_with_a_friend) by *[Sem'anis](http://psychonautwiki.org/wiki/User:Sem%27anis)*
- [unknown dosage (smoked) - It felt like I was on rails the whole time ](http://psychonautwiki.org/wiki/Experience:Unknown_dosage_(smoked)_-_It_felt_like_I_was_on_rails_the_whole_time)by *[Gregasaurus](http://psychonautwiki.org/wiki/User:Gregasaurus)*
- [80mg - progressing deeper into states of unity and interconnectedness](http://psychonautwiki.org/wiki/Experience:80mg_-_progressing_deeper_into_states_of_unity_and_interconnectedness) by *[Anonymous](http://psychonautwiki.org/wiki/Anonymous)*

**Conclusion:**

The things experienced on this drug are incredible and completely logic defying, if a single object could be somehow brought back into the real world from such a place nothing would ever be the same again as the sheer impossibility of these things would instantly break reality.
...
Click **[here](http://psychonautwiki.org/wiki/DMT)** for a more comprehensive breakdown.`,
  "dmturner": `# DMT
## CANDY FOR THE MIND
...
5-MeO-DMT is an MAO inhibitor. See
list of items not to take with MAO inhibitors on page 19. Since DMT takes
effect almost immediately, users normally lie down or sit in a reclining
position prior to taking a hit. One will neither be able to stand up, or
have the ability to recognize their surroundings if they get a good hit.
### MATERIAL

N,N-Dimethyltryptamine and
5-Methoxy-Dimethyltryptamine are naturally occurring psychedelics found
...
the plants, are also found in the human brain as neurotransmitters, as
well as m our blood, urine, and spinal fluid [1].
DMT is produced in the human pineal gland which is correlated to the "3rd
eye" or Ajna Chakra in the Indian spiritual system. Meditative states attained
by yogis who concentrate on the 3rd eye may be the result of increased
DMT levels. DMT is produced in heavy concentration in the glands of some
tropical toads, such as Bufo Alvarius. Some people actually make a practice
of squeezing out this venom, then drying and smoking it to get high.
N,N-DMT and 5-MeO-DMT are also
manufactured synthetically, as separate compounds, and sold on the underground
market And although it's quite rare in the psychedelic underground, synthetic
DMT is used much more often than DMT from natural sources.
### HISTORY

There are several plant sources of
DMT, many of which have uniquely different histories of use. Normally DMT
is not active if taken orally. It must be either smoked or snorted for
any psychoactive effects. To obtain a full strength DMT experience, one
must take the entire dose into their system in a short period of time.
Two sources of DMT, Anadenanthera
peregrina and Virola theiodora, are made into snuffs, commonly
known as Yopo and Epena, respectively. The natives of the Amazon region
have ingenious methods for getting a good dose of these snuffs. One method
calls for a "snorter" through which they inhale with both nostrils at once.
The most effective is a snorting device for two people. This device has
a tube going from the mouth of each person to the nose of the other Rather
than snorting, once the device is loaded, one person "blows'; the DMT snuff
into the other's nose, getting a large amount deep into the nasal cavity.
The person who received the first hit must quickly blow a dose into the
other person's nose before falling into a tryptamine trance, "trypping."
Elsewhere in the Amazon, DMT-containing
plants like Psychotria veridis are included in brews known as Ayahuasca
or Yage. These brews include Banisteriopsis caapi, which is a source
of Harmala alkaloids, and occasionally plants from the Belladonna family.
The combination of Harmala alkaloids and DMT is amazing. The Harmala alkaloids
intensify the DMT "tryp," and in my opinion produce a deeper, more spiritual
experience. The Harmala alkaloids which are MAO inhibitors, also allow
the DMT to be active when taken orally.
How the natives discovered this combination
boggles the mind. The healers and shamans that work with Ayahuasca claim
that the spirits of the plants talk to them, telling them which plants
to use in their brews, and which plants will heal various diseases. I believe
their claims, since they certainly didn't have modern technical knowledge
to predict the results of such combinations. And it's unlikely they could
have tried all of the combinations of the thousands of plants growing in
the Amazon jungle. I've also noticed increased synergy with plant consciousness
in my own DMT experiments.
### DOSAGE and ADMINISTRATION

The dosage for 5-MeO-DMT is 5 to 10
mg. The dosage for N,N-DMT is about 40 mg. Smaller amounts will
produce some perceptual changes but will not bring one to the unique dimensions
normally reached on DMT. The entire dose of DMT needs to be consumed in
a short amount of time. If one doesn't get enough within the first 60 seconds
they won't get much higher by smokmg more.
Synthetic DMT usually comes in a crystalline
form as an off-white to brownish or yellowish powder. Smoking DMT can be
tricky. I load the DMT into a glass pipe with a fine mesh stainless steel
screen. The flame should be kept about 1/2" away from the DMT. Toking very
slowly, I draw in enough heat to melt and then vaporize the DMT. The flame
...
the more I seem to get out of it. I've also found it helpful to place a
small amount of ash in the bottom of the pipe bowl. This will work to hold
the melted DMT before it is vaporized to prevent it from running through
the screen and down the stem of the pipe. One can also use a hash oil pipe,
but it's easy to burn your mouth with a concentrated hit of hot vapor.
The smoke has a harsh, plastic-like taste, and tends to make people yak.
I've had to train my lungs not to cough it out. Although it's harsh comma
in, it doesn't expand like cannabis, and the smoke cools quickly.
Glass pipes can be difficult to find.
Many head shops don't sell them since they are often used for crack cocaine.
A pipe made of another material will work, but does not allow one to look
into the bowl to monitor the melting/vaporization of the DMT, and to see
if it's leaking through the screen and running down the stem of the pipe.
I also enjoy watching the intricate patterns of the DMT recrystallizing
inside the stem, and more importantly, once enough has collected on the
inside of the stem, I can heat up a glass pipe for a few good hits.
Sometimes DMT comes soaked into parsley
flakes or cannabis. This is frequently done with 5-MeO-DMT since the amount
required for one high, 5 to 10 mg., can only be weighed on a sophisticated
scale. In this case one must smoke the DMT by burning the parsley or cannabis
This will work, but not quite as well as vaporization.
Plant material containing DMT requires
some method of extraction prior to use. Most of the plants containing DMT
are scarce in this country, and instructions for a pure DMT extraction
are hard to find. Typically, DMT-containing plants are used in a brew,
in combination with Harmala alkaloids. This way one need not be concerned
with getting the entire dose in a short amount of time, and a simple water
extraction should suffice.
### THE HIGH

The highs from N,N-DMT and
5-MeO-DMT are similar yet have some distinct differences. The typical DMT
tryp is an order of magmtude more potent than a trip on the traditional
psychedelics (LSD, psilocybin or mescaline). When smoking DMT the high
comes on within about 30 seconds. Within the next 30 seconds I am propelled
to a high as intense as the peak of a 1000+ mcg. acid trip. Generally by
this point I will be completely out of my body and unaware of my physical
surroundings. This intense part of the experience, although seeming timeless
while I'm in it, lasts only 2 to 5 minutes. I then drift back quickly to
regular consciousness. On 5-MeO I am back within 20 minutes, with N.N.I
am back in 30 minutes. In the Sixties DMT was called "The businessman's
lunch trip."
What one will experience on DMT is
impossible to predict. It can range from heaven to hell, cyberspace to
jeweled palaces, fear or personified evil, visions of jungle animals, contacts
with extraterrestrials, links with ancient spirits, or adventures with
fairies and elves. The DMT user should be prepared for anything. On a full
dose of DMT (or Ketamine) one can not guide the tryp with the mind or thoughts
the way an LSD trip can be guided. One can, however direct the tryp by
what I will call the "intent of the soul" or will.
Many users, including myself, have
felt possessed by various spirits while on DMT, as if becoming a medium
and channeling alien thoughts. This can be quite heavy. It has been generally
positive for myself and the people I've smoked DMT with, but I've heard
stories from others who have expenenced the opposite extreme.
On DMT the perception of time slows
to nearly a complete stop. During this stage one may feel that they are
not breathing, or that their heart has stopped. However, this is due to
one's state of perception. Many users report being aware of millions of
vibrations and sounds going through the universe and their bodies, the
body often bursting with energies they never knew existed. One can let
these feelings flow through them, or if appropriate, direct the movements
to some type of dance, yogic exercise, or drumming. These "physically manifesting"
energies are gentler on N,N-DMT than on 5-MeO-DMT.
DMT frequently produces changes in
the facial expression of the user, which can appear quite bizarre to an
onlooker. It would seem as though the human face has the potential for
a far greater number of expressions than we normally use, possibly even
the ability to carry on sophisticated communication through facial expression.
DMT acts as a catalyst to awaken this realm of movement by exercising the
muscles involved and realigning the underlying energies. It's also possible
for this realignment of energies to take place in other areas of the body,
occasionally instigating a shamanic dance.
In recent years DMT has become quite
notorious in the psychedelic underground, primarily through the writings
of Terence McKenna. And despite the fact that it is rare and highly sought
after, once it becomes available to those who are seeking it, very few
people use it frequently after a short period of initial use. I've assumed
that many people have joy rides for their first several trips, then have
an experience which is extremely frightening or intense, leaving them intimidated
about continuing DMT use. However, I like a friend's recent explanation
for this observation better: "DMT gets progressively 'weirder' as you keep
smoking it."
What I've described about DMT so far
can be applied to both varieties. However, some characteristics of the
two are quite different. I had been using 5-MeO-DMT for a few years before
obtaining any N,N-DMT. After I first tried N,N-DMT I concluded
that 5-MeO-DMT feels like sheer force, whereas N,N-DMT feels like
sheer perfection.
5-MeO-DMT is the more potent of the
two in terms of: the size of the dose required, how quickly it comes on
and how forcefully it blows apart my universe. On 5-MeO I can literally
feel my mind exploding and expanding outward to encompass first the area
near me, then the planet, and eventually the cosmos. This takes place over
a span of 15 seconds or so.
5-MeO does not produce as spectacular
visuals as N,N-DMT. Most frequently for me the 5-MeO visuals are
intensely complex, multidimensional, and quickly-moving geometric designs.
These, however, are primarily in black and white, checkerboard style. At
times there is some color, and on occasion the visuals are abundantly colorful,
...
some practice.
5-MeO increases pulse rate and blood
pressure, more so than N,N-DMT, but not to the extent as a whiff
of amyl nitrite. 5-MeO can also produce breathing irregularities which
may take some getting used to. If one does not get a good dose of 5-MeO
all they will feel are some bodily symptoms, and a slight alteration of
consciousness especially in the visual field. A small dose of N,N-DMT
will stili produce a psychedelic trip, but without the intensity and depth
of a full-dose experience.
N,N-DMT comes on a bit slower,
less forcefully, enchanting the smoker with its magical nature. I've often
found myself transported to a fairy tale world where little gnomes pop
out of nowhere, laugh, and smile at me. On N,N-DMT I've never had
to worry that the universe is too small to contain me and that I might
crash into its boundaries when my mind has expanded all the way. Where
5-MeO-DMT can awe or frighten with its incredible power N,N-DMT
tends to delight with its brilliant, magical, and hypnotic nature. This
is not to say that N,N-DMT experiences can not be frightening. In
a way they can be the most frightening of all psychedelic experiences,
since they leave a portion of the ego intact while allowing access to realms
of discarnate entities and awesomely powerful psychic energies. Almost
everyone I've known who has used N,N-DMT repeatedly, eventually
encounters deeper fear than they've ever felt before.
The visuals produced by N,N-DMT
are spectacular. I see more swirling, kaleidoscopic universes per square
millimeter of visual space than on anything else. The detail and intricacy
of the patterns and the brilliance of the colors is also unsurpassable.
The visuals are usually a mixture of kaleidoscopic-geometric forms, archetypal
symbols, and outlandish and unimaginable images of people, places and things.
The images also "move" and are arranged in a manner which is different
than the traditional psychedelics and in keeping with N,N-DMT's
enchanting nature.
If one smokes a smaller amount of N,N-DMT,
say around 20 mg., they will tend to experience only the visual aspect
of the high, without getting in touch with gnomes and discarnate entities.
Following is a friend's description of DMT visuals produced by smoking
20 mg. doses every 20 to 30 minutes. "The vibration is still very strong
at this level and objects in the room become cartoonish and jeweled with
rotating 'pools' of interlocked spiraling gems on wall surfaces and ceiling.
At the peak of the 20 mg. tokes, brilliantly changing latticework becomes
apparent within. A gooey liquid of phosphorescent brilliance knits itself
into neon lattices of emerald green and iridescent blue against a molten
gold background. Always changing, always new, always novel, these geometric
storms of shape and color never cease to amaze me with their beauty and
intricacy; something one can FEEL as well as see. Clouds of molten gold
liquid, boiling, seethe into arabesques and chainwork networks. Each node
of each net and lattice form a jeweled point of incredible pure color,
all rotating and pulsating through the eyes, brain, and stomach, as one
becomes a transparent electric ghost deciphering mysto-glyphs for eternity!
"
This next experience comes from a friend
who smoked a full-strength dose. "The stuff hit me instantaneously.
MILLIONS of brilliantly colored little 'skull clowns' swarmed me in a most
visionary way while emitting crickling, tinging sounds which looked like
violet sparks coming out of their mouths. These tiny skull clowns were
laughing most musically as I died in the light. Melt down - feels like
drowning and being electrocuted at the same time. Some fear is good though,
and pretty soon the skull clown swarm had laughed me through death to a
place of jeweled coiling roots and capillaries, swaying endlessly in a
gem lit sea... The glowing, ember-like afterimage instantly swirls and
shatters into blue and red sizzling domes that pinwheel ecstatically into
a Creative, God-Thing with a trillion jeweled eyes that dissolves into
an atomic ocean. This is the multi-eyed God that is my Creator, Master,
Destroyer. I am nothing compared to this Thing which has no ego boundaries
whatsoever and can turn into anything it damn well wishes, even death itself
if it wants to!"
DMT visuals are best in diffused sunlight,
in contrast to something like mushrooms whose visuals are best in a pitch
black forest. With DMT I've had excellent results adjusting my venetian
blinds so that grids of sunlight are bouncing around the room. Since all
psychedelics greatly enhance visual perception, I enjoy trying them with
as many different visual stimuli as possible: a pitch black room, a desert
sunset, full moonlight, blacklights, strobes, Pink Floyd concerts, raves,
multi-media images, and lasers.
N,N-DMT also has a unique "selective
anesthetic" property to it. Both body and mind feel simultaneously stimulated
and anesthetized, as though every other nerve were switched full on or
full off.
I've also been noticing an attribute
of DMT and psilocybin mushrooms (which are essentially long-lasting tryptamines)
which set these substances apart from other psychedelics such as LSD or
Ketamine. With LSD, Ketamine, or any other synthetic psychedelic, I typically
feel that I am interacting with my mind, and a universal process of consciousness
change where the self-identity is dissolved and then reformulated. These
same processes occur with DMT and mushrooms. However, with these substances
I often get the sense that I am also interacting with an intelligent entity
who is vastly superior to me in knowledge and breadth of consciousness.
This entity seems to be quite aware of what's transpiring in my mind, and
is able to instruct and to tailor the experience so that it's personally
suited to me.
With DMT one tends not to go through the personality breakdown
and rebuilding process that takes place with the traditional psychedelics.
Or if one does go through it, the process is so quick they tend not to
notice it happening. Under the force of DMT one must relax, release, and
let it come over them. Trying to resist DMT's overwhelming influence and
the inevitable dissolution of the identity will be unpleasant, and it won't
work. A DMT tryp tends to be out of body, out of personality, and sometimes
outside of the mind. For these reasons some people I know who've used DMT
do not consider it a good tool for psychological development. The DMT experience
can be like a quick trip to the void or the funhouse. Since it is so different
than normal reality it can be difficult for the user to bring any of the
tryp back to daily life. However, this changes significantly when DMT is
done in combination with the Harmala alkaloids.
### THE DMT HIGH WITH HARMALA ALKALOIDS

Harmala alkaloids potentiate DMT,
not only in intensity and duration, but also in content and quality. The
Harmala alkaloids also make DMT orally active, this being the method by
which DMT is traditionally consumed in the Ayahuasca brews of the Amazon
region. I have only recently begun experimenting with ingested DMT, and
these experiences are described later in the chapter DMT
~ Water Spirit. The Harmala alkaloids also intensify smoked DMT,
and I have described this method of administration below.
Prior to smoking or ingesting the DMT
one should wait until they are feeling the effects of the Harmala alkaloids.
This will prevent the DMT from being metabolized prematurely. (See chapter
on Harmala alkaloids.) Harmala only slightly
intensifies 5-MeO-DMT. Therefore, one still needs to smoke 5 mg. or so
to get a powerful high. It does, however, prolong the normally 2-3 minute
peak to 10-20 minutes, with the total experience lasting between 40 minutes
and two hours.
N,N-DMT is significantly intensified
by Harmala. Smoking 15-20 mg. of N,N-DMT while on Harmala will produce
an experience as intense as smoking 40 mg. of N,N-DMT by itself.
This is especially useful because it's difficult to smoke 40 mg. of harsh
tasting DMT. Harmala will also extend the N,N-DMT experience to
about 30 to 40 minutes total.
The high of both types of DMT while
on Harmala is a much slower process. I don't feel "blown out of my mind"
quite so quickly. The focus of the experience becomes personally involved,
rather than the feeling that I'm a voyager in some alien realm. I tend
to experience an increased awareness of my mind, body, and subtle energy.
I often feel that my body and Being are "embraced" by an ancient earth
spirit. And this earth spirit is instructing me to become aware of, and
open up, many lines of communication that exist between my mind, body and
the extemal world. In combination with Harmala the DMT high does not "disappear,"
leaving me suddenly back in normal reality. I have more time to absorb
the experience and make it a part of me.
The combination of 5-MeO-DMT and Harmala
produces the most powerful experience I have ever felt. This tends to be
both physically and mentally overwhelming. I've had some good journeys
with this combination but I've also become violently nauseous and experienced
extreme discomfort, and I've witnessed other people go through sheer misery.
One friend who ingested 5-MeO + Harmala felt he had entered into an ill-intentioned
pact with a spirit, and while trying to fight his way out of the pact,
went into convulsions and bit the inside of his mouth. Since there is such
a high percentage of intensely unpleasant experiences with this combination
I've recently reverted to taking 5-MeO-DMT alone, and most acquaintances
of mine who've used this combination have done likewise.
Some users feel that the DMT high is
"warbly" in combination with Harmala and lacks the "Diamond Consciousness"
of DMT alone. Since Harmala slows the onset of 5-MeO-DMT so drastically,
I've found that I lose much of the brilliance that can be experienced using
5-MeO-DMT alone. However, I don't find that Harmala produces any degradation
of the N.N. DMT experience. N,N-DMT is like a rocket to another
dimension, with or without the Harmala alkaloids.
1. See The Psychedelics Encyclopedia
by Peter Stafford`,
  "drugusersbible": `# DMT
*Source: Drug Users Bible by Dominic Milton Trott*

*Section 2.2.17 - CHEMSCAPE: A Chemical Journey*
...
Despite invoking what is possibly the most intense of psychedelic experiences, DMT
is found naturally within the human cerebrospinal system and elsewhere. Indeed, it
is frequently suggested that it is excreted by the pineal gland (in the centre of the
brain). Outside the human organism it is also present in mammals and many species
of plants, seemingly permeating nature itself.

Whilst I had previously engaged DMT as an ingredient of ayahuasca, smoking the
raw molecule produces a radically different and less gentle type of experience.
Unfortunately, smoking an effective breakthrough dose to achieve this is frequently
reported as being a difficult operation to execute.

The trick is to vaporize the crystals, rather than to burn them, which is apparently
easier said than done. Nonetheless, I set about the task with diligence and patience.

\`\`\`
BREAKTHROUGH ATTEMPT #1
For this attempt I obtained a glass pipe, courtesy of Amazon, for a grand total
of £5.95 (see image above). I began the experiment at 10am.
\`\`\`

\`\`\`
I placed 20mg of DMT into the pipe, and carefully heated the bottom of the
bowl with a lighter. As smoke began to appear, I inhaled, slowly. Nothing
happened; so I repeated several times until the crystals had all disappeared.
\`\`\`
\`\`\`
There were no hallucinations and no trip. There was an extremely mild
psychedelic type headspace, which lasted an hour or so. That was it.
\`\`\`
\`\`\`
My conclusion was that I must have burned the DMT, or even swallowed some
of the crystals before they melted. This was an abject failure.
\`\`\`
\`\`\`
BREAKTHROUGH ATTEMPT #2
Further research led me to buy a VaporGenie. This was a much more
expensive device, but contributors across multiple forums claimed great
success in using it to breakthrough. Regardless, it still sounded like a fiddly
exercise to undertake.
\`\`\`
\`\`\`
The experiment began at 7:30pm. I placed 22mg into the chamber of the
VaporGenie on top of a damiana ash bed, and sprinkled some further ashes on
top. On heating I inhaled, trying not to suck the flame deep enough into the
device to touch the DMT. I held the smoke nervously for 10 seconds and then
exhaled. I saw smoke dissipate into the air as I did so.
\`\`\`
\`\`\`
I knew that I was under some sort of influence almost immediately. I lay
down, placed my head on to a cushion and closed my eyes, largely because I
was chicken and didn’t want to see the world actually disintegrate before me.
\`\`\`
\`\`\`
The problem was that it didn’t. I missed the breakthrough again, and I missed
the famed chrysanthemum too (the alleged prelude to entering the main
hallucinogenic event).
\`\`\`
\`\`\`
However, what I did see were some glorious CEVs. There were concave
adornments on the walls of wherever I was. They were morphing a little, but
were largely stable and were of rich beautiful colours.
\`\`\`
\`\`\`
As I opened my eyes to check the real world status this vision immediately
disappeared. There were no OEVs of any significance, so I closed my eyes
again. Unfortunately, I couldn't reach the same clarity or intensity as
moments ago. However, what I had seen was somewhere; not just patterns,
but actual walls with indented window type alcoves (but without
transparency). It was like some grand medieval castle-like interior, but bright,
perfect and extremely colourful.
\`\`\`
\`\`\`
I was feeling fine, and not so scared, so I lit up again, inhaled, and held for
another ten seconds. This time I didn’t notice any smoke or vapour.
\`\`\`
\`\`\`
I embraced the notion that closing my eyes was a little like tuning into a
frequency. I simply chose to go there. It was a strange feeling.
\`\`\`

\`\`\`
I searched for the other-worldly interior again. There were CEVs but not
enough to frame the place. I suspect that the DMT may well have been largely
used or burned on the first hit.
\`\`\`
\`\`\`
I chased it three more times over the next 10 minutes, but all I could find was
the headspace and the colours.
\`\`\`
\`\`\`
I opened the pipe: only ashes remained.
\`\`\`
\`\`\`
I actually got somewhere with this attempt, but not far enough. However, I
was encouraged sufficiently to promise myself that I would try this again soon,
using the same technique, but being more careful with the flame, and perhaps
holding the smoke for longer.
\`\`\`
\`\`\`
I would say the duration of the main play was around 6 minutes, as generally
advertised.
\`\`\`
\`\`\`
As an experience it was perfectly fine, with interesting visuals, a nice
headspace, a certain contentment, a short duration, no body load, and some
afterglow. Without having some knowledge of where DMT can lead when fully
charged, I suspect that I would have been extremely happy with this, but I was
disappointed not to have broken through. I was determined to be bolder next
time.
\`\`\`
\`\`\`
Note that my subsequent sleep pattern was a little disrupted with several
wake-ups and some weird vivid dreams. Retro checking on the Internet, I
learned that this is quite a common phenomenon. This continued into a
second night, with sleep cycles broken by dreams which were sometimes not
very positive.
\`\`\`
\`\`\`
BREAKTHROUGH ATTEMPT #3
This time I measured 35mg and mixed it with the remaining ashes from
Attempt #2. I prepared in the same manner and initiated the experiment.
\`\`\`
\`\`\`
I misfired again, but I instantly understood why. I felt powder enter my mouth
as I inhaled. This was DMT and ash; unvaporised. I had inhaled too strongly,
and it was apparent that the chemical was not entrenched sufficiently below
the ash, which itself was not heavy enough.
\`\`\`
\`\`\`
The experience itself was much like a re-run of the second attempt, but the
visuals were more intense. Was that the initial framing of the famed orange
chrysanthemum I saw during the first few seconds? Perhaps, but it dissipated
very quickly, just as it started to form.
\`\`\`
\`\`\`
I felt a strange analgesic numbness of the body as I lay on the ground, and
again failed to recapture the same visual intensity once I had opened my eyes.
There were OEVs, but the real action was on the back of my eyelids.
\`\`\`

\`\`\`
Subsequently, Sleep was again disturbed, with strange vivid dreaming.
\`\`\`
Retrospectively, I feel that I should try to compare this with salvia divinorum, which
was the source of my first alien-reality type of encounter.

My experience of smoking salvia was of being pulled into a bright and lucidly
coloured out-of-body domain, which comprised sharp threatening echoed shapes,
framed on my original field of vision. I felt that my mind was being dragged outwards
into this abyss, as I struggled in absolute terror. This is considered by many to be a
form of delirium. However, given that oral consumption produces a different
response, I wouldn’t classify it as such.

DMT produced similarly wonderful colours, but it presented an actual locale, the
timeline was ordered, and there was no fear. Also, at the doses I sampled, I had the
capacity to proactively tune in to this construct, rather than being suddenly
wrenched into an inferno.

This intelligible character of ordered enfoldment is, in fact, the major difference
between DMT and the other psychedelic chemicals I have so far tested. With DMT I
wasn’t experiencing a variation of where I was at the moment I inhaled, but rather, I
found myself in entirely different surroundings, which had appeared from nowhere. I
had my faculties intact and my mind was rational, but I was transplanted into an
unknown setting, which appeared to comprise some sort of other-reality. This wasn’t
random patterns or shapes or bright lights, it was an actual place. This, of course,
renders it astonishing.
...
`,
  "isomerdesign": `# DMT
*Source: https://isomerdesign.com/PiHKAL/read.php?domain=tk&id=6*

*TiHKAL Entry #6*


## SYNTHESIS
The demethylation of the iodide salt: Under an inert atmosphere, a solution of 0.40 g N,N,N-trimethyltryptammonium iodide in 5 mL THF was treated with 1.5 mL of 1 M LiEt3BH in THF and held at reflux temperature for 9 h. After cooling, the mixture was acidified with dilute HCl and the THF removed under vacuum. The residue was suspended in dilute NaOH and extracted with Et2O. The extracts were pooled, and the solvent removed under vacuum to provide a residue of 0.12 g N,N-dimethyltryptamine (DMT) as a crystalline solid, with a mp of 57â59 Â°C. IR (in cm-1): 732, 740, 811, 859, 1011, 1037, 1110, 1171. The MS is discussed below.

The demethylation of the chloride salt: A hot aqueous solution of N,N,N-trimethyltryptammonium iodide was treated with an excess of freshly precipitated AgCl, and all was boiled gently for 15 min. The mixed silver halides were removed by filtration, and the filtrate stripped of H2O as rapidly as possible. To the residue there was added a small amount of MeOH follow by acetone until the crystallization of N,N,N-trimethyltryptammonium chloride was complete. It had a mp of 193 Â°C (80%), and it is considerably more water soluble than the starting iodide. This salt was pyrolysed under hard vacuum and the residue distilled. This distillate was dissolved in a small amount of methanol and acidified with dilute nitric acid. A small amount of insoluble material was removed by filtration, the aqueous phase washed with CHCl3, made basic with aqueous NaOH, and extracted with CHCl3. The solvent was removed under vacuum, and the residue treated with a hot solution of picric acid. This was decanted from a little insoluble material, and slowly cooled to provide the picrate of DMT as yellow needles with a mp of 167 Â°C. An aqueous suspension of this picrate was made basic with an excess of aqueous NaOH, extracted with Et2O, and the solvent removed under vacuum to provide a pale yellow residue that crystallized. This was pressed on a porous plate and washed with petroleum ether to give N,N-dimethyltryptamine (DMT) as an off-white solid with a mp of 47 Â°C.

The demethylation of the thiophenolate salt: A suspension of 2.5 g N,N,N-trimethyltryptammonium iodide in 25 mL MeOH was brought into solution by heating, and treated with 1.0 g Ag2O. The mixture was heated for 10 min on the steam bath, the solids removed by filtration and washed with an additional 20 mL MeOH. The methanol solutions were treated with 1.0 g thiophenol and the solvent was removed under vacuum. The resulting viscous oil (2.12 g) was heated with a flame to the reflux point and there was extensive bubbling. After 5 min, the light colored reaction mixture was cooled to room temperature, dissolved in 50 mL CH2Cl2, and extracted with two 25 mL portions of dilute HCl. These were pooled (pale yellow color), made basic with 5% aqueous NaOH and extracted with 3Ã25 mL CH2Cl2. After removal of the solvent from the pooled extracts, the residue (an amber oil, 1.04 g) was distilled at the KugelRohr. A white oil distilled over at 130â140 Â°C at 0.1 mm/Hg, and crystallized spontaneously. This distillate weighed 0.77 g, and was recrystallized from boiling hexane after decanting the solution from a small amount of insolubles. There was thus obtained 0.40 g of dimethyltryptamine (DMT) with a mp 67â68 Â°C. The distillate contained about 3% of 2-Methyl-1,2,3,4-tetrahydro-Î²-carboline (parent peak mass 186, major peak mass 186) as an impurity which was lost upon recrystallization.
...
(with 250 mg, orally) âIt was inactive.â

(with 350 mg, orally) âCompletely without effect either physiological or psychological.â

(with 100 mg, via the buccal mucosa) âNumbness at the site, but no central effects.â

(with 20 mg, intramuscularly) âI began to see patterns on the wall that were continuously moving. They were transparent, and were not colored. After a short period these patterns became the heads of animals, a fox, a snake, a dragon. Then kaleidoscopic images appeared to me in my inner eye, fantastically beautiful and colored.â

(with 30 mg, intramuscularly) âThere was eye dilation and, subjectively, some perception disturbances.â

(with 50 mg, intramuscularly) âI feel strange, everything is blurry. I want my mother, I am afraid of fainting, I canât breathe.â

(with 60 mg, intramuscularly) âI donât like this feelingâI am not myself. I saw such strange dreams a while ago. Strange creatures, dwarfs or something; they were black and moved about. Now I feel as if I am not alive. My left hand is numb. As if my heart would not beat, as if I had no body, no nothing. All I feel are my left hand and stomach. I donât like to be without thoughts.â
...
(with 80 mg, intramuscularly) âMy perceptual distortions were visual in nature and with my eyes closed I could see colored patterns, primarily geometrical patterns moving very fast, having sometimes very deep emotional content and connotation. My blood pressure went up and my pupils were dilated.â

(with 30 mg, smoked) âI spread it evenly on a joint of Tanacetum vulgare and melted it with a heat lamp. In about 30 seconds a strong light-headedness starts, with a feeling of temporal pressure. Some yellowing of the visual field. There was nothing for me to do because I had to turn complete control over to the drug. Off the plateau in 3â4 minutes and the fact that the radio was on became apparent. I was out in a few more minutes.â

(with 60 mg, smoked) âWe did it together. Swift entryâhead overwhelmedâelaborate and exotic. Slightly threatening patternsâno insightâslight sense of cruelty and sharpness between us, but enjoying. His face, as before with MDA, demonic but pleasantly so. He said he saw my face as a mask. He asked me to let him see my teeth. I laughedâaware that laughter slightly not-funny. Heavy, massive intoxication. Time extension extraordinary. What seemed like 2 hrs was about 30 minutes.â

(with 60 mg, smoked) âRapid onset, and in a completely stoned isolation in about a minute for about three minutes. Slow return but continued afterglow (pleasant) for thirty minutes. Repeated three times, with no apparent tolerance or change in chronology. Easily handled. The intoxication is of limited usefulness but the residues are completely relaxing,â

(with 100 mg, smoked) âAs I exhaled I became terribly afraid, my heart very rapid and strong, palms sweating. A terrible sense of dread and doom filled meâI knew what was happening, I knew I couldnât stop it, but it was so devastating; I was being destroyedâall that was familiar, all reference points, all identityâall viciously shattered in a few seconds. I couldnât even mourn the lossâthere was no one left to do the mourning. Up, up, out, out, eyes closed, I am at the speed of light, expanding, expanding, expanding, faster and faster until I have become so large that I no longer existâmy speed is so great that everything has come to a stopâhere I gaze upon the entire universe.â

(with 15 mg, intravenously) âAn almost instantaneous rush began in the head and I was quickly scattered. Rapidly moving and intensely colored visuals were there, and I got into some complex scenes. There were few sounds, and those that were there were not of anyone talking. I was able to continue to think clearly.â

(with 30 mg, intravenously) âI was hit harder that I had ever been when smoking the stuff. The onset was similar, but the euphoria was less.â
...
Both the N-hydroxy (N-HO-NMT) and the 2-hydroxy (2-HO-NMT) analogues of NMT are found in another legume Desmanthus illinoensis, but have not been pharmacologically evaluated. Another provocative mono-alkyl analogue of DMT is N-cyclopropyltryptamine, made from indole-3-oxalylchloride and benzyl cyclopropylamine with eventual hydrogenolysis of the benzyl group; mp 180â182. This compound, as with the 5-methoxy (5-MeO-NCPT) and the 7-methoxy (7-MeO-NCPT) counterparts, is a potent monoamineoxidase inhibitor, and it has also been reported to have hypoglycemic activity. The 2-methyl-homologue of NMT was made from 2-methyl-3-(2-bromoethyl)tryptamine and methylamine. This is 2-Me-DMT 2,Me-DMT (or 2,N,N-TMT). Both it and tryptamine itself (T) have their own entries.

Before this is closed, a couple of points need be made regarding nomenclature. Older literature uses alpha for the 2-position of the indole ring. Thus, alpha-methyltryptamine, in early literature, refers to the indole-2-methyl, not to a side-chain methyl derivative. Throughout PiHKAL, the numbers are devoted to the indole ring, and the alpha and beta terms to the side-chain. And the use of the letter N refers to the side-chain amino nitrogen atom. The pyrrole nitrogen is the indole position 1. And finally, I found in my old files a news announcement (dated March 25, 1974) that Hercules Chemical Company intends to build a big DMT plant in the Southern United States, with an annual capacity of 800 million pounds a year. In the industrial world, DMT can also stand for dimethylterephthalate.

`,
  "protestkit": `{
  "url": "https://psychonautwiki.org/wiki/DMT",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_DMT.shtml",
  "name": "DMT",
  "aliases": [
    "dimethyltryptamine",
    "dmitry",
  ...
  "aliasesStr": "dimethyltryptamine,dmitry,n,n-dmt,the glory,the spirit molecule",
  ...
  "roas": [
    {
      ...
      "duration": [
        {
          "name": "Onset",
          "value": "0.33 - 0.67 minutes"
        },
        {
          "name": "Come up",
          "value": "1.0 - 3.0 minutes"
        },
        {
          "name": "Peak",
          "value": "2.0 - 8.0 minutes"
        },
        {
          "name": "Offset",
          "value": "1.0 - 6.0 minutes"
        },
        {
          "name": "Total",
          "value": "5.0 - 20.0 minutes"
        },
        {
          "name": "After effects",
          "value": "10.0 - 60.0 minutes"
        }
      ]
    },
    {
      ...
      "duration": [
        {
          "name": "Onset",
          "value": "0.03 - 0.17 minutes"
        },
        {
          "name": "Come up",
          "value": "1.17 - 1.67 minutes"
        },
        {
          "name": "Peak",
          "value": "2.0 - 5.0 minutes"
        },
        {
          "name": "Offset",
    ...
    },
    {
      ...
      "duration": [
        {
          "name": "Onset",
          "value": "3.0 - 5.0 minutes"
        },
        {
          "name": "Duration",
          "value": "45.0 - 60.0 minutes"
        },
        {
          "name": "After effects",
    ...
    },
    {
      ...
      "duration": [
        {
          "name": "Onset",
          "value": "0.0 - 2.0 minutes"
        },
        {
          "name": "Duration",
          "value": "3.0 - 10.0 minutes"
        },
        {
          "name": "After effects",
          "value": "15.0 - 60.0 minutes"
...
`,
  "thedrugclassroom": `# Dimethyltryptamine (DMT)
*Source: https://thedrugclassroom.com/video/dimethyltryptamine-dmt/*
...
[Erowid](https://erowid.org/experiences/subs/exp_DMT.shtml)
...
**(2016)** [Inhibition of alpha oscillations through serotonin-2A receptor activation underlies the visual effects of ayahuasca in humans.](https://www.ncbi.nlm.nih.gov/pubmed/27039035)

**(2016)** [A Model for the Application of Target-Controlled Intravenous Infusion for a Prolonged Immersive DMT Psychedelic Experience](http://journal.frontiersin.org/article/10.3389/fphar.2016.00211/full)

**(2016)** [Exploring the therapeutic potential of Ayahuasca: acute intake increases mindfulness-related capacities.](https://www.ncbi.nlm.nih.gov/pubmed/26612618)

**(2016)** [Neuropharmacology of N,N-dimethyltryptamine.](https://www.ncbi.nlm.nih.gov/pubmed/27126737)

**(2016)** [Dimethyltryptamine (DMT): a biochemical Swiss Army knife in neuroinflammation and neuroprotection?](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4828992/)

**(2016)** [The Endogenous Hallucinogen and Trace Amine N,N-Dimethyltryptamine (DMT) Displays Potent Protective Effects against Hypoxia via Sigma-1 Receptor Activation in Human Primary iPSC-Derived Cortical Neurons and Microglia-Like Immune Cells](http://journal.frontiersin.org/article/10.3389/fnins.2016.00423/full)

**(2015)** [N,N-Dimethyltryptamine-Induced Psychosis.](https://www.ncbi.nlm.nih.gov/pubmed/26166234)

**(2015)** [Ritualistic Use of Ayahuasca versus Street Use of Similar Substances Seized by the Police: A Key Factor Involved in the Potential for Intoxications and Overdose?](https://www.ncbi.nlm.nih.gov/pubmed/25950593)

**(2015)** [On the transmethylation hypothesis: stress, N,N-dimethyltryptamine, and positive symptoms of psychosis.](https://www.ncbi.nlm.nih.gov/pubmed/25362533)

**(2015)** [The Role of 5-HT2A, 5-HT2C and mGlu2 Receptors in the Behavioral Effects of Tryptamine Hallucinogens N,N-Dimethyltryptamine and N,N-Diisopropyltryptamine in Rats and Mice](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4282596/)

**(2015)** [New World Tryptamine Hallucinogens and the Neuroscience of Ayahuasca.](https://www.ncbi.nlm.nih.gov/pubmed/25655746)

**(2014)** [N, N-Dimethyltryptamine and biological reductive accounts for religious and spiritual experiences](http://digitalcommons.liberty.edu/cgi/viewcontent.cgi?article=1006&context=symp_grad)

**(2014)** [Psychedelic N,N-Dimethyltryptamine and 5-Methoxy-N,N-Dimethyltryptamine Modulate Innate and Adaptive Inflammatory Responses through the Sigma-1 Receptor of Human Monocyte-Derived Dendritic Cells](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0106533)

**(2014)** [Noncompetitive inhibition of indolethylamine-N-methyltransferase by N,N-dimethyltryptamine and N,N-dimethylaminopropyltryptamine.](https://www.ncbi.nlm.nih.gov/pubmed/24730580)

**(2013)** [A possibly sigma-1 receptor mediated role of dimethyltryptamine in tissue protection, regeneration, and immunity.A possibly sigma-1 receptor mediated role of dimethyltryptamine in tissue protection, regeneration, and immunity.](https://www.ncbi.nlm.nih.gov/pubmed/23619992)

**(2013)** [Building Alien Worlds— The Neuropsychological and Evolutionary Implications of the Astonishing Psychoactive Effects of N,N-Dimethyltryptamine (DMT)](https://www.researchgate.net/publication/277281153_ESSAY_Building_Alien_Worlds-_The_Neuropsychological_and_Evolutionary_Implications_of_the_Astonishing_Psychoactive_Effects_of_NN-Dimethyltryptamine_DMT)

**(2013)** [Dimethyltryptamine (DMT): Prevalence, user characteristics and abuse liability in a large global sample](http://journals.sagepub.com/doi/abs/10.1177/0269881113513852)

**(2013)** [LC/MS/MS analysis of the endogenous dimethyltryptamine hallucinogens, their precursors, and major metabolites in rat pineal gland microdialysate.](https://www.ncbi.nlm.nih.gov/pubmed/23881860)
...
**(2012)** [Does N,N-Dimethyltryptamine (DMT) Adequately Explain Near-Death Experiences?](https://www.academia.edu/18868446/Does_N_N-Dimethyltryptamine_DMT_Adequately_Explain_Near-Death_Experiences)

**(2012)** [Personality, Psychopathology, Life Attitudes and Neuropsychological Performance among Ritual Users of Ayahuasca: A Longitudinal Study](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0042421)

**(2012)** [Seeing with the eyes shut: neural basis of enhanced imagery following Ayahuasca ingestion.](https://www.ncbi.nlm.nih.gov/pubmed/21922603)

**(2012)** [Recreational use of naturally occurring dimethyltryptamine – contributing to psychosis?](http://journals.sagepub.com/doi/full/10.1177/0004867412462749)

**(2011)** [Discarnate entities and dimethyltryptamine (DMT): Psychopharmacology, phenomenology and ontology](https://www.researchgate.net/publication/258051832_Discarnate_entities_and_dimethyltryptamine_DMT_Psychopharmacology_phenomenology_and_ontology)

**(2010)** [Assessment of addiction severity among ritual users of ayahuasca.](https://www.ncbi.nlm.nih.gov/pubmed/20554400)

**(2010)** [Dimethyltryptamine (DMT): subjective effects and patterns of use among Australian recreational users.](https://www.ncbi.nlm.nih.gov/pubmed/20570058)

**(2010)** [The Hallucinogen N,N-Dimethyltryptamine (DMT) Is an Endogenous Sigma-1 Receptor Regulator](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2947205/)

**(2009)** [Dimethyltryptamine (DMT) a Psychedelic](https://link.springer.com/chapter/10.1007%2F978-90-481-2448-0_35)

**(2009)** [When the endogenous hallucinogenic trace amine N,N-dimethyltryptamine meets the sigma-1 receptor.](https://www.ncbi.nlm.nih.gov/pubmed/19278957)

**(2009)** [Gas chromatographic analysis of dimethyltryptamine and beta-carboline alkaloids in ayahuasca, an Amazonian psychoactive plant beverage.](https://www.ncbi.nlm.nih.gov/pubmed/19140116)

**(2009)** [Dimethyltryptamine and other hallucinogenic tryptamines exhibit substrate behavior at the serotonin uptake transporter and the vesicle monoamine transporter.](https://www.ncbi.nlm.nih.gov/pubmed/19756361)

**(2008)** [Identification of N,N-dimethyltryptamine and beta-carbolines in psychotropic ayahuasca beverage.](https://www.ncbi.nlm.nih.gov/pubmed/18506697)

**(2008)** [Phenomenology of N,N-Dimethyltryptamine Use: A Thematic Analysis](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.583.1262&rep=rep1&type=pdf)

**(2007)** [Ayahuasca in the treatment of Addictions](http://www.takiwasi.com/docs/arti_ing/ayahuasca_in_treatment_addictions.pdf)

**(2007)** [Risk assessment of ritual use of oral dimethyltryptamine (DMT) and harmala alkaloids.](https://www.ncbi.nlm.nih.gov/pubmed/17207120)

**(2007)** [Effects of ayahuasca on psychometric measures of anxiety, panic-like and hopelessness in Santo Daime members.](https://www.ncbi.nlm.nih.gov/pubmed/17532158)

**(2006)** [The globalization of ayahuasca: Harm reduction or benefit maximization?](http://www.sciencedirect.com/science/article/pii/S0955395906002283)

**(2005)** [Altered states of consciousness and short-term psychological after-effects induced by the first time ritual use of ayahuasca in an urban context in Brazil.](https://www.ncbi.nlm.nih.gov/pubmed/16149333)

**(2005)** [Ayahuasca in adolescence: a preliminary psychiatric assessment.](https://www.ncbi.nlm.nih.gov/pubmed/16149324)

**(2005)** [Report on psychoactive drug use among adolescents using ayahuasca within a religious context.](https://www.ncbi.nlm.nih.gov/pubmed/16149326)

**(2005)** [Psychological effects of (S)-ketamine and N,N-dimethyltryptamine (DMT): a double-blind, cross-over study in healthy volunteers.](https://www.ncbi.nlm.nih.gov/pubmed/16342002)

**(2005)** [Drug tourism or spiritual healing? Ayahuasca seekers in Amazonia.](https://www.ncbi.nlm.nih.gov/pubmed/16149335)

**(2005)** [Endogenous psychoactive tryptamines reconsidered: an anxiolytic role for dimethyltryptamine.](https://www.ncbi.nlm.nih.gov/pubmed/15780487)

**(2005)** [Ayahuasca in adolescence: a neuropsychological assessment.](https://www.ncbi.nlm.nih.gov/pubmed/16149323)

**(2003)** [Human pharmacology of ayahuasca: subjective and cardiovascular effects, monoamine metabolite excretion, and pharmacokinetics.](https://www.ncbi.nlm.nih.gov/pubmed/12660312)

**(2002)** [Determination of N,N-dimethyltryptamine and beta-carboline alkaloids in human plasma following oral administration of Ayahuasca.](https://www.ncbi.nlm.nih.gov/pubmed/12361741)

**(2001)** [Subjective effects and tolerability of the South American psychoactive beverage Ayahuasca in healthy volunteers.](https://www.ncbi.nlm.nih.gov/pubmed/11292011)

**(1999)** [Pharmahuasca: human pharmacology of oral DMT plus harmine.](https://www.ncbi.nlm.nih.gov/pubmed/10438001)

**(1998)** [Agonist properties of N,N-dimethyltryptamine at serotonin 5-HT2A and 5-HT2C receptors.](https://www.ncbi.nlm.nih.gov/pubmed/9768567)

**(1996)** [Human psychopharmacology of N,N-dimethyltryptamine.](https://www.ncbi.nlm.nih.gov/pubmed/8788488)

**(1996)** [Quantitation of N,N-dimethyltryptamine and harmala alkaloids in human plasma after oral dosing with ayahuasca.](https://www.ncbi.nlm.nih.gov/pubmed/8889686)

**(1996)** [Differential Tolerance to Biological and Subjective Effects of Four Closely Spaced Doses of N,N-Dimethyltryptamine in Humans](http://www.maps.org/research-archive/w3pb/1996/1996_Strassman_22710_1.pdf)

**(1994)** [Dose-Response Study of N,N-Dimethyltryptamine in Humans: II. Subjective Effects and Preliminary Results of a New Rating Scale](http://www.maps.org/research-archive/w3pb/1994/1994_Strassman_22714_1.pdf)

**(1994)** [Dose-response study of N,N-dimethyltryptamine in humans. I. Neuroendocrine, autonomic, and cardiovascular effects.](https://www.ncbi.nlm.nih.gov/pubmed/8297216)

**(1991)** [Differential interactions of dimethyltryptamine (DMT) with 5-HT1A and 5-HT2 receptors.](https://www.ncbi.nlm.nih.gov/pubmed/1828347)

**(1989)** [Sociopsychotherapeutic functions of ayahuasca healing in Amazonia.](https://www.ncbi.nlm.nih.gov/pubmed/2656954)

**(1981)** [N, N-dimethyltryptamine: an endogenous hallucinogen.](https://www.ncbi.nlm.nih.gov/pubmed/6792104)

**(1976)** [Dimethyltryptamine levels in blood of schizophrenic patients and control subjects.](https://www.ncbi.nlm.nih.gov/pubmed/803203)

**(1976)** [DMT & TMA-2](http://www.tandfonline.com/doi/abs/10.1080/02791072.1976.10471846)

**(1973)** [The effects of N,N-dimethyltryptamine on operant behavior in squirrel monkeys](https://link.springer.com/article/10.1007/BF00422642)

**(1972)** [“Ayahuasca,” the South American Hallucinogenic Drink: An Ethnobotanical and Chemical Investigation](https://www.jstor.org/stable/4253328?seq=1#page_scan_tab_contents)

**(1970)** [Effects of psilocybin, dimethyltryptamine and various lysergic acid derivatives on photically-induced epilepsy in the baboon (Papio papio).](https://www.ncbi.nlm.nih.gov/pubmed/4992165)

**(1964)** [The effect of N,N-Dimethyltryptamine in human subjects tolerance to lysergic acid diethylamide](https://www.ncbi.nlm.nih.gov/pubmed/14138757)

**(1958)** [Dimethyltryptamine Experiments with Psychotics](http://bjp.rcpsych.org/content/104/435/445)
`,
  "tripsit-factsheets": `# DMT
...
- **Also known as:** n,n-dmt, dimethyltryptamine
...
*Note:  NOTE: These figures are for 100% effective vaporization methods. Typical methods of vaporization are not 100% effective. The likelihood of having a "breakthrough" experience increases with dosages. Caution is advised.*
...
- **nitrous**
- **pcp**
- **pregabalin**: Pregabalin may reduce the anxiety and other possible side effects of DMT. Additionally, the combination may increase inhibition, dizziness, and risk of injury.
