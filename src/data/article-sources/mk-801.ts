...
export const substanceName = "MK-801";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - MK-801.json","displayName":"Protest Kit","size":1630},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - MK-801.md","displayName":"TripSit Factsheets","size":759},{"id":"wikipedia","fileName":"WIKIPEDIA - MK-801.md","displayName":"Wikipedia","size":9966}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/mk-801",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_Dizocilpine.shtml",
  "name": "MK-801",
  "aliases": [
    "dizocilpine",
    "mk801"
  ],
  "aliasesStr": "dizocilpine,mk801",
  ...
  "roas": [
    {
      ...
      "duration": [
        ...
        {
          "name": "Duration",
          "value": "20.0 - 36.0 hours"
        },
        {
          "name": "After effects",
          "value": "1.0 - 72.0 hours"
        }
      ]
    },
    {
  ...
  "tripsit-factsheets": `# MK-801
*Source: TripSit Factsheets (tripsit.me)*

## Summary

Dissociative research chemical reported to be similar to PCP and Ketamine. Dizocilpine, also known as MK-801, is a non-competitive antagonist of the NMDA receptor.

## Classification
- **Categories:** dissociative, research-chemical, tentative, habit-forming
- **Also known as:** dizocilpine, mk801
...
- **Avoid:** Unnecessary movement due to risk of injury. Mixing with other depressants such as alcohol, benzodiazepines, and opiods.
