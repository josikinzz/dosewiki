...
export const substanceName = "Ibuprofen";
export const sources = [{"id":"drugbank","fileName":"DRUGBANK - Ibuprofen.md","displayName":"DrugBank","size":48986},{"id":"protestkit","fileName":"PROTESTKIT - Ibuprofen.json","displayName":"Protest Kit","size":1138},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Ibuprofen.md","displayName":"TripSit Factsheets","size":522},{"id":"wikipedia","fileName":"WIKIPEDIA - Ibuprofen.md","displayName":"Wikipedia","size":18892}];
export const contents: Record<string, string> = {
  "drugbank": `# Ibuprofen
*Source: https://go.drugbank.com/drugs/DB01050*
...
8
Ibuprofen was finally patented in 1961 and this drug was first launched against rheumatoid arthritis in the UK in 1969 and USA in 1974. It was the first available over-the-counter NSAID.
9
On the available products, ibuprofen is administered as a racemic mixture. Once administered, the R-enantiomer undergoes extensive interconversion to the S-enantiomer
in vivo
by the activity of the alpha-methylacyl-CoA racemase. In particular, it is generally proposed that the S-enantiomer is capable of eliciting stronger pharmacological activity than the R-enantiomer.
24
...
11
The use of ibuprofen and its enantiomer
Dexibuprofen
in a racemic mix is common for the management of mild to moderate pain related to dysmenorrhea, headache, migraine, postoperative dental pain, spondylitis, osteoarthritis, rheumatoid arthritis, and soft tissue disorder.
12
...
16
Pain - ibuprofen is widely used to reduce minor aches and pains as well as to reduce fever and manage dysmenorrhea. It is very commonly used for the relief of acute indications such as fever and tension headaches.
10
...
10
Ibuprofen is largely used in OTC products such as an agent for the management of dysmenorrhea which has been proven to reduce the amount of menstrual prostanoids and to produce a reduction in the uterine hypercontractility.
17
As well, it has been reported to reduce significantly the fever and the pain caused by migraines.
18
,
19
This effect is thought to be related to the effect on platelet activation and thromboxane A2 production which produces local vascular effects in the affected regions. This effect is viable as ibuprofen can enter in the central nervous system.
23
...
10
As soon as it is absorbed, the R-enantiomer undergoes extensive enantiomeric conversion (53-65%) to the more active S-enantiomer
in vivo
by the activity of alpha-methylacyl-CoA racemase.
24
...
**Synonyms:** (±)-2-(p-isobutylphenyl)propionic acid
(±)-ibuprofen
...
Ibuprofen
is an NSAID and non-selective COX inhibitor used to treat mild-moderate pain, fever, and inflammation.

### Brand Names

Addaprin, Advil, Advil Cold and Sinus, Advil Congestion Relief, Advil PM, Advil Sinus Congestion and Pain, Alivio, Caldolor, Cedaprin, Children's Ibuprofen, Combogesic, Diphen, Ibu, Ibuprofen Gen.Orph, Ibutab, Junior Strength Motrin, Motrin, Motrin PM, Neoprofen, Nuprin, Pedea, Proprinal, Reprexain, Sudafed PE Head Congestion Plus Pain, Vicoprofen, Wal-profen Congestion Relief and Pain
...
Act-3 (Healthcare Logistics)
/
Actiprofen (Sterling Health)
/
Adex (Dexxon)
/
Aktren (Bayer)
...
Algofren (Intermed)
/
Alivium (Bristol-Myers Squibb)
/
Artofen (Teva)
/
Betagesic (Adcock Ingram Pharmaceuticals)
/
Betaprofen (Be-Tabs Pharmaceuticals)
/
Bonifen (Krka)
/
Brufen (Abbott)
...
Brupro (Sandoz)
/
Buburone (Towa Yakuhin)
/
Buprovil (Multilab Industry and Trade of Pharmaceuticals)
/
Burana (Orion)
/
Butylenin (Sanken)
...
Capsibu (Sandoz)
/
Children's Elixsure (Pfizer)
/
Children's Ibuprofen (Pfizer)
/
Dalsy (Abbott)
/
Dismenol (Merz)
...
Dolgit (Dolorgiet)
/
Doloraz (Jordanian Pharmaceutical Manufacturing Co.)
/
Dolormin (Johnson & Johnson GmbH)
/
Ebufac (DDSA Pharmaceuticals)
/
EmuProfen (Progressive Emu, Inc)
/
Epobron (Ono)
/
Fenbid (Smith Kline and Beecham)
/
Fenpaed (Rite Aid Corporation)
/
Fenpain (Sandoz)
/
Ibalgin (Zentiva)
/
IBU-Ratiopharm (Ratiopharm GmbH)
/
Ibuflam (Natco Pharma Ltd)
/
...
IbuHEXAL (Hexal AG)
/
Ibuleve (Diomed Development Ltd)
/
Ibum (PPF Hasco-Lek SA)
/
Ibumax (standford Biotech Pvt Ltd)
/
Ibumetin (Nycomed Denmark Aps)
/
Ibupain (Sandoz)
/
Ibuprocin (Nisshin)
...
Ibuprox (Norway)
/
Ibustar (Berlin-Chemie Menarini Croatia)
/
Ibutren (Sandoz)
/
Ibux (Weifa AS)
/
Ibuxin (Pliva Hrvatska)
/
Junior Strength Motrin (J&J Consumer Inc)
/
Kratalgin (Austria)
/
Lamidon (Kowa)
...
Medicol (United Lab)
/
Medipren (Johnson & Johnson)
/
Mynosedin (Toho Yakuhin)
/
Mypaid (Ai Pharm)
/
Myprodol (Adcock Ingram)
/
Narfen (Alter)
/
Naron Ace (Primary Care Tokyo)
/
Neobrufen (Crookes)
/
Nobfen (Toho)
...
Norvectan
/
Nuprin (Upjohn Company)
/
Nureflex (Boots Healthcare, Courbevoie)
/
Nurofen (Crookes)
/
Orbifen (Boehringer Ingelheim International GmbH)
/
Panafen (GlaxoSmithKline Consumer Healthcare Australia Pty Ltd)
/
Pediaprofen (Whitehall Laboratories)
/
Rapidol (Actavis)
/
Rimafen
...
Rufen (Boots)
/
Salvarina (Salvat, Barcelona)
/
Seclodin (Whitehall Labs, Maidenhead)
/
Speedpain NANO (Goodsense)
/
Spidifen (Zambon)
/
Suspren
/
Tabalon (Sanofi India Ltd)
/
Trendar (Whitehall-Robins)
/
Urem (Kade, MErlin)
...
(98.6 mL/100mL)
Kit
Ophthalmic; Oral; Respiratory (inhalation); Topical
...
Neomycin sulfate
(3.5 mg/1g)
Cream; Kit; Liquid; Ointment; Swab; Tablet
Oral; Topical
Honeywell Safety Products USA, Inc
2018-10-18
Not applicable
...
Zawada ET Jr: Renal consequences of nonsteroidal antiinflammatory drugs. Postgrad Med. 1982 May;71(5):223-30. [
Article
]
Townsend KP, Pratico D: Novel therapeutic opportunities for Alzheimer's disease: focus on nonsteroidal anti-inflammatory drugs. FASEB J. 2005 Oct;19(12):1592-601. [
Article
]
...
Geisslinger G, Dietzel K, Bezler H, Nuernberg B, Brune K: Therapeutically relevant differences in the pharmacokinetical and pharmaceutical behavior of ibuprofen lysinate as compared to ibuprofen acid. Int J Clin Pharmacol Ther Toxicol. 1989 Jul;27(7):324-8. [
Article
]
...
Adams SS: The propionic acids: a personal perspective. J Clin Pharmacol. 1992 Apr;32(4):317-23. [
Article
]
Rainsford KD: Discovery, mechanisms of action and safety of ibuprofen. Int J Clin Pract Suppl. 2003 Apr;(135):3-8. [
Article
]
Halford GM, Lordkipanidze M, Watson SP: 50th anniversary of the discovery of ibuprofen: an interview with Dr Stewart Adams. Platelets. 2012;23(6):415-22. doi: 10.3109/09537104.2011.632032. Epub 2011 Nov 18. [
Article
]
...
Sharma PK, Garg SK, Narang A: Pharmacokinetics of oral ibuprofen in premature infants. J Clin Pharmacol. 2003 Sep;43(9):968-73. [
Article
]
Tan SC, Patel BK, Jackson SH, Swift CG, Hutt AJ: Ibuprofen stereochemistry: double-the-trouble? Enantiomer. 1999;4(3-4):195-203. [
Article
]
...
Moore PA, Hersh EV: Celecoxib and rofecoxib. The role of COX-2 inhibitors in dental practice. J Am Dent Assoc. 2001 Apr;132(4):451-6. [
Article
]
...
Krishna S, Pukrittayakamee S, Supanaranond W, ter Kuile F, Ruprah M, Sura T, White NJ: Fever in uncomplicated Plasmodium falciparum malaria: randomized double-'blind' comparison of ibuprofen and paracetamol treatment. Trans R Soc Trop Med Hyg. 1995 Sep-Oct;89(5):507-9. [
Article
]
...
Casper D, Yaparpalvi U, Rempel N, Werner P: Ibuprofen protects dopaminergic neurons against glutamate toxicity in vitro. Neurosci Lett. 2000 Aug 11;289(3):201-4. [
Article
]
Ton TG, Heckbert SR, Longstreth WT Jr, Rossing MA, Kukull WA, Franklin GM, Swanson PD, Smith-Weller T, Checkoway H: Nonsteroidal anti-inflammatory drugs and risk of Parkinson's disease. Mov Disord. 2006 Jul;21(7):964-9. doi: 10.1002/mds.20856. [
Article
]
...
Rao P, Knaus EE: Evolution of nonsteroidal anti-inflammatory drugs (NSAIDs): cyclooxygenase (COX) inhibition and beyond. J Pharm Pharm Sci. 2008 Sep 20;11(2):81s-110s. [
Article
]
Hall AH, Smolinske SC, Conrad FL, Wruk KM, Kulig KW, Dwelle TL, Rumack BH: Ibuprofen overdose: 126 cases. Ann Emerg Med. 1986 Nov;15(11):1308-13. [
Article
]
Current issues in pharmacy and medical sciences [
Link
]
FDA Approved Drug Products: Caldolor (ibuprofen) solution for intravenous injection [
Link
]
...
Cost
Unit
Neoprofen 20 mg/2 ml vial
304.5USD
ml
...
Spectrum Type
Splash Key
GC-MS Spectrum - GC-EI-TOF (Pegasus III TOF-MS system, Leco; GC 6890, Agilent Technologies) (1 TMS)
GC-MS
splash10-02t9-1910000000-23f448d7be7d5cc35682
GC-MS Spectrum - GC-EI-TOF (Pegasus III TOF-MS system, Leco; GC 6890, Agilent Technologies) (1 TMS)
GC-MS
splash10-02t9-1910000000-cbe52d63986b68a2cec0
GC-MS Spectrum - GC-EI-TOF (Pegasus III TOF-MS system, Leco; GC 6890, Agilent Technologies) (1 TMS)
GC-MS
splash10-00di-9300000000-cc259b7768023e4cdba8
Predicted GC-MS Spectrum - GC-MS
Predicted GC-MS
splash10-0296-3900000000-497aad6d6a3e7af1ac0a
GC-MS Spectrum - EI-B
GC-MS
splash10-03di-3910000000-618880f8fd7b8ec3d473
...
MS
splash10-03xr-3900000000-e20ef3c30496e17720ba
MS/MS Spectrum - Quattro_QQQ 10V, N/A
LC-MS/MS
splash10-03di-0910000000-90bf6813134491c9fbfd
MS/MS Spectrum - Quattro_QQQ 25V, N/A
LC-MS/MS
splash10-001i-9800000000-56f599abc462380b648c
MS/MS Spectrum - EI-B (HITACHI RMU-6E) , Positive
LC-MS/MS
splash10-03di-3910000000-618880f8fd7b8ec3d473
LC-MS/MS Spectrum - LC-ESI-qTof , Positive
LC-MS/MS
splash10-0006-0497000000-fa397d6ffd29da116900
LC-MS/MS Spectrum - LC-ESI-qTof , Positive
LC-MS/MS
splash10-0a4i-0690000000-f598b8bee69a6b62e817
MS/MS Spectrum - , positive
LC-MS/MS
splash10-03di-1900000000-f1b7a986fee133d97eb1
MS/MS Spectrum - , positive
LC-MS/MS
splash10-03di-0920000000-aa36b3244e32560bb9d5
Predicted MS/MS Spectrum - 10V, Positive (Annotated)
Predicted LC-MS/MS
splash10-0a4i-1930000000-728a67daaea8ecb1b60a
Predicted MS/MS Spectrum - 10V, Negative (Annotated)
Predicted LC-MS/MS
splash10-0a4i-0190000000-e8049d9759b81f0d56b0
Predicted MS/MS Spectrum - 20V, Positive (Annotated)
Predicted LC-MS/MS
splash10-05mo-5900000000-3c32234af86d6b3a2656
Predicted MS/MS Spectrum - 20V, Negative (Annotated)
Predicted LC-MS/MS
splash10-02ai-0900000000-e1c07c4d6d5219e98219
Predicted MS/MS Spectrum - 40V, Positive (Annotated)
Predicted LC-MS/MS
splash10-0ldl-4900000000-7635978e2602fb36e1ce
Predicted MS/MS Spectrum - 40V, Negative (Annotated)
Predicted LC-MS/MS
splash10-014i-0900000000-b1bbd0cff6f4f6df9ebc
1H NMR Spectrum
1D NMR
Not Applicable
1H NMR Spectrum
...
`,
  "protestkit": `{
  "url": "https://drugs.tripsit.me/ibuprofen",
  "experiencesUrl": "https://www.reddit.com/search/?q=Ibuprofen",
  "name": "Ibuprofen",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# Ibuprofen
*Source: TripSit Factsheets (tripsit.me)*

## Summary

A ubiquitously available pain reliever/fever reducer. Ibuprofen is a nonsteroidal anti-inflammatory drug that is available in many forms. It is occasionally used to reduce the body-load caused by certain drugs, such as stimulants.
...
## Additional Information
- **Avoid:** Alcoholic beverages, other NSAIDs.
`,
  "wikipedia": `# Ibuprofen
...
Ibuprofen works by inhibiting cyclooxygenase (COX) enzymes, which convert arachidonic acid to prostaglandin H2 (PGH2). PGH2, in turn, is converted by other enzymes into various prostaglandins (which mediate pain, inflammation, and fever) and thromboxane A2 (which stimulates platelet aggregation and promotes blood clot formation).
