# Glaucine
*Source: https://en.wikipedia.org/wiki/Glaucine*
...
Glaucine has also recently  been found to have an effect on the neuronal 5-HT2A receptors, which are responsible for the hallucinogenic effects of classical psychedelics. It also inhibits MAO enzymes. Its enantiomers effect are same for adrenergic receptor yet different for 5-HT receptor. Both (R)-glaucine and (S)-glaucine antagonize α1 receptor, but (S)-glaucine is partial agonist of 5-HT2 subtypes whereas (R)-glaucine is a positive allosteric modulator of 5-HT2.
