...
export const substanceName = "Barbital";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Barbital.json","displayName":"Protest Kit","size":1016},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Barbital.md","displayName":"TripSit Factsheets","size":421},{"id":"wikipedia","fileName":"WIKIPEDIA - Barbital.md","displayName":"Wikipedia","size":4762}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/barbital",
  "experiencesUrl": "https://www.reddit.com/search/?q=Barbital",
  "name": "Barbital",
  "aliases": [],
  "aliasesStr": "",
...
## Classification
- **Categories:** barbiturate, habit-forming, depressant
...
`,
  "wikipedia": `# Barbital
*Source: https://en.wikipedia.org/wiki/Barbital*
...
Barbital was also used as a plot device in the CBS television legal drama, Perry Mason, in the episode, The Case of the Missing Element (1963).
It was used as a method of suicide in Stephen King’s The Stand by a character named Perion after her partner Mark dies from appendicitis.
`,
};
