...
export const substanceName = "Aminorex";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Aminorex.json","displayName":"Protest Kit","size":3183},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Aminorex.md","displayName":"TripSit Factsheets","size":493},{"id":"wikipedia","fileName":"WIKIPEDIA - Aminorex.md","displayName":"Wikipedia","size":4649}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/aminorex",
  "experiencesUrl": "https://www.reddit.com/search/?q=Aminorex",
  "name": "Aminorex",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# Aminorex
*Source: TripSit Factsheets (tripsit.me)*

## Summary

Is an anorectic stimulant drug that was taken off the market after it was found to cause pulmonary hypertension. Potency wise it has been found to be roughly 2.5 times more potent than dextroamphetamine.

## Classification
- **Categories:** stimulant, habit-forming, tentative
...
`,
  "wikipedia": `# Aminorex
*Source: https://en.wikipedia.org/wiki/Aminorex*
