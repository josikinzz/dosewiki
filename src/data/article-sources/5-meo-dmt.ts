...
export const substanceName = "5-MeO-DMT";
export const sources = [{"id":"disregardeverythingisay","fileName":"DISREGARDEVERYTHINGISAY - 5-MeO-DMT.md","displayName":"DEIA","size":12983},{"id":"erowid","fileName":"EROWID - 5-MeO-DMT.md","displayName":"Erowid","size":30433},{"id":"isomerdesign","fileName":"ISOMERDESIGN - 5-MeO-DMT.md","displayName":"Isomer Design","size":18744},{"id":"protestkit","fileName":"PROTESTKIT - 5-MeO-DMT.json","displayName":"Protest Kit","size":5653},{"id":"psychonautwiki","fileName":"PSYCHONAUTWIKI - 5-MeO-DMT.md","displayName":"PsychonautWiki","size":40386},{"id":"saferparty","fileName":"SAFERPARTY - 5-MeO-DMT.md","displayName":"Safer Party","size":3116},{"id":"thedrugclassroom","fileName":"THEDRUGCLASSROOM - 5-MeO-DMT.md","displayName":"The Drug Classroom","size":5247},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - 5-MeO-DMT.md","displayName":"TripSit Factsheets","size":833},{"id":"tripsit-wiki","fileName":"TRIPSIT_WIKI - 5-MeO-DMT.md","displayName":"TripSit Wiki","size":3904},{"id":"wikipedia","fileName":"WIKIPEDIA - 5-MeO-DMT.md","displayName":"Wikipedia","size":25671}];
export const contents: Record<string, string> = {
  "disregardeverythingisay": `# 5-MeO-DMT
*Source: https://disregardeverythingisay.com/post/98109177114/5-meo-dmt-broken-down-and-described*

*Disregard Everything I Say - 5-MeO-DMT, broken down and described*
...
- **[Enhancement of tactile sensations](http://psychonautwiki.org/wiki/Effect:Enhancement_of_touch)** - This particular component is perhaps the most overwhelming sensation within the entirety of the 5-MeO-DMT experience. It increases the intensity of tactile sensations to such an overwhelming extent that it induces a sustained and repeatable full body orgasm within every nerve ending across the entire body. The experience of this results in the perception of having a difficulty sustaining the act of breathing. It is worth noting, however, that this is not a genuine or dangerous experience of respiratory depression and is perfectly safe.
- **[Physical euphoria](http://psychonautwiki.org/wiki/Effect:Physical_euphoria)**
- **[Nausea](http://psychonautwiki.org/wiki/Effect:Nausea)**
- **[Increased bodily control](http://psychonautwiki.org/wiki/Effect:Increased_bodily_control)**
- **[Loss of motor control](http://psychonautwiki.org/wiki/Effect:Loss_of_motor_control)**
- **Bodily pressures**
- **Skin flushing**
- **[Changes in gravity](http://psychonautwiki.org/wiki/Effect:Changes_in_gravity)**
- **[Loss of temperature regulation](http://psychonautwiki.org/wiki/Effect:Loss_of_temperature_regulation)**
- **[Increased bodily weight](http://psychonautwiki.org/wiki/Effect:Increased_bodily_weight)**

**Cognitive Effects:**

The most prominent of 5-MeO-DMT’s cognitive effects generally include:

- **[Current mind state enhancement](http://psychonautwiki.org/wiki/Effect:Current_mind_state_enhancement)**
- **[Mindfulness](http://psychonautwiki.org/wiki/Effect:Mindfulness)**
- **[Conceptual thinking](http://psychonautwiki.org/wiki/Effect:Conceptual_thinking)**
- **[Thought connectivity](http://psychonautwiki.org/wiki/Effect:Thought_connectivity)**
- **[Anxiety](http://psychonautwiki.org/wiki/Effect:Anxiety)**
- **[Time distortion](http://psychonautwiki.org/wiki/Effect:Time_distortion)**
- **[Direct communication with the subconscious](http://psychonautwiki.org/wiki/Effect:Direct_communication_with_the_subconscious)**
- **[States of unity and interconnectedness](http://psychonautwiki.org/wiki/Effect:States_of_unity_and_interconnectedness)**
- **[Ego suppression, loss and death](http://psychonautwiki.org/wiki/Effect:Ego_suppression,_loss_and_death)**
- **[Delusions](http://psychonautwiki.org/wiki/Effect:Delusions)**
- **[Amnesia](http://psychonautwiki.org/wiki/Effect:Amnesia)**
...
- **[Visual acuity enhancement](http://psychonautwiki.org/wiki/Effect:Visual_acuity_enhancement) and [Visual acuity suppression](http://psychonautwiki.org/wiki/Effect:Visual_acuity_suppression)** - 5-MeO-DMT is equally capable of both decreasing and increasing visual acuity. The outcome of which effect will manifest seems to be chosen almost entirely at random and is largely setting dependent.
- **[Colour enhancement](http://psychonautwiki.org/wiki/Effect:Colour_enhancement)**
- **[Colour shifting](http://psychonautwiki.org/wiki/Effect:Colour_shifting)**
- **[Drifting](http://psychonautwiki.org/wiki/Effect:Drifting)** ([Morphing](http://psychonautwiki.org/wiki/Effect:Drifting#Morphing), [Breathing](http://psychonautwiki.org/wiki/Effect:Drifting#Breathing), [Melting](http://psychonautwiki.org/wiki/Effect:Drifting#Melting), [Flowing](http://psychonautwiki.org/wiki/Effect:Drifting#Flowing)) - In comparison to other psychedelics, this effect can be described as identical to DMT in its style, highly detailed, slow and smooth in motion and static in appearance.
- **[Geometry](http://psychonautwiki.org/wiki/Effect:Geometry)** - The visual geometry that is present throughout this trip does not usually occur and never extends beyond level 7 at its highest state. It is very similar to DMT although significantly smaller in size and more likely to manifest in darkness or without distractions. In terms of appearance, it can be comprehensively described through its [variations](http://psychonautwiki.org/wiki/Effect:Geometry#Variations) as intricate in complexity, abstract in form, equally organic and digital in feel, structured in organization, brightly lit, multicoloured in scheme, glossy in shading, equal in sharp and soft edges, small in size, fast in speed, smooth in motion, equal in rounded and angular corners, immersive in depth and consistent in its intensity.
...
- [Enhancements](http://psychonautwiki.org/wiki/Auditory_effects:_Enhancements)
- [Distortions](http://psychonautwiki.org/wiki/Auditory_effects:_Distortions)
- [Hallucinations](http://psychonautwiki.org/wiki/Auditory_effects:_Hallucinations)
...
This substance breakdown was written through collaboration between PsychonautWiki contributors [Pjosepherum](http://www.psychonautwiki.org/wiki/User:PJosepherum), [Josikins](http://www.psychonautwiki.org/wiki/User:Josifikins) and [Oscarette](http://www.psychonautwiki.org/wiki/User:Oscarette). The full article is available [here](http://psychonautwiki.org/wiki/5-MeO-DMT).`,
  "erowid": `# 5-MeO-DMT
*Source: https://erowid.org/chemicals/5meo_dmt/5meo_dmt.shtml*

## Basics
[CHEMICALS](https://erowid.org/chemicals/)
 
[5meo_dmt](https://erowid.org/chemicals/5meo_dmt/)
...
5-MeO-DMT is a psychoactive tryptamine which was first identified in the mid 20th Century as a chemical in a South American plant entheogen. It is a common constituent of many different plants and has been used traditionally in psychoactives snuffs such as Yopo from the Anadenanthera colubrina seeds, Epena from Virola sap, and some ayahuasca-type brews where 5-MeO-DMT containing plants are used as admixtures. In the other parts of the world, including the U.S., 5-MeO-DMT is mostly encountered as a crystalline chemical and smoked, snorted, or swallowed for recreation and/or insight. 5-MeO-DMT is sometimes confused with its more well-known cousin N,N-DMT (usually just called "DMT") which can lead to disasterous results because of the large difference in appropriate dosages (5-MeO-DMT's dosage is perhaps 1/10 to 1/2 that of N,N-DMT, depending on individual reaction). 
 
 5-MeO-DMT has been called just "5MEO", but as other "5-MeO" (methoxy group on the 5 position, such as 5-MeO-DiPT) psychoactives have become known this shortened name is slowly losing its usefulness. 5-MeO-DMT's effects are much less visual than N,N-DMT's, with many users reporting no visual distortions at all. The experience itself is sometimes characterized as 'the void'. 
 
[ [Main 5-MeO-DMT Vault](https://erowid.org/5meo_dmt.shtml) ]
 
[Dose](https://erowid.org/5meo_dmt_dose.shtml) #
...
[Law](https://erowid.org/5meo_dmt_law.shtml) #
...
[Chemistry](https://erowid.org/5meo_dmt_chemistry.shtml) #
...
[History](https://erowid.org/5meo_dmt_timeline.php) #
...
[EFFECTS](https://erowid.org/5meo_dmt_effects.shtml) #
...
[PROBLEMS](https://erowid.org/5meo_dmt_health.shtml) #
...
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to 5meo_dmt](https://erowid.org/chemicals/5meo_dmt/) ]
 
- Created by Erowid - Aug 24, 2000 | Created by Erowid - Aug 24, 2000 | Modified - Feb 10, 2015
**Created by Erowid - Aug 24, 2000**
...
- 5-MeO-DMT Duration Smoked Total Duration5 - 20 mins Onset0 - 1 mins Coming Up0 - 30 secs Plateau3 - 15 mins Coming Down3 - 5 mins After Effects15 - 60 mins Hangover / Day After- - - | 5-MeO-DMT Duration | Smoked | Total Duration | 5 - 20 mins | Onset | 0 - 1 mins | Coming Up | 0 - 30 secs | Plateau | 3 - 15 mins | Coming Down | 3 - 5 mins | After Effects | 15 - 60 mins | Hangover / Day After | - - - | 5-MeO-DMT Duration Insufflated Total Duration- - - Onset1 - 5 mins Coming Up1 - 5 mins Plateau10 - 40 mins Coming Down30 - 60 mins After Effects1 - 3 hrs Hangover / Day After- - - | 5-MeO-DMT Duration | Insufflated | Total Duration | - - - | Onset | 1 - 5 mins | Coming Up | 1 - 5 mins | Plateau | 10 - 40 mins | Coming Down | 30 - 60 mins | After Effects | 1 - 3 hrs | Hangover / Day After | - - -
**5-MeO-DMT Duration**
**Smoked**
- Total Duration: 5 - 20 mins
- Onset: 0 - 1 mins
- Coming Up: 0 - 30 secs
- Plateau: 3 - 15 mins
...
- Smoked POSITIVE short duration immersive experiences powerful "rushing" sensation radical perspective shifting profound life-changing spiritual experiences some people experience erotic / sensual enhancement occasional euphoria internal visions (actual visual effects not as common) NEUTRAL change in perception of time experience of "the void" lack of memory of experience muscle jerking, twitching, abnormal vocalizations unconsciousness / nonresponsiveness lasting 5-20 minutes dissociation increased salivation NEGATIVE overly-intense experiences hard on the lungs to smoke increased salivation can become drooling at high doses difficulty integrating experiences fear, terror and panic dysphoria (bad feelings) fast onset and intensity can lead to problems if not prepared (dropped pipe, knocking things over, falling & hitting head, etc): Insufflated POSITIVE more gradual onset immersive experiences less intense radical perspective shifting profound life-changing spiritual experiences some people experience erotic / sensual enhancement occasional euphoria NEUTRAL change in perception of time experience of "the void" NEGATIVE overly-intense experiences nasal drip difficulty integrating experiences fear, terror and panic dysphoria (bad feelings) intensity can lead to problems if not prepared nausea, vomiting
 
DESCRIPTION #
 
"Chemical Terror" or "Chemical Bliss".
...
- Created by Erowid - May 07, 1999 | Created by Erowid - May 07, 1999 | Modified - Feb 10, 2015
**Created by Erowid - May 07, 1999**
...
5-MeO-DMT is a short acting tryptamine very similar in nature to DMT. It is often found as very small white crystals (like salt) and is generally smoked/vaporized and less commonly insufflated. Dosages are very sensitive. People react very differently to different doses, and insufficient measuring instruments add to the risk. Some individuals have world-shattering effects with less than 5 mg.
 
WARNING: The wide variation in reactions to this and other substances can lead to overwhelmingly intense and frightening experiences even at very low doses.
 
- Smoked/Vaporized 5-MeO-DMT Dosages Threshold1 - 2 mg Light2 - 5 mg Common5 - 10 mg Strong10 - 20 mg | Smoked/Vaporized 5-MeO-DMT Dosages | Threshold | 1 - 2 mg | Light | 2 - 5 mg | Common | 5 - 10 mg | Strong | 10 - 20 mg
...
- Insufflated 5-MeO-DMT Dosages Threshold3 - 5 mg Light5 - 10 mg Common8 - 15 mg Strong10 - 25 mg | Insufflated 5-MeO-DMT Dosages | Threshold | 3 - 5 mg | Light | 5 - 10 mg | Common | 8 - 15 mg | Strong | 10 - 25 mg
...
- Oral 5-MeO-DMT Dosages Threshold?? mg Light10 - 15 mg Common20 - 30 mg Strong30 + mg | Oral 5-MeO-DMT Dosages | Threshold | ?? mg | Light | 10 - 15 mg | Common | 20 - 30 mg | Strong | 30 + mg
...
Note: Oral dosages are based on Jonathan Ott's presentation at the San Francisco [Ayahuasca conference](https://erowid.org/general/conferences/conference_ayahuasca1.shtml) in 2000.
 
---
 
 
- Sublingual 5-MeO-DMT Dosages Threshold?? mg Light10 mg Common?? mg Strong?? mg | Sublingual 5-MeO-DMT Dosages | Threshold | ?? mg | Light | 10 mg | Common | ?? mg | Strong | ?? mg
...
Note: Oral dosages are based on Jonathan Ott's presentation at the San Francisco [Ayahuasca conference](https://erowid.org/general/conferences/conferences_ayahuasca1.shtml) in 2000.
...
- Created by Erowid - Feb 14, 1999 | Created by Erowid - Feb 14, 1999 | Modified - Feb 21, 2015
**Created by Erowid - Feb 14, 1999**
...
1. Brush DE, Bird SB, Boyer EW. ["Monoamine oxidase inhibitor poisoning resulting from Internet misinformation on illicit substances"](https://erowid.org/references/refs_view.php?ID=6411) *J Toxicol Clin Toxicol* . 2004 Jun;42(2):191-5.
2. Sklerov J, Levine B, Moore KA, King T, Fowler D. ["A fatal intoxication following the ingestion of 5-methoxy-N,N-dimethyltryptamine in an ayahuasca preparation"](https://erowid.org/references/6778) *J Anal Toxicol* . 2005 Nov-Dec;29(8):838-41.
3. Callaway JC, Grob CS, McKenna DJ, Nichols DE, Shulgin A, Tupper KW. ["A demand for clarity regarding a case report on the ingestion of 5-methoxy-N, N-dimethyltryptamine (5-MeO-DMT) in an Ayahuasca preparation"](https://erowid.org/references/6821) *J Anal Toxicol* . 2006 Jul-Aug 28;30(6):406-7; author reply.
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to 5meo_dmt](https://erowid.org/chemicals/5meo_dmt/) ]
 
- Created by Erowid - Sep 2, 2010 | Created by Erowid - Sep 2, 2010 | Modified - Feb 20, 2015
...
- REGULATED: Yes
- STATUS: Scheduled
- SCHEDULE: Schedule I(effective Jan 19 2011)
...
5-MeO-DMT was added to Schedule I effective Jan 19, 2011. This means it is illegal to manufacture, buy, possess, or distribute (sell, trade or give) without a DEA license. 
 ...
 See [http://edocket.access.gpo.gov/2010/2010-31854.htm](http://edocket.access.gpo.gov/2010/2010-31854.htm) . 
 
 Leading up to its control as a Schedule I drug: On August 21, 2009, the DEA entered a proposed rule change in the [Federal Register (Volume 74, Number 161)](http://edocket.access.gpo.gov/2009/E9-20204.htm) to Schedule I of the Controlled Substances Act. It is extremely likely that this rule will become final and 5-Meo-DMT will become Schedule I in the United States. On October 28, 2009, the DEA extended the comment period to November 27, 2009. See [http://edocket.access.gpo.gov/2009/E9-25939.htm](http://edocket.access.gpo.gov/2009/E9-25939.htm) .
 
U.S. STATE LAW #
 
China #
 
Controlled in China as a Category I psychotropic substance, illegal to sell, buy, import, export, and manufacture 4-methylmethcathinone as of September 2010. See [China's SFDA announcement](https://erowid.org/psychoactives/law/countries/china/china_law_2015_09_27_list_of_newly_controlled_chemicals.pdf) . (thanks n) (last updated Nov 25, 2015)
 
Florida #
 
Schedule I. See [http://leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0800-0899/0893/0893.html](http://leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0800-0899/0893/0893.html) . (last updated Jul 21, 2012)
 
Louisiana #
 
2C-C, 2C-E, 2C-D, 2C-T-2, 2C-T 2C-T-4, 2C-H, 2C-N, 2C-P, 4-FA, 4-FMA, 6-APDB, 5-APDB, 5-APB6-APB, MDAI, 5-IAI, 4-HO-DIPT, 5-MeO-DMT, 5-MeO-MIPT, 5-MeO-DALT, DIPT, Methoxetamine, and the NBOMe compounds are Schedule I (as of June 2013). See [http://www.legis.state.la.us/lss/lss.asp?doc=98877](http://www.legis.state.la.us/lss/lss.asp?doc=98877) . (thanks ch) (last updated Mar 15, 2014)
 
Nebraska #
 
Schedule I ( [Reference](http://www.hhs.state.ne.us/crl/medical/medsur/Pharmacy.pdf) )
 
Oklahoma #
 
Schedule I ( [Nov 1, 2008](http://www.oscn.net/applications/oscn/DeliverDocument.asp?CiteID=98866
) )
 
S. Dakota #
 
Schedule I : 5-methoxy-N, N-Dimethyltryptamine. [Feb 2003](http://legis.state.sd.us/sessions/2003/bills/SB25enr.htm)
...
According to one visitor, 5-MeO-DMT is not controlled under Canadian law. See [Law Canada](https://erowid.org/psychoactives/law/countries/law_canada.shtml) . (thanks f) (last updated Apr 17 2011)
 
Denmark #
 
As of December 1, 2004, 5-MeO-DMT is legally restricted to "medical or scientific purposes". See [EMCDDA](http://eldd.emcdda.europa.eu/html.cfm/index5176EN.html?pluginMethod=eldd.shownewsdetails&id=22/11/2004DENMARK:%205-MeO-DMT%20added%20to%20list%20of%20controlled%20substances) . (thanks Vman and Ali)
 
Finland #
 
5-MeO-DMT was banned in Finland in December 2014. A new government regulation was enacted in Finland that banned over 100 psychoactive chemicals. See [Finland's Prohibited Psychoactive Substances: December 19, 2014](https://erowid.org/psychoactives/law/countries/finland/finland_law1_2014.pdf) . (last updated Dec 26, 2014)
 
Germany #
 
Schedule I / Highest level of control, unable to be prescribed, manufactured, or possessed as of Sep, 1999. (listed as [2-(5-Methoxyindol-3-yl)ethyl]dimethylazan) (see [Deutsche BtMG](http://www.gifte.de/btmg.htm) or [http://www.silicium-sensei.de/projecte/drugs/news/news.html](http://www.silicium-sensei.de/projecte/drugs/news/news.html) )
 
Greece #
 
5-MeO-DMT became a controlled substance in Greece on Feb 18, 2003 [ [EU Legal Database](http://eldd.emcdda.eu.int/databases/eldd_legal_text.cfm?id=2831&;lang=el&;T=1) ].
 
Japan #
 
5-MeO-DMT is controlled as a "Designated Substance" (Shitei-Yakubutsu) by the Pharmaceutical Affairs Law, making it illegal to possess or sell (see [Ref](https://erowid.org/references/refs_view.php?ID=7395) )
 
Netherlands #
 
5-MeO-DMT is not controlled as a listed drug in the Opium List: List 1 (Hard) or List 2 (Soft). (Thanks PJ) (Last updated Aug 30, 2023)
 
New Zealand #
 
5-MeO-DMT is Schedule I (Class A) in New Zealand [ [reference](https://erowid.org/psychoactives/law/countries/nz/law_nz_info1.shtml) ]. (thanks BC)
 
Russian Federation #
 
5-MeO-DMT became controlled in the Russian Federation starting October, 2011. See [http://www.rg.ru/2011/10/19/narko-dok.html](http://translate.google.com/translate?hl=ru&sl=ru&tl=en&u=http%3A%2F%2Fwww.rg.ru%2F2011%2F10%2F19%2Fnarko-dok.html) . (thanks n) (last updated Jan 2 2012)
 
South Africa #
 
5-MeO-DMT is NOT classified under the Drug and Drug Trafficking Act No. 140 of 1992 as a "Undesirable Dependence Producing Substance". See [www.justice.gov.za/legislation/acts/1992-140.pdf](http://www.justice.gov.za/legislation/acts/1992-140.pdf) , but could be considered an "ether" of Bufotenin (5-OH-DMT) or possibly DMT and ethers and esters of the listed substances are also considered controlled. (thanks MvS) (last updated April 18 2011)
 
Sweden #
 
Controlled in Sweden as of Oct 1, 2004 (see [notisum.se](http://www.notisum.se/rnp/sls/lag/19990058.htm) ). (thanks RH)
...
5-MeO-DMT is controlled in the Ukraine. See [http://search.ligazakon.ua/l_doc2.nsf/link1/KP100373.html](http://search.ligazakon.ua/l_doc2.nsf/link1/KP100373.html) . (thanks p) (Last Updated Aug 30 2017)
 
United Kingdom #
 
5-MeO-DMT is a [Schedule I/Class A](https://erowid.org/psychoactives/law/countries/uk/uk_law_definitions.shtml) drug in the United Kingdom, making it illegal to buy or possess without a license.
 (thanks OW)
...
[DMT Law](https://erowid.org/../dmt/dmt_law.shtml)
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to 5meo_dmt](https://erowid.org/chemicals/5meo_dmt/) ]
 
- Created by Erowid - Jul 31, 1997 | Created by Erowid - Jul 31, 1997 | Modified - Aug 30, 2023
...
- Germany :: [2-(5-Methoxyindol-3-yl)ethyl]dimethylazan
 ...
 **INFORMATION** 
 [Compare 5-MeO-DMT molecule to another chemical](https://erowid.org/psychoactives/chemistry/chemistry_compare.php?rm=&lm=5-meo-dmt_3d)
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to 5meo_dmt](https://erowid.org/chemicals/5meo_dmt/) ]
 
- Created by Erowid - Apr 16, 2000 | Created by Erowid - Apr 16, 2000 | Modified - Feb 21, 2015
**Created by Erowid - Apr 16, 2000**
 
Content & design © 1995-2025 Erowid.org. Permission required before publicly reproducing Erowid info.`,
  "isomerdesign": `# 5-MeO-DMT
...
`,
  "protestkit": `{
  "url": "https://psychonautwiki.org/wiki/5-MeO-DMT",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_5MeODMT.shtml",
  "name": "5-MeO-DMT",
  "aliases": [
    "5-medmt",
    "5-meo",
  ...
  "aliasesStr": "5-medmt,5-meo,5meo,5meodmt,jaguar,the god molecule,toad,toads",
  ...
  "roas": [
    {
      ...
      "duration": [
        {
          "name": "Onset",
          "value": "0.08 - 1.0 minutes"
        },
        {
          "name": "Come up",
          "value": "0.5 - 1.0 minutes"
        },
        {
          "name": "Peak",
          "value": "5.0 - 15.0 minutes"
        },
        {
          "name": "Offset",
          "value": "10.0 - 20.0 minutes"
        },
        {
          "name": "Total",
          "value": "20.0 - 40.0 minutes"
        },
        {
          "name": "After effects",
          "value": "15.0 - 60.0 minutes"
        }
      ]
    },
    {
...
*Source: https://psychonautwiki.org/wiki/5-MeO-DMT*
...
**5-Methoxy-N,N-dimethyltryptamine** (also known as **5-MeO-DMT** ) is a [naturally-occurring](https://psychonautwiki.org/wiki/Naturally-occurring) [psychedelic](https://psychonautwiki.org/wiki/Psychedelic) substance of the [tryptamine](https://psychonautwiki.org/wiki/Tryptamine) class. It is structurally related to [DMT](https://psychonautwiki.org/wiki/DMT) and [5-HO-DMT](https://psychonautwiki.org/wiki/5-HO-DMT) ( *bufotenin* ) and is reputed to produce the most powerful and intense psychedelic states within the entire class. 5-MeO-DMT produces its effects by binding to [serotonin](https://psychonautwiki.org/wiki/Serotonin) [receptors](https://psychonautwiki.org/wiki/Receptors) in the brain, although the precise mechanism is not known.

It is distributed in a wide variety of plant species as well as in the venom of a single toad species ( *Incilius alvarius* ). [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*] Although little is known about its history, it is believed to have been used in South American shamanic practices for centuries. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*] In modern times, both the extracts of the toad venom as well as synthetic powder form are used, primarily via [vaporization](https://psychonautwiki.org/wiki/Vaporization) .

The synthesis and psychoactive effects were documented by [Alexander Shulgin](https://psychonautwiki.org/wiki/Alexander_Shulgin) in his 1997 book [TiHKAL](https://psychonautwiki.org/wiki/TiHKAL) ("Tryptamines I Have Known and Loved"). Recent studies have demonstrated its capacity to induce mystical experiences and there is growing interest in exploring its potential therapeutic effects. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]

[Subjective effects](https://psychonautwiki.org/wiki/Subjective_effects) include [unity and interconnectedness](https://psychonautwiki.org/wiki/Unity_and_interconnectedness) , [time distortion](https://psychonautwiki.org/wiki/Time_distortion) , [conceptual thinking](https://psychonautwiki.org/wiki/Conceptual_thinking) , [euphoria](https://psychonautwiki.org/wiki/Euphoria) , and [ego loss](https://psychonautwiki.org/wiki/Ego_loss) . 5-MeO-DMT's psychedelic effects are best compared to [DMT](https://psychonautwiki.org/wiki/DMT) in terms of intensity (extreme) and duration (very short). However, it generally lacks a [visual geometry](https://psychonautwiki.org/wiki/Geometry) component and tends to produce more [physical euphoria](https://psychonautwiki.org/wiki/Physical_euphoria) as well as even stronger [transpersonal](https://psychonautwiki.org/wiki/Transpersonal) or mystical-like effects (e.g. [ego loss](https://psychonautwiki.org/wiki/Ego_loss) ) than DMT.

Additionally, both mental and physical side effects are reported to occur more often with 5-MeO-DMT. These effects include significant [anxiety](https://psychonautwiki.org/wiki/Anxiety) and [dysphoria](https://psychonautwiki.org/wiki/Cognitive_dysphoria) as well as [nausea](https://psychonautwiki.org/wiki/Nausea) and [bodily discomfort](https://psychonautwiki.org/wiki/Body_load) , and are often described as challenging and overwhelming.

Unlike DMT, which has been shown to possess minimal physiological toxicity, 5-MeO-DMT's safety profile is much less established. A small number of deaths have been linked to its use and appear to be a result of physical overdose. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*] Some reports suggest it may cause serotonin toxicity when combined with certain substances such as [MAOIs](https://psychonautwiki.org/wiki/MAOIs) ; it may also have cardiotoxic properties. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]

Anecdotal reports suggest that this substance is only suitable for users with extensive experience with powerful psychedelics (e.g. [DMT](https://psychonautwiki.org/wiki/DMT) , [ayahuasca](https://psychonautwiki.org/wiki/Ayahuasca) , and [DPT](https://psychonautwiki.org/wiki/DPT) ) and trained in their safe use. It is highly advised to use [harm reduction practices](https://psychonautwiki.org/wiki/Harm_reduction_practices) if using this substance.

## Chemistry

5-MeO-DMT or 5-methoxy-N,N-dimethyltryptamine is a ring-substituted indole [alkaloid](https://psychonautwiki.org/wiki/Alkaloid) molecule of the [tryptamine](https://psychonautwiki.org/wiki/Tryptamine) class. Tryptamines share a core structure comprised of a bicylic indole heterocycle attached at R 3 to a terminal amine group via an ethyl side chain. 5-MeO-DMT is substituted at R 5 of its indole heterocycle with a methoxy (MeO) functional group CH 3 O−; it also contains two methyl groups CH 3 - bound to the terminal amine R N of its tryptamine backbone (DMT).

5-MeO-DMT is the N-substituted methyl homologue of [5-MeO-MiPT](https://psychonautwiki.org/wiki/5-MeO-MiPT) and [5-MeO-DiPT](https://psychonautwiki.org/wiki/5-MeO-DiPT) , although it radically differs in its effects.
...
5-Meo-DMT's [psychedelic](https://psychonautwiki.org/wiki/Psychedelic) effects are primarily believed to come from its efficacy at the [5-HT1A receptor](https://psychonautwiki.org/wiki/Serotonin#The_5-HT_system) as a [partial agonist](https://psychonautwiki.org/wiki/Agonist#Agonists) . Specifically, this molecule shows a high binding affinity for the 5-HT 1A subtype and relatively low binding for the 5-HT 2a subtype. Since common psychedelics are thought to primarily elicit their effects through 5-HT 2a receptor activity, the drug’s binding profile and how it results in the [psychedelic](https://psychonautwiki.org/wiki/Psychedelic) experience continues to remain elusive.

Additional mechanisms of action such as [reuptake inhibition](https://psychonautwiki.org/wiki/Reuptake_inhibition) of [neurotransmitters](https://psychonautwiki.org/wiki/Neurotransmitters) such as [serotonin](https://psychonautwiki.org/wiki/Serotonin) , [noradrenaline](https://psychonautwiki.org/wiki/Noradrenaline) and [dopamine](https://psychonautwiki.org/wiki/Dopamine) are also thought to be involved to an extent. This can result in 5-MeO-DMT becoming dangerously toxic when combined with [MAOIs](https://psychonautwiki.org/wiki/MAOIs) , [RIMAs](https://psychonautwiki.org/wiki/RIMA) , [SSRIs](https://psychonautwiki.org/wiki/SSRI) , [stimulants](https://psychonautwiki.org/wiki/Stimulant) or any substance which acts as a [releasing agent](https://psychonautwiki.org/wiki/Releasing_agent) or [reuptake inhibitor](https://psychonautwiki.org/wiki/Reuptake_inhibitor) of [monoamine neurotransmitters](https://psychonautwiki.org/wiki/Monoamine_neurotransmitter) .

5-MeO-DMT is *O* -demethylated by polymorphic cytochrome P450 2D6 (CYP2D6) to an active metabolite, [bufotenin](https://psychonautwiki.org/wiki/Bufotenin) .
...
- - **[Spontaneous bodily sensations](https://psychonautwiki.org/wiki/Spontaneous_bodily_sensations)** - Perhaps the most remarkable sensation present in the 5-MeO-DMT experience. It increases the intensity of physical and tactile sensations to such an overwhelming extent that it can induce a sensation of sustained and repeatable full body orgasm within every nerve ending across the entire body, to a degree not found within any other psychedelic substance. The experience of this can result in the perception of having a difficulty sustaining the act of breathing. However, this is not a genuine or dangerous experience of [respiratory depression](https://psychonautwiki.org/wiki/Respiratory_depression) and is considered to be safe, although studies into this phenomenon are lacking.
...
- **[Perception of bodily heaviness](https://psychonautwiki.org/wiki/Perception_of_bodily_heaviness)**
...
- **[Muscle tremors](/w/index.php?title=Muscle_tremors&action=edit&redlink=1)**
...
- **[Visual acuity enhancement](https://psychonautwiki.org/wiki/Visual_acuity_enhancement) or [Visual acuity suppression](https://psychonautwiki.org/wiki/Visual_acuity_suppression)** - 5-MeO-DMT is equally capable of both decreasing and increasing visual acuity. The outcome of which effect will manifest seems to be chosen almost entirely at random and is largely setting dependent.
- **[Drifting](https://psychonautwiki.org/wiki/Drifting)** ( [Morphing](https://psychonautwiki.org/wiki/Drifting#Morphing) , [Breathing](https://psychonautwiki.org/wiki/Drifting#Breathing) , [Melting](https://psychonautwiki.org/wiki/Drifting#Melting) , [Flowing](https://psychonautwiki.org/wiki/Drifting#Flowing) ) - In comparison to other psychedelics, this effect can be described as identical to DMT in its style, highly detailed, slow and smooth in motion and static in appearance.
...
The visual geometry that is present throughout this trip does not usually occur and in notable contrast to [DMT](https://psychonautwiki.org/wiki/DMT) , does not extend beyond level 7 at its highest state (though some experiences involving nonvisual 8b have been reported). It is vaguely similar to [DMT](https://psychonautwiki.org/wiki/DMT) although significantly smaller in size and more likely to manifest in darkness or without distractions. In terms of appearance, it can be comprehensively described through its [variations](https://psychonautwiki.org/wiki/Geometry#Variations) as intricate in complexity, abstract in form, equally organic and digital in feel, structured in organization, brightly lit, multicoloured in scheme, glossy in shading, equal in sharp and soft edges, small in size, fast in speed, smooth in motion, equal in rounded and angular corners, immersive in-depth and consistent in its intensity. 5-MeO-DMT is unique in that in breakthrough doses, it uniquely tends to result in [8B Geometry](https://psychonautwiki.org/wiki/8B_Geometry) over [level 8A](https://psychonautwiki.org/wiki/8A_Geometry) . ### Cognitive effects
...
- **[Confusion](https://psychonautwiki.org/wiki/Confusion)**
...
- **[Ego death](https://psychonautwiki.org/wiki/Ego_death)** - This effect is more consistent and reproducible on 5-MeO-DMT than on any other known substance.
...
- **[Hallucinations](https://psychonautwiki.org/wiki/Auditory_hallucinations)** ### Transpersonal effects
 
- **Note** : For a number of individuals these effects are consistently more reproducible and powerful with smoked or vaporized 5-MeO-DMT than they are with other “classical psychedelics” such as [LSD](https://psychonautwiki.org/wiki/LSD) or [mescaline](https://psychonautwiki.org/wiki/Mescaline) , this is most likely due to its very intense but relatively short-lived effects. These components are unique to 5-MeO-DMT in that for a majority of its users they are significantly more likely to manifest during "breakthrough" experiences as opposed to sub-breakthrough level trips. 
- **[Perception of eternalism](https://psychonautwiki.org/wiki/Perception_of_eternalism)**
- **[Perception of self-design](https://psychonautwiki.org/wiki/Perception_of_self-design)**
- **[Perception of predeterminism](https://psychonautwiki.org/wiki/Perception_of_predeterminism)**
- **[Perceived exposure to inner mechanics of consciousness](https://psychonautwiki.org/wiki/Perceived_exposure_to_inner_mechanics_of_consciousness)**
...
- [Experience: 40mg 5-MeO-DMT (oral) + 40mg MXE (oral) - Untitled](https://psychonautwiki.org/wiki/Experience:_40mg_5-MeO-DMT_(oral)_%2B_40mg_MXE_(oral)_-_Untitled)
- [Experience:A combination of DOC, 5-MAPB, 5-MeO-DMT, ETH-LAD, Cannabis, Pentedrone](https://psychonautwiki.org/wiki/Experience:A_combination_of_DOC,_5-MAPB,_5-MeO-DMT,_ETH-LAD,_Cannabis,_Pentedrone)

Additional experience reports can be found here:

- [Erowid Experience Vaults: 5-MeO-DMT](https://www.erowid.org/experiences/subs/exp_5MeODMT.shtml)

## Routes of administration

### Vaporization

When taken in its synthetic powder form, 5-MeO-DMT is typically [vaporized](https://psychonautwiki.org/wiki/Routes_of_administration#Vaporization) , but can also be insufflated (although this is discouraged), and is active at a dose of as little as 2 mg. It has been suggested that it possesses roughly 4-5x the potency of DMT.

### Oral

As with DMT, 5-MeO-DMT has been demonstrated to be active orally when taken with an [MAOI](https://psychonautwiki.org/wiki/MAOI) , but according to numerous reports this combination tends to be extremely unpleasant, producing a strong [body load](https://psychonautwiki.org/wiki/Body_load) in addition to the risk of hypertensive symptoms and [serotonin syndrome](https://psychonautwiki.org/wiki/Serotonin_syndrome) , and is therefore strongly advised against. On both physical and psychological levels, it is considered to be substantially less safe than [DMT](https://psychonautwiki.org/wiki/DMT) . [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]

## Natural sources

### Colorado River toad

The Colorado River toad ( *Incilius alvarius* ), also known as the Sonoran Desert toad, is a toad found in northern Mexico and the southwestern United States. Its skin and venom contain 5-MeO-DMT and [bufotenin](https://psychonautwiki.org/wiki/Bufotenin) (5-HO-DMT). Fresh venom can be collected without harm to the toad. This is done by stroking the parotid glands in the neck region onto a flat glass plate. The venom will take on the texture of rubber cement on drying, which can then be smoked. This product contains up to 15% 5-MeO-DMT, as well as [5-MeO-NMT](/w/index.php?title=5-MeO-NMT&action=edit&redlink=1) and [bufotenin](https://psychonautwiki.org/wiki/Bufotenin) . [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
...
Like other [serotonergic psychedelics](https://psychonautwiki.org/wiki/Serotonergic_psychedelics) , 5-MeO-DMT is considered to be non-addictive with a low abuse potential. There are no literature reports of successful attempts to train animals to self-administer 5-MeO-DMT — an animal model predictive of abuse liability — indicating that it does not have the necessary pharmacology to either initiate or maintain dependence.

Tolerance to the effects of 5-MeO-DMT is built almost immediately after ingestion. After that, it takes about 1 hour for the tolerance to be reduced to half and 2 hours to be back at baseline (in the absence of further consumption). 5-MeO-DMT does not have a cross-tolerance with other [psychedelics](https://psychonautwiki.org/wiki/Psychedelic) , meaning that after the consumption of 5-MeO-DMT psychedelics will not have a reduced effect.
...
- **Cannabis** - May increase the risk of negative psychological effects such as [anxiety](https://psychonautwiki.org/wiki/Anxiety) , [paranoia](https://psychonautwiki.org/wiki/Paranoia) , and [psychosis](https://psychonautwiki.org/wiki/Psychosis) .
...
- **Tramadol** - Increased risk of [serotonin syndrome](https://psychonautwiki.org/wiki/Serotonin_syndrome) .
- **aMT** - Increased risk of [serotonin syndrome](https://psychonautwiki.org/wiki/Serotonin_syndrome) .
- **MAOIs** - Increased risk of [serotonin syndrome](https://psychonautwiki.org/wiki/Serotonin_syndrome) .
- **PCP** - Little information exists about this combination. May increase risk of psychosis and excessive stimulation.

Deaths from 5-MeO-DMT are rare. However, as a powerful [monoamine](https://psychonautwiki.org/wiki/Monoamine) [reuptake inhibitor](https://psychonautwiki.org/wiki/Reuptake_inhibitor) (MRI), injury can occur when excessive doses are taken or when taken with substances such as [MAOIs](https://psychonautwiki.org/wiki/MAOIs) , [RIMAs](https://psychonautwiki.org/wiki/RIMAs) , [stimulants](https://psychonautwiki.org/wiki/Stimulants) and anything which act as a [releasing agent](https://psychonautwiki.org/wiki/Releasing_agent) or [reuptake inhibitor](https://psychonautwiki.org/wiki/Reuptake_inhibitor) of [neurotransmitters](https://psychonautwiki.org/wiki/Neurotransmitters) such as [serotonin](https://psychonautwiki.org/wiki/Serotonin) and [dopamine](https://psychonautwiki.org/wiki/Dopamine) . This has resulted in well documented fatal poisonings that could otherwise have been prevented.

## Legal status

- **Australia** : As a structural analog of *N* , *N* -dimethyltryptamine (DMT), 5-MeO-DMT is a Schedule 9 prohibited substance under the Poisons Standard.
- **Austria** : 5-Meo-DMT is, as an ether of N,N-DMT, illegal to possess, produce and sell under the SMG (Suchtmittelgesetz Österreich). [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
- **Brazil** : Possession, production and sale is illegal as it is listed on Portaria SVS/MS nº 344.
- **China** : As of October 2015, 5-MeO-DMT is a controlled substance in China.
- **Czech Republic** : 5-Meo-DMT is legal in Czechia; as it is not listed in the *Government Regulation n. 463/2013* ( *Nařízení vlády č. 463/2013 Sb* ).
- **Denmark** : As of December 2004, 5-MeO-DMT is legally restricted to "medical or scientific purposes". [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
...
- **Greece** : 5-MeO-DMT became a controlled substance in Greece on February 18, 2003 [EU Legal Database]. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
- **Latvia** : 5-MeO-DMT is a Schedule I drug.
- **The Netherlands:** Since 5-MeO-DMT can be regarded as an ether of bufotenin, it is considered a controlled substance as a List 1 opium under Dutch law. Despite this it is freely available through dutch online research chemical sellers.
- **New Zealand** : 5-MeO-DMT is Schedule I (Class A) in New Zealand. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
...
- **Turkey:** 5-MeO-DMT is classed as a drug and is illegal to possess, produce, supply, or import.
...
- **United States** : 5-MeO-DMT was added to Schedule I, effective January 19, 2011. This means it is illegal to manufacture, buy, possess, or distribute (sell, trade or give) without a DEA license. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
...
- [Bufotenin](https://psychonautwiki.org/wiki/Bufotenin) ( *5-HO-DMT* )

## External links

- [5-MeO-DMT (Wikipedia)](https://en.wikipedia.org/wiki/5-MeO-DMT)
- [5-MeO-DMT (Erowid Vault)](https://erowid.org/chemicals/5meo_dmt/5meo_dmt.shtml)
- [5-MeO-DMT (TiHKAL / Isomer Design)](http://isomerdesign.com/PiHKAL/read.php?domain=tk&id=38)
- [5-MeO-DMT (DrugBank)](https://go.drugbank.com/drugs/DB14010)

### Discussion

- [The Big & Dandy 5-MeO-DMT Thread - First Launch (Bluelight)](http://www.bluelight.org/vb/threads/72085-The-Big-amp-Dandy-5-MeO-DMT-Thread-First-Launch)

## Literature

- Ott, J. (2011). Pharmepéna-Psychonautics: Human Intranasal, Sublingual and Oral Pharmacology of 5-Methoxy-N, N-Dimethyl-Tryptamine. Journal of Psychoactive Drugs, 33(4), 403-407. [https://doi.org/10.1080/02791072.2001.10399925](https://doi.org/10.1080/02791072.2001.10399925)
- Shen, H.-W., Jiang, X.-L., Winter, J. C., & Yu, A.-M. (2010). Psychedelic 5-Methoxy-N,N-dimethyltryptamine: Metabolism, Pharmacokinetics, Drug Interactions, and Pharmacological Actions. Current Drug Metabolism, 11(8), 659–666. [https://doi.org/10.2174/138920010794233495](https://doi.org/10.2174/138920010794233495)
- Davis, A. K., Barsuglia, J. P., Lancelotta, R., Grant, R. M., & Renn, E. (2018). The epidemiology of 5-methoxy-N, N-dimethyltryptamine (5-MeO-DMT) use: Benefits, consequences, patterns of use, subjective effects, and reasons for consumption. Journal of Psychopharmacology. [https://doi.org/10.1177/0269881118769063](https://doi.org/10.1177/0269881118769063)
...
## References
1. ↑ Barsuglia, J.; Davis, A. K.; Palmer, R.; Lancelotta, R.; Windham-Herman, A.-M.; Peterson, K.; Polanco, M.; Grant, Robert; Griffiths, R. R. (2018).["Intensity of Mystical Experiences Occasioned by 5-MeO-DMT and Comparison With a Prior Psilocybin Study"](//www.ncbi.nlm.nih.gov/pmc/articles/PMC6292276).*Frontiers in Psychology*.**9**: 2459.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.3389/fpsyg.2018.02459](//doi.org/10.3389%2Ffpsyg.2018.02459).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[1664-1078](//www.worldcat.org/issn/1664-1078).[OCLC](http://en.wikipedia.org/wiki/OCLC)[701805890](//www.worldcat.org/oclc/701805890).[PMC](http://en.wikipedia.org/wiki/PubMed_Central)[6292276](//www.ncbi.nlm.nih.gov/pmc/articles/PMC6292276).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[30574112](//www.ncbi.nlm.nih.gov/pubmed/30574112).
2. ↑ [Shulgin, Alexander](https://psychonautwiki.org/wiki/Alexander_Shulgin); Shulgin, Ann (1997).["#38. 5-MeO-DMT"](https://erowid.org/library/books_online/tihkal/tihkal38.shtml).*[TiHKAL: The Continuation](https://psychonautwiki.org/wiki/TiHKAL)*. United States: Transform Press.[ISBN](http://en.wikipedia.org/wiki/International_Standard_Book_Number)[0-9630096-9-9](http://en.wikipedia.org/wiki/Special:BookSources/0-9630096-9-9).[OCLC](http://en.wikipedia.org/wiki/OCLC)[38503252](//www.worldcat.org/oclc/38503252).
3. ↑ 3.0 3.1 Shen, H.-W.; Jiang, X.-L.; Winter, J. C.; Yu, A.-M. (2010).["Psychedelic 5-Methoxy-N,N-dimethyltryptamine: Metabolism, Pharmacokinetics, Drug Interactions, and Pharmacological Actions"](//www.ncbi.nlm.nih.gov/pmc/articles/PMC3028383).*Current Drug Metabolism*.**11**(8): 659–666.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.2174/138920010794233495](//doi.org/10.2174%2F138920010794233495).[eISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number#Electronic_ISSN)[1875-5453](//www.worldcat.org/issn/1875-5453).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[1389-2002](//www.worldcat.org/issn/1389-2002).[OCLC](http://en.wikipedia.org/wiki/OCLC)[55201006](//www.worldcat.org/oclc/55201006).[PMC](http://en.wikipedia.org/wiki/PubMed_Central)[3028383](//www.ncbi.nlm.nih.gov/pmc/articles/PMC3028383).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[20942780](//www.ncbi.nlm.nih.gov/pubmed/20942780).
4. ↑ Krebs-Thomson, K.; Ruiz, E. M.; Masten, V.; Buell, M.; Geyer, M. A. (2006). "The roles of 5-HT1Aand 5-HT2receptors in the effects of 5-MeO-DMT on locomotor activity and prepulse inhibition in rats".*Psychopharmacology*.**189**(3): 319–329.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1007/s00213-006-0566-1](//doi.org/10.1007%2Fs00213-006-0566-1).[eISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number#Electronic_ISSN)[1432-2072](//www.worldcat.org/issn/1432-2072).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0033-3158](//www.worldcat.org/issn/0033-3158).[OCLC](http://en.wikipedia.org/wiki/OCLC)[2409222](//www.worldcat.org/oclc/2409222).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[17013638](//www.ncbi.nlm.nih.gov/pubmed/17013638).
5. ↑ 5.0 5.1 Nagai, F.; Nonaka, R.; Satoh, K.; Kamimura, H. (2007). "The effects of non-medically used psychoactive drugs on monoamine neurotransmission in rat brain".*European Journal of Pharmacology*.**559**(2–3): 132–137.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1016/j.ejphar.2006.11.075](//doi.org/10.1016%2Fj.ejphar.2006.11.075).[eISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number#Electronic_ISSN)[1879-0712](//www.worldcat.org/issn/1879-0712).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0014-2999](//www.worldcat.org/issn/0014-2999).[OCLC](http://en.wikipedia.org/wiki/OCLC)[01568459](//www.worldcat.org/oclc/01568459).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[17223101](//www.ncbi.nlm.nih.gov/pubmed/17223101).
6. ↑ Ott, Jonathan (2001). "Pharmepéna-Psychonautics: Human Intranasal, Sublingual and Oral Pharmacology of 5-Methoxy-N, N-Dimethyl-Tryptamine".*Journal of Psychoactive Drugs*.**33**(4): 403–407.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1080/02791072.2001.10399925](//doi.org/10.1080%2F02791072.2001.10399925).[eISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number#Electronic_ISSN)[2159-9777](//www.worldcat.org/issn/2159-9777).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0279-1072](//www.worldcat.org/issn/0279-1072).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[11824699](//www.ncbi.nlm.nih.gov/pubmed/11824699).
7. ↑ ["5-MeO-DMT (5-Methoxydimethyltryptamine): Health"](https://erowid.org/chemicals/5meo_dmt/5meo_dmt_health.shtml). Erowid. September 2, 2010. Retrieved September 29, 2020.
8. ↑ Brush, D. E.; Bird, S. B.; Boyer, E. W. (2004). "Monoamine oxidase inhibitor poisoning resulting from Internet misinformation on illicit substances".*Journal of Toxicology: Clinical Toxicology*.**42**(2): 191–195.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1081/clt-120030949](//doi.org/10.1081%2Fclt-120030949).[eISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number#Electronic_ISSN)[1556-9519](//www.worldcat.org/issn/1556-9519).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[1556-3650](//www.worldcat.org/issn/1556-3650).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[15214625](//www.ncbi.nlm.nih.gov/pubmed/15214625).
9. ↑ Sklerov, J.; Levine, B.; Moore, K. A.; King, T.; Fowler, D. (2005). "A fatal intoxication following the ingestion of 5-methoxy-N,N-dimethyltryptamine in an ayahuasca preparation".*Journal of Analytical Toxicology*.**29**(8): 838–841.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1093/jat/29.8.838](//doi.org/10.1093%2Fjat%2F29.8.838).[eISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number#Electronic_ISSN)[1945-2403](//www.worldcat.org/issn/1945-2403).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0146-4760](//www.worldcat.org/issn/0146-4760).[OCLC](http://en.wikipedia.org/wiki/OCLC)[02942106](//www.worldcat.org/oclc/02942106).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[16356341](//www.ncbi.nlm.nih.gov/pubmed/16356341).
10. ↑ [https://www.legislation.gov.au/Details/F2016L01071/Html/Text#_Toc454279736](https://www.legislation.gov.au/Details/F2016L01071/Html/Text#_Toc454279736)
11. ↑ ["RESOLUÇÃO DA DIRETORIA COLEGIADA - RDC N° 130, DE 2 DE DEZEMBRO DE 2016"](http://portal.anvisa.gov.br/documents/10181/3115436/%281%29RDC_130_2016_.pdf/fc7ea407-3ff5-4fc1-bcfe-2f37504d28b7)(in Portuguese). Agência Nacional de Vigilância Sanitária (ANVISA) [Brazilian Health Regulatory Agency (ANVISA)]. December 5, 2016.
12. ↑ ["关于印发《非药用类麻醉药品和精神药品列管办法》的通知"](https://web.archive.org/web/20170906191704/http://www.sfda.gov.cn/WS01/CL0056/130753.html)(in Chinese). 国家食品药品监督管理总局 [China Food and Drug Administration (CFDA)]. September 27, 2015. Archived from[the original](http://www.sfda.gov.cn/WS01/CL0056/130753.html)on September 6, 2017. Retrieved August 19, 2020.
13. ↑ [https://www.zakonyprolidi.cz/cs/2013-463](https://www.zakonyprolidi.cz/cs/2013-463)
14. ↑ ["Gesetz über den Verkehr mit Betäubungsmitteln: Anlage I"](https://www.gesetze-im-internet.de/btmg_1981/anlage_i.html)(in German). Bundesamt für Justiz [Federal Office of Justice]. Retrieved December 10, 2019.
15. ↑ ["Vierzehnte Verordnung zur Änderung betäubungsmittelrechtlicher Vorschriften"](https://www.bgbl.de/xaver/bgbl/start.xav?start=%2F%2F*%5B%40attr_id%3D%27bgbl100s1414b.pdf%27%5D#__bgbl__%2F%2F*%5B%40attr_id%3D%27bgbl100s1414b.pdf%27%5D__1576702069328).*Bundesgesetzblatt Jahrgang 2000 Teil I Nr. 44*(in German). Bundesanzeiger Verlag (published September 30, 2000). September 27, 2000. pp. 1414–1415.[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0341-1095](//www.worldcat.org/issn/0341-1095). Retrieved December 18, 2019.
16. ↑ ["Gesetz über den Verkehr mit Betäubungsmitteln: § 29"](https://www.gesetze-im-internet.de/btmg_1981/__29.html)(in German). Bundesamt für Justiz [Federal Office of Justice]. Retrieved December 10, 2019.
17. ↑ ["Noteikumi par Latvijā kontrolējamajām narkotiskajām vielām, psihotropajām vielām un prekursoriem"](http://likumi.lv/doc.php?id=121086)(in Latvian). VSIA Latvijas Vēstnesis. November 10, 2005. Retrieved January 1, 2020.
18. ↑ ["List 1 Controlled substances]"](https://web.archive.org/web/20210414060533/https://wetten.overheid.nl/BWBR0001941/2013-07-01)(in Dutch). Archived from[the original](https://wetten.overheid.nl/BWBR0001941/2013-07-01#LijstI)on April 14, 2021. Retrieved November 11, 2021.
19. ↑ [OUG 6 10/02/2010 - Portal Legislativ](https://legislatie.just.ro/Public/DetaliiDocumentAfis/116209)
20. ↑ ["Svensk författningssamling Förordning om ändring i förordningen (1999:58) om förbud mot vissa hälsofarliga varor"](http://www.notisum.se/rnp/sls/sfs/20040696.pdf)(PDF)(in Swedish) (published September 7, 2004). August 19, 2004. SFS 2004:696.
...
22. ↑ Bakanlar Kurulu Kararı Karar Sayısı : 2013/4827 | [https://free-ankara.org/wp-content/uploads/2017/09/BKK_2013_4827_28688.pdf](https://free-ankara.org/wp-content/uploads/2017/09/BKK_2013_4827_28688.pdf)
23. ↑ ["Schedule 2: Part I: Class A Drugs"](http://www.legislation.gov.uk/ukpga/1971/38/schedule/2/part/I).*"Misuse of Drugs Act 1971"*. UK Government. Retrieved August 20, 2020.NewPP limit report Cached time: 20251218075133 Cache expiry: 1209600 Dynamic content: false Complications: [] [SMW] In‐text annotation parser time: 0.074 seconds CPU time usage: 0.429 seconds Real time usage: 0.855 seconds Preprocessor visited node count: 2505/1000000 Post‐expand include size: 179909/2097152 bytes Template argument size: 20720/2097152 bytes Highest expansion depth: 12/40 Expensive parser function count: 0/100 Unstrip recursion depth: 0/20 Unstrip post‐expand size: 32575/5000000 bytes Lua time usage: 0.300/7 seconds Lua virtual size: 8.33 MB/50 MB Lua estimated memory usage: 0 bytes ExtLoops count: 22Transclusion expansion time report (%,ms,calls,template) 100.00% 688.902 1 -total 57.05% 392.990 1 Template:Reflist 26.35% 181.497 7 Template:Cite_journal 19.29% 132.892 11 Template:Cite_web 18.97% 130.715 12 Template:Citation_needed 11.86% 81.722 1 Template:Fix 11.02% 75.925 2 Template:Category_handler 6.41% 44.140 1 Template:SubstanceBox/5-MeO-DMT 6.03% 41.538 1 Template:SubstanceBox 4.66% 32.120 1 Template:Effects/base`,
  "saferparty": `# 5-MeO-DMT
*Source: [SaferParty](https://saferparty.ch) - Drug Checking Service (Switzerland)*

## Effects
The effect depends very much on the set and the setting. Blood pressure and pulse increase, pupils dilate. Detachment of the body from the mind and ego dissolution are common, near-death experiences also occur relatively often, especially when high doses are consumed. The perception of time changes greatly during intoxication. A few minutes can be perceived as very long and intense. In addition, different feelings such as fear, euphoria, etc. can be experienced within a short period of time. Consumers report immersion in very "bizarre" worlds in which connections between being, environment and matter arise. Physical perception can also be influenced, in that one feels weightless or thinks one is falling.
With 5-MeO-DMT, the potential effect is greater, but less optical than with DMT.

## Dosage
MeO-DMT must be dosed very carefully, as even a few milligrams more can cause a very intense and unpleasant effect, which can result in psychological and mental problems lasting several weeks.

## Risks

### Short-term Risks
The risk associated with the use of 5-MeO-DMT is mainly psychological and depends on the personality structure of the user. The perceptual changes during a trip can be so intense that especially inexperienced users feel overwhelmed by the flood of impressions. The perception of sudden emotional outbursts can also be perceived as rather disturbing and overwhelming. At high doses, such psychological side effects can be felt for days to weeks. If the rules of the set and setting are not followed, there can be false reactions, loss of orientation, panic, paranoia and horror trips. Physical side effects include nausea, vomiting, increase in heart rate, slightly accelerated breathing, increased blood pressure, pupil dilation, increased salivation, tremors, restlessness, headaches and movement disorders.

### Long-term Risks
Permanent disturbances in self- and reality recognition are possible. The view of the world can be permanently called into question, which can make it difficult to cope with everyday life. Latent (hidden) psychoses can be triggered.
...
`,
  "thedrugclassroom": `# 5-MeO-DMT
*Source: https://thedrugclassroom.com/video/5-meo-dmt/*

5-MeO-DMT is a psychedelic tryptamine that appears to be an endogenous drug. It can be found in many plants and is also produced by the Bufo alvarius toad.

The drug has been used for centuries in South America and the Caribbean. To this day, it is used by indigenous groups in the form of intranasal snuffs.

It can produce fully dissociative psychedelic experiences, similar to DMT. However, 5-MeO-DMT is far less visual with its effects and seems more likely to cause terror/anxiety responses.

---

5-MeO-DMT = 5-MeO; 5-methoxy-N,N-dimethyltryptamine; N,N-Dimethyl-5-methoxytryptamine; 5-Methoxy-N,N-dimethyltryptamine; Methoxybufotenin
...
[Erowid](https://erowid.org/experiences/subs/exp_5MeODMT.shtml)
...
**(2014)** [The natural hallucinogen 5-MeO-DMT, component of Ayahuasca, disrupts cortical function in rats: reversal by antipsychotic drugs.](https://www.ncbi.nlm.nih.gov/pubmed/24650558)

**(2012)** [A critical review of reports of endogenous psychedelic N, N-dimethyltryptamines in humans: 1955-2010.](https://www.ncbi.nlm.nih.gov/pubmed/22371425)

**(2012)** [Behavioral effects of α,α,β,β-tetradeutero-5-MeO-DMT in rats: comparison with 5-MeO-DMT administered in combination with a monoamine oxidase inhibitor.](https://www.ncbi.nlm.nih.gov/pubmed/22222861)

**(2011)** [Psychedelic 5-Methoxy-N,N-dimethyltryptamine: Metabolism, Pharmacokinetics, Drug Interactions, and Pharmacological Actions](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3028383/)

**(2011)** [Enhanced effects of amphetamine but reduced effects of the hallucinogen, 5-MeO-DMT, on locomotor activity in 5-HT(1A) receptor knockout mice: implications for schizophrenia.](https://www.ncbi.nlm.nih.gov/pubmed/21501627)

**(2007)** [The effects of non-medically used psychoactive drugs on monoamine neurotransmission in rat brain.](https://www.ncbi.nlm.nih.gov/pubmed/17223101)

**(2006)** [The roles of 5-HT1A and 5-HT2 receptors in the effects of 5-MeO-DMT on locomotor activity and prepulse inhibition in rats.](https://www.ncbi.nlm.nih.gov/pubmed/17013638)

**(2006)** [A demand for clarity regarding a case report on the ingestion of 5-methoxy-N, N-dimethyltryptamine (5-MeO-DMT) in an Ayahuasca preparation.](https://www.ncbi.nlm.nih.gov/pubmed/16872575)

**(2005)** [A fatal intoxication following the ingestion of 5-methoxy-N,N-dimethyltryptamine in an ayahuasca preparation.](https://www.ncbi.nlm.nih.gov/pubmed/16356341)

**(2004)** [Monoamine oxidase inhibitor poisoning resulting from Internet misinformation on illicit substances.](https://www.ncbi.nlm.nih.gov/pubmed/15214625)

**(2001)** [Pharmepéna-Psychonautics: Human intranasal, sublingual and oral pharmacology of 5-methoxy-N,N-dimethyl-tryptamine.](https://www.ncbi.nlm.nih.gov/pubmed/11824699)

**(1997)** [Suppressive Effect of Mitragynine on the 5-Methoxy-N,N-dimethyltryptamine-Induced Head-Twitch Response in Mice](http://www.sciencedirect.com/science/article/pii/S0091305796003140)

**(1987)** [In vivo metabolism of 5-methoxy-N,N-dimethyltryptamine and N,N-dimethyltryptamine in the rat.](https://www.ncbi.nlm.nih.gov/pubmed/3472526)

**(1987)** [Serotonin receptor subtype mediation of the interoceptive discriminative stimuli induced by 5-methoxy-N,N-dimethyltryptamine.](https://www.ncbi.nlm.nih.gov/pubmed/3122248)

**(1985)** [Subtypes of the 5-HT receptor mediating the behavioural responses to 5-methoxy-N,N-dimethyltryptamine in the rat.](https://www.ncbi.nlm.nih.gov/pubmed/2935408)

**(1976)** [Biogenesis of 5-methoxy-N,N-dimethyltryptamine in human pineal gland](http://onlinelibrary.wiley.com/doi/10.1111/j.1471-4159.1976.tb04456.x/abstract)

**(1972)** [Effects of 5-methoxy-N,N-dimethyltryptamine on central monoamine neurons](http://www.sciencedirect.com/science/article/pii/0014299972900738)

**(1972)** [Biosynthesis and turnover of N,N-dimethyltryptamine and 5-methoxy-N,N-dimethyltryptamine in Phalaris tuberosa](http://www.sciencedirect.com/science/article/pii/S0031942200865115)

**(1968)** [Structure-activity relationships among 5-methoxy-N:N-dimethyltryptamine, 4-hydroxy-N:N-dimethyltryptamine (psilocin) and other substituted tryptamines](http://www.sciencedirect.com/science/article/pii/0024320568902002)

**(1959)** [Indole Alkaloids of Acer saccharinum (the Silver Maple), Dictyoloma incanescens, Piptadenia colubrina, and Mimosa hostilis](http://pubs.acs.org/doi/abs/10.1021/jo01091a032)
`,
  "tripsit-factsheets": `# 5-MeO-DMT
*Source: https://tripbot.tripsit.me/api/tripsit/getDrug/5-meo-dmt*

## Classification
- **Categories:** psychedelic, research-chemical
- **Also known as:** 5meodmt, toads, 5-meo, 5meo, 5-medmt
...
## Duration
- **Onset:** Insufflated: 1-5, Smoked: 0-1 minutes
- **Duration:** Insufflated: 15-45, Smoked: 5-15 minutes
- **After Effects:** Insufflated: 1-3, Smoked: 1-2 hours
...
Check out our [Drug Combinations](https://wiki.tripsit.me/wiki/Drug_Combinations) page and chart for interactions and combinations of common drugs.
...
[Erowid](https://www.erowid.org/chemicals/5meo_dmt/5meo_dmt.shtml)

[Wikipedia](https://en.wikipedia.org/wiki/5-MeO-DMT)`,
  "wikipedia": `# 5-MeO-DMT
*Source: https://en.wikipedia.org/wiki/5-MeO-DMT*
...
5-MeO-DMT has various possible adverse effects.

## Overdose

There have been cases of death with 5-MeO-DMT. The estimated lethal dose of 5-MeO-DMT relative to a typical recreational dose in humans is unknown. The median lethal dose (LD50) in animals varies widely, ranging from 1 to 5 mg/kg i.v. in sheep to 48 mg/kg i.v. in mice. In one case, combination of 5-MeO-DMT with harmala alkaloids, which act as monoamine oxidase inhibitors (MAOIs), as well as with other drugs, resulted in death. However, the exact contribution of 5-MeO-DMT in this case is difficult to determine.
...
The elimination half-life of 5-MeO-DMT, administered sublingually, was found to be 28 minutes.
...
5-MeO-DMT is the common informal name of the drug and an acronym of one of its chemical names. Mebufotenin is the generic name of the drug and its INNTooltip International Nonproprietary Name. Other names can include O-methylbufotenin, O-methyl-5-HO-DMT, and O,N,N-trimethylserotonin.
...
Ultra-short-acting psychedelics like dimethyltryptamine (DMT) and 5-MeO-DMT may be advantageous compared to longer-acting psychedelics like psilocybin in terms of practicality for use as therapeutic interventions in clinical settings.
