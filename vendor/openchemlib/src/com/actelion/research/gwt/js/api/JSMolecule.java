...
public class JSMolecule {
  ...
  /*-{
  	...
  	if (typeof coordinates === 'boolean') {
  		mol = @com.actelion.research.gwt.js.api.JSMolecule::fromIDCode(Ljava/lang/String;Z)(idcode, coordinates);
  	} else if(typeof coordinates === 'string') {
  		mol = @com.actelion.research.gwt.js.api.JSMolecule::fromIDCode(Ljava/lang/String;Ljava/lang/String;)(idcode, coordinates);
  	}
  	return mol;
  }-*/;
  ...
  /*-{
    ...
    return this.@com.actelion.research.gwt.js.api.JSMolecule::toIsomericSmilesInternal(ZZZ)(createSmarts, includeMapping, kekulizedOutput);
  }-*/;
  ...
  /*-{
  	return {
  		idCode: this.@com.actelion.research.gwt.js.api.JSMolecule::getIDCode()(),
  		coordinates: this.@com.actelion.research.gwt.js.api.JSMolecule::getIDCoordinates()()
  	};
  }-*/;
  ...
  /*-{
  	if (atomNumber === undefined) {
  		this.@com.actelion.research.gwt.js.api.JSMolecule::addImplicitHydrogens()();
  	} else {
  		this.@com.actelion.research.gwt.js.api.JSMolecule::addImplicitHydrogens(I)(atomNumber);
  	}
  }-*/;
  ...
  /*-{
    if (esrType === undefined) {
      this.@com.actelion.research.gwt.js.api.JSMolecule::addMissingChirality()();
    } else {
      this.@com.actelion.research.gwt.js.api.JSMolecule::addMissingChirality(I)(esrType);
    }
  }-*/;
  ...
  /*-{
  	...
  	return @com.actelion.research.chem.contrib.HoseCodeCreator::getHoseCodes(Lcom/actelion/research/chem/StereoMolecule;II)(this.@com.actelion.research.gwt.js.api.JSMolecule::oclMolecule, maxSphereSize, type);
  }-*/;
  ...
  // DoseWiki local modification: depiction-only bold-bond marker.
  public boolean isBondBold(int bond) {
    return oclMolecule.isBondBold(bond);
  }

  // DoseWiki local modification: depiction-only bold-bond marker.
  public void setBondBold(int bond, boolean bold) {
    oclMolecule.setBondBold(bond, bold);
  }
