...
describe("open-data EffectIndex route", () => {
  it("serves the EffectIndex dataset and revalidates daily", async () => {
    ...
    expect(mocks.openDataResponse).toHaveBeenCalledWith(OPEN_DATA_DATASETS.EffectIndex);
