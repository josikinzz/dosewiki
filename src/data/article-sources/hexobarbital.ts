...
export const substanceName = "Hexobarbital";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Hexobarbital.json","displayName":"Protest Kit","size":1308},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Hexobarbital.md","displayName":"TripSit Factsheets","size":592},{"id":"wikipedia","fileName":"WIKIPEDIA - Hexobarbital.md","displayName":"Wikipedia","size":7650}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/hexobarbital",
  "experiencesUrl": "https://www.reddit.com/search/?q=Hexobarbital",
  "name": "Hexobarbital",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# Hexobarbital
*Source: TripSit Factsheets (tripsit.me)*

## Summary

The drug is barbiturate that was used for anesthesia during surgery. The drug has a very rapid onset and a short duration of effects.

## Classification
- **Categories:** barbiturate, depressant, habit-forming, tentative
...
*Note:  Note: These dosages are extremely tentative.*
...
*Source: https://en.wikipedia.org/wiki/Hexobarbital*
