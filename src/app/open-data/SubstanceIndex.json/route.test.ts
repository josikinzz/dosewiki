...
describe("open-data SubstanceIndex route", () => {
  it("serves the SubstanceIndex dataset and revalidates daily", async () => {
    ...
    expect(mocks.openDataResponse).toHaveBeenCalledWith(OPEN_DATA_DATASETS.SubstanceIndex);
