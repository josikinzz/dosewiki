...
export const substanceName = "Pagoclone";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Pagoclone.json","displayName":"Protest Kit","size":770},{"id":"thedrugclassroom","fileName":"THEDRUGCLASSROOM - Pagoclone.md","displayName":"The Drug Classroom","size":40444},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Pagoclone.md","displayName":"TripSit Factsheets","size":376},{"id":"wikipedia","fileName":"WIKIPEDIA - Pagoclone.md","displayName":"Wikipedia","size":3093}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/pagoclone",
  "experiencesUrl": "https://www.reddit.com/search/?q=Pagoclone",
  "name": "Pagoclone",
  "aliases": [],
  "aliasesStr": "",
  ...
  "thedrugclassroom": `# Pagoclone
*Source: https://thedrugclassroom.com/video/pagoclone/*
...
Show Papers(Maguire, 2010) – Pagoclone is effective in the treatment of stuttering 
- Background 
...
Show Papers(Sandford, 2001) – It is effective in the short-term treatment of panic disorder 
...
Show Papers(de Wit, 2006) – It has a similar abuse potential to diazepam at higher doses 
...
Show Papers(Atack, 2006) – 5′-hydroxy-pagoclone occurs at higher concentrations in animals and is likely responsible for the effects 
- Research 
...
Show Papers(Dalvie, 2009) – Pagoclone is metabolized to 5′-hydroxy-pagoclone to a significant extent in humans
...
Pagoclone was discovered by Rhone-Poulenc, a French pharmaceutical company that would come to be known as Aventis following a merger with Hoechst Marion Roussel. A 1994 patent ( [5498716](https://patents.justia.com/patent/5498716) ) from Rhone-Poulenc described it as exhibiting “remarkably anxiolytic, hypnotic, anticonvulsant, antiepileptic, and muscle relaxant properties.”
...
An [article](http://archive.boston.com/business/globe/articles/2006/05/25/drug_for_stutterers_shows_promise/) in the Boston Globe said pagoclone “shows promise” for stutterers. Brooke Wagner, an Indevus spokesperson, said a larger trial with 600 to 1,000 patients was needed to confirm its effects.

**September**

[ABC News](https://abcnews.go.com/Health/story?id=2432639&page=1) reported that pagoclone, unlike other stuttering medications, produces just a few mild side effects and researchers believe it works by lowering dopamine levels in the brain.
...
Though it was the first drug tested through the FDA process specifically for stuttering, Dr. Gerald Maguire, one of the main pagoclone researchers, [revealed](https://www.stammering.org/speaking-out/article/pagoclone-disappointing-news) the latest data was not impressive. During the US National Stuttering Association conference in Ohio, Dr. Maguire informally discussed the Phase 2B study results and said the pre-specified criteria for success were not met. Significant and lasting gains in fluency were not seen.

**November**

Dr. Gerald Maguire [said](https://www.ocregister.com/2010/11/02/uci-doc-tests-drug-to-cure-stuttering-including-his-own/) pagoclone would not be approved by the FDA for stuttering anytime soon. He thinks the antipsychotic asenapine “is going to be better.”

#### 2011

Endo Pharmaceuticals [decided](https://stutter-mind-body.blogspot.com/2011/12/breaking-news-about-pagoclone.html) not to continue its research program focused on pagoclone for stuttering.
...
Show Papers(Caveney, 2008) – It impairs some aspects of performance, though tolerance removes the effect. 
...
## References
Show ReferencesAtack, J. R., Pike, A., Marshall, G., Stanley, J., Lincoln, R., Cook, S. M., … Reynolds, D. S. (2006). The in vivo properties of pagoclone in rat are most likely mediated by 5′-hydroxy pagoclone. *Neuropharmacology* , *50* (6), 677–689. https://doi.org/10.1016/j.neuropharm.2005.11.014
...
Wong, G., Uusi-Oukari, M., Hansen, H. C., Suzdak, P. D., & Korpi, E. R. (1995). Characterization of novel ligands for wild-type and natural mutant diazepam-insensitive benzodiazepine receptors. *European Journal of Pharmacology* , *289* (2), 335–42. Retrieved from http://www.ncbi.nlm.nih.gov/pubmed/7621907`,
  "tripsit-factsheets": `# Pagoclone
*Source: TripSit Factsheets (tripsit.me)*

## Summary

An anxiolytic drug related to zopiclone with reportedly no sedative or hypnotic qualities. The drug has been investigated as a possible alcohol replacement. Related in structure and effect to zopiclone and zolpidem.

## Classification
- **Categories:** depressant, habit-forming, tentative, research-chemical
`,
  "wikipedia": `# Pagoclone
