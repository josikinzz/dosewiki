...
export const substanceName = "Marinol";
export const sources = [{"id":"drugbank","fileName":"DRUGBANK - Marinol.md","displayName":"DrugBank","size":38400},{"id":"protestkit","fileName":"PROTESTKIT - Marinol.json","displayName":"Protest Kit","size":3415},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Marinol.md","displayName":"TripSit Factsheets","size":576},{"id":"wikipedia","fileName":"WIKIPEDIA - Marinol.md","displayName":"Wikipedia","size":7292}];
export const contents: Record<string, string> = {
  "drugbank": `# Dronabinol
*Source: https://go.drugbank.com/drugs/DB00470*
...
4
. While both CBD and THC are used for medicinal purposes, they have different receptor activity, function, and physiological effects. If not provided in their activated form (such as through synthetic forms like Dronabinol or
Nabilone
), THC and CBD are obtained through conversion from their precursors, tetrahydrocannabinolic acid-A (THCA-A) and cannabidiolic acid (CBDA), through decarboxylation reactions. This can be achieved through heating, smoking, vaporization, or baking of dried unfertilized female cannabis flowers.
From a pharmacological perspective, Cannabis' diverse receptor profile explains its potential application for such a wide variety of medical conditions. Cannabis contains more than 400 different chemical compounds, of which 61 are considered cannabinoids, a class of compounds that act upon endogenous cannabinoid receptors of the body
1
. The endocannabinoid system is widely distributed throughout the central and peripheral nervous system (via the Cannabinoid Receptors CB1 and CB2) and plays a role in many physiological processes such as inflammation, cardiovascular function, learning, pain, memory, stress and emotional regulation, and the sleep/wake cycle among many others
2
. CB1 receptors are found in both the central and peripheral nervous system, and are most abundant in the hippocampus and amygdala, which are the areas of the brain responsible for short-term memory storage and emotional regulation. CB2 receptors are mainly located in the peripheral nervous system and can be found on lymphoid tissue where they are involved in regulation of immune function
3
.
...
subjects developed tolerance to the cardiovascular and subjective adverse CNS effects of dronabinol within 12 days of treatment initiation.
8
...
1
. Dronabinol and its principal active metabolite, 11-OH-delta-9-THC, are present in approximately equal concentrations in plasma. Concentrations of both parent drug and metabolite peak at approximately 0.5 to 4 hours after oral dosing and decline over several days
Label
.
...
patients. In general, dose selection for an elderly patient should be cautious, usually starting at the low end of the dosing range, reflecting the greater frequency of falls decreased hepatic, renal, or cardiac function, increased sensitivity to psychoactive effects, and concomitant disease or other drugs therapy.
8
...
1,2-Benzodiazepine
Dronabinol may increase the central nervous system depressant (CNS depressant) activities of 1,2-Benzodiazepine.
Abametapir
The serum concentration of Dronabinol can be increased when it is combined with Abametapir.
Abatacept
The metabolism of Dronabinol can be increased when combined with Abatacept.
Abrocitinib
The metabolism of Abrocitinib can be decreased when combined with Dronabinol.
Acalabrutinib
The serum concentration of Dronabinol can be increased when it is combined with Acalabrutinib.
...
Dronabinol
is a synthetic delta-9-THC used in the treatment of anorexia and weight loss in HIV patients as well as nausea and vomiting in cancer chemotherapy.
...
8
Due to its redistribution, dronabinol and its metabolites may be excreted for prolonged periods of time. Following single-dose administration, dronabinol metabolites have been detected for more than 5 weeks in the urine and feces.
8
...
polyketide, diterpenoid, phytocannabinoid, benzochromene (
CHEBI:66964
)
/
Cannabinoids (
...
FDA Approved Drug Products: Syndros (Dronabinol) Oral Solution [
Link
]
WHO Expert Committee on Drug Dependence Pre-Review: delta-9-tetrahydrocannibinol [
Link
]
FDA Approved Drug Products: Syndros (Dronabinol) Oral Solution 2022 [
Link
]
Health Canada Approved Drug Proucts: Marinol (Dronabinol) Oral Solution [
Link
]
...
Predicted GC-MS
splash10-0597-4090000000-670e40c1592b93325e44
Mass Spectrum (Electron Ionization)
MS
splash10-01pp-4792000000-06532e533cb7794b7c37
Predicted MS/MS Spectrum - 10V, Positive (Annotated)
Predicted LC-MS/MS
splash10-014i-0129000000-792c85d14937e55c73fe
Predicted MS/MS Spectrum - 10V, Negative (Annotated)
Predicted LC-MS/MS
splash10-03di-0009000000-e947c52964a2fca1ce5a
Predicted MS/MS Spectrum - 20V, Negative (Annotated)
Predicted LC-MS/MS
splash10-03di-0009000000-b2083a653e404ead65fa
Predicted MS/MS Spectrum - 20V, Positive (Annotated)
Predicted LC-MS/MS
splash10-01b9-1394000000-50341056af05e6c9813e
Predicted MS/MS Spectrum - 40V, Negative (Annotated)
Predicted LC-MS/MS
splash10-0aor-0090000000-aab8cc16af6513de6af4
Predicted MS/MS Spectrum - 40V, Positive (Annotated)
Predicted LC-MS/MS
splash10-0006-5490000000-fa50a9e3305f72f9328b
...
`,
  "protestkit": `{
  "url": "https://drugs.tripsit.me/marinol",
  "experiencesUrl": "https://www.reddit.com/search/?q=Marinol",
  "name": "Marinol",
  "aliases": [
    "cesamet",
    "delta9-tetrahydrocannabinol",
  ...
  "aliasesStr": "cesamet,delta9-tetrahydrocannabinol,delta9-thc,dronabinol,syndros,δ9--tetrahydrocannabinol,δ9-thc",
...
## Classification
- **Categories:** depressant, tentative
- **Also known as:** dronabinol, syndros, cesamet, δ9-thc, δ9--tetrahydrocannabinol, delta9-tetrahydrocannabinol, delta9-thc
...
*Source: https://en.wikipedia.org/wiki/Dronabinol*
...
Dronabinol is the principal psychoactive constituent enantiomer form, (−)-trans-Δ9-tetrahydrocannabinol, found in Cannabis sativa L. plants, but can also be synthesized in laboratory. Dronabinol does not include any other tetrahydrocannabinol (THC) isomers or any cannabidiol (CBD).
...
The FDA has recognized that there can be cannabinoid impurities in pharmaceutical dronabinol including cannabinol, Δ8-Tetrahydrocannabinol, isotetrahydrocannabinol and Δ11-tetrahydrocannabinol.
`,
};
