...
export const substanceName = "Nitrous";
export const sources = [{"id":"disregardeverythingisay","fileName":"DISREGARDEVERYTHINGISAY - Nitrous.md","displayName":"DEIA","size":13722},{"id":"drugbank","fileName":"DRUGBANK - Nitrous.md","displayName":"DrugBank","size":11684},{"id":"drugusersbible","fileName":"DRUGUSERSBIBLE - Nitrous.md","displayName":"Drug Users Bible","size":1505},{"id":"erowid","fileName":"EROWID - Nitrous.md","displayName":"Erowid","size":24111},{"id":"isomerdesign","fileName":"ISOMERDESIGN - Nitrous.md","displayName":"Isomer Design","size":542},{"id":"protestkit","fileName":"PROTESTKIT - Nitrous.json","displayName":"Protest Kit","size":4524},{"id":"psychonautwiki","fileName":"PSYCHONAUTWIKI - Nitrous.md","displayName":"PsychonautWiki","size":46480},{"id":"saferparty","fileName":"SAFERPARTY - Nitrous.md","displayName":"Safer Party","size":1337},{"id":"thedrugclassroom","fileName":"THEDRUGCLASSROOM - Nitrous.md","displayName":"The Drug Classroom","size":92643},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Nitrous.md","displayName":"TripSit Factsheets","size":2124},{"id":"tripsit-wiki","fileName":"TRIPSIT_WIKI - Nitrous.md","displayName":"TripSit Wiki","size":3609},{"id":"wikipedia","fileName":"WIKIPEDIA - Nitrous.md","displayName":"Wikipedia","size":35407}];
export const contents: Record<string, string> = {
  "disregardeverythingisay": `# Nitrous
*Source: https://disregardeverythingisay.com/post/76500383493/nitrous-oxide-broken-down-and-described*

*Disregard Everything I Say - Nitrous Oxide, broken down and described*
...
The Nitrous Oxide experience contains a complex and wide array of effects which based on the predefined potential subjective effects index found [here](http://psychonautwiki.org/index.php?title=Subjective_effects_index), I will now begin to breakdown and describe.
...
Click **[here](http://psychonautwiki.org/wiki/Nitrous)** for a more comprehensive breakdown.`,
  "drugbank": `# Nitrous oxide
*Source: https://go.drugbank.com/drugs/DB06690*
...
1,2-Benzodiazepine
The risk or severity of CNS depression can be increased when Nitrous oxide is combined with 1,2-Benzodiazepine.
Acebutolol
Nitrous oxide may decrease the antihypertensive activities of Acebutolol.
Aceclofenac
The risk or severity of hypertension can be increased when Nitrous oxide is combined with Aceclofenac.
Acemetacin
The risk or severity of hypertension can be increased when Nitrous oxide is combined with Acemetacin.
Acetaminophen
The risk or severity of methemoglobinemia can be increased when Acetaminophen is combined with Nitrous oxide.
...
Nitrous oxide
is an inhalatory gas used as an adjunct to improve oxygenation and reduce the need for extracorporeal membrane oxygenation in certain neonates with hypoxic respiratory failure.
...
InChI
Similar Structures
Structure for Nitrous oxide (DB06690)
×
Close
...
Predicted GC-MS
splash10-0006-9000000000-eb7b02e9ea0e132b0a58
...
*Section 2.6.10 - CHEMSCAPE: A Chemical Journey*

## Quick Reference
- **Common Nomenclature:** Nitrous Oxide
- **Street & Reference Names:** Hippy Crack; Nitro; NOS; Laughing Gas;
...
For my own experiment, I elected to use the balloon method, which is commonly
considered to provide one of the safer forms of inhalation. Using a device known as
an N2O Cracker, two canisters were blown into a balloon. The content of this was
then inhaled and held. This had an immediate effect, in that my headspace dissipated
and appeared to distance from my physical being, but it was quick; too quick. It was a
wham bam type of hit, with little fulfilment or pleasure.

During the aftermath I felt strangely calm and was almost sedated for a period, at
least to a small degree. Perhaps this is part of the attraction, but for me, it wasn't a
particularly rewarding experience.

I have an inkling that starting from a different state of mind might provide a more
positive outcome, and in some cases, act as a reset button in terms of mood. I should
add, however, that this is largely speculation.
`,
  "erowid": `# Nitrous
*Source: https://www.erowid.org/chemicals/nitrous/nitrous.shtml*

## Basics
[CHEMICALS](https://erowid.org/chemicals/)
 
[nitrous](https://erowid.org/chemicals/nitrous/)
...
[Nitrous Oxide Images](https://erowid.org/nitrous_images.shtml)
 
Nitrous Oxide (N 2 O) is a simple gas that, when inhaled, causes rapid analgesia (pain relief), euphoria, mild sedation, and sometimes psychedelic dissociation. It has been used in dentistry since the mid 1800's and recreationally since the late 1700's when it earned the name 'laughing gas' because of its tendency to cause laughter in those who inhale. 
 
[ [Main Nitrous Vault](https://erowid.org/nitrous.shtml) ]
...
[Law](https://erowid.org/nitrous_law.shtml) #
...
[Chemistry](https://erowid.org/nitrous_chemistry.shtml) #
 
Nitrous Oxide (N 2 O) is an extremely simple naturally occurring gas which is produced synthetically for sale.
...
[History](https://erowid.org/nitrous_timeline.php) #
...
Nitrous Oxide; Nitrous; Laughing Gas; Hippy Crack; N 2 O.
 
The Experience:
 
No common terms known.
 
[EFFECTS](https://erowid.org/nitrous_effects.shtml) #
...
[PROBLEMS](https://erowid.org/nitrous_health.shtml) #
 
Although generaly considered quite safe when used medically and sparingly, it has some negative health consequences when used chronically. Heavy Nitrous use can lead to a depletion of vitamin B 12 . This can cause numbing of fine nerve endings, especially noticeable in the fingers and toes. Supplements of B 12 may reduce the chances of this occurring in heavy users. Shots of B 12 are given as a treatment for advanced depletion. If left untreated B 12 deficiency can lead to long-term damage. 
...
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to nitrous](https://erowid.org/chemicals/nitrous/) ]
...
- Nitrous Oxide Duration Inhaled (single breath) Total Duration1-5 mins Onset0 - 1 mins Coming Up15 - 30 secs Plateau1 - 5 mins Coming Down10 mins After Effects15 - 30 mins Hangover / Day After- - - | Nitrous Oxide Duration | Inhaled (single breath) | Total Duration | 1-5 mins | Onset | 0 - 1 mins | Coming Up | 15 - 30 secs | Plateau | 1 - 5 mins | Coming Down | 10 mins | After Effects | 15 - 30 mins | Hangover / Day After | - - -
**Nitrous Oxide Duration**
**Inhaled (single breath)**
- Total Duration: 1-5 mins
- Onset: 0 - 1 mins
- Coming Up: 15 - 30 secs
- Plateau: 1 - 5 mins
- Coming Down: 10 mins
- After Effects: 15 - 30 mins
- Hangover / Day After: - - -
...
- numbness in extremities (fingers, nose, lips) with heavy, regular use, see [Nitrous Health](https://erowid.org/nitrous_health.shtml)
 
DESCRIPTION #
 
There is currently no Effects Description for this substance.
...
[Nitrous Pharmacology Notes](https://erowid.org/nitrous_info3.shtml)
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to nitrous](https://erowid.org/chemicals/nitrous/) ]
 
- Created by Erowid - Jul 22, 2005 | Created by Erowid - Jul 22, 2005 | Modified - Feb 10, 2015
**Created by Erowid - Jul 22, 2005**
...
- Never strap a gas mask to your face while using pure nitrous as it is possible to black out and die from lack of oxygen. Never use a garbage bag as a delivery device. It is possible (and has happened) to black out and suffocate when the bag falls over the nose and mouth. Never open a tank of nitrous in a sealed room, closet, car, or other space.
 ...
 Heavy and frequent nitrous use can deplete vitamin B 12 in the body and lead to serious and unpleasant neurological problems. Users may experience numbness and tingling in the fingers, toes, lips, etc. In more severe cases, numbness of all extremeties. Taking B 12 supplements, especially in combination with multi vitamin and complete amino acid supplements, may help alleviate this problem. If you experience these symptoms, cease nitrous use immediately and if the symptoms persist, seek medical attention. See [Nitrous & B-Vitamin Dangers](https://erowid.org/nitrous_health2.shtml) . 
...
[No2N2O: Nitrous Oxide Harm Reduction](https://no2n2o.org/health.html)
 
[Reddit: Nitrous Health Summary and Discussion](http://www.reddit.com/r/Drugs/comments/174hhp/why_nitrous_might_be_the_most_damaging_drug_you/)
 
[ [back to chemicals](https://erowid.org/chemicals/) ] [ [back to nitrous](https://erowid.org/chemicals/nitrous/) ]
 
- Created by Erowid - Unknown | Created by Erowid - Unknown | Modified - May 13, 2025
**Created by Erowid - Unknown**
...
Many states outlaw the use of nitrous for recreational purposes and the sale of nitrous oxide in tanks is controlled with a variety of licensing requirements. 
 ...
 [State Laws Concerning Nitrous Oxide (May 2002)](http://www.cognitiveliberty.org/dll/N20_state_laws.htm) 
 [State by State Inhalant Legislation (somewhat out of date, 1997)](https://erowid.org/chemicals/inhalants/inhalants_law1.shtml) 
...
California state law prohibits the possession of nitrous oxide with the intent to use it as a psychoactive unless it is administered by medical personnel. See California penal code 381b : "381b. Any person who possesses nitrous oxide or any substance containing nitrous oxide, with the intent to breathe, inhale, or ingest for the purpose of causing a condition of intoxication,elation, euphoria, dizziness, stupefaction, or dulling of the senses or for the purpose of, in any manner, changing, distorting, or disturbing the audio, visual, or mental processes, or who knowingly and with the intent to do so is under the influence of nitrous oxide or any material containing nitrous oxide is guilty of a misdemeanor. This section shall not apply to any person who is under the influence of nitrous oxide or any material containing nitrous oxide pursuant to an administration for the purpose of medical, surgical, or dental care by a person duly licensed to administer such an agent." 
 ...
 The city of Rialto, CA passed an ordinance in Mar 2017 making the sale or distribution of nitrous oxide illegal regardless of its intended us with "the exception of sales of the gas for lawful medical and industrial use". Persons violating the ordinance can face jail time, a \$1,000 fine or both. See [Rialto passes unique nitrous oxide ordinance aimed at protecting youth](http://www.dailybulletin.com/government-and-politics/20170302/rialto-passes-unique-nitrous-oxide-ordinance-aimed-at-protecting-youth) .
 
Florida #
 
A new 2005 law in Florida makes possession and use of nitrous oxide for inhaling pruposes a second-degree misdemeanor, punishable by 60 days in jail and a \$500.00 fine. Selling, purchasing, transferring, or possessing more than 16 grams of nitrous oxide for the purpose of inhaling is now a third-degree felony punishable by five (5) years in prison and a \$5,000.00 fine. Florida also closed a loophole that allowed nitrous oxide and nitrous oxide paraphernalia (used to store, transfer, or inhale nitrous oxide) to be sold in tobacco shops. Now the use or possession with intent to use such nitrous oxide paraphernalia is a first-degree misdemeanor punishable by one (1) year in jail and a \$1,000.00 fine. See [Florida State Statute Title XLVI Chapter 877.111](http://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&Search_String=&URL=Ch0877/SEC111.HTM&Title=-%3E2001-%3ECh0877-%3ESection%20111) . (thanks D5)
 
Oregon #
 
Oregon controls Nitrous Oxide as an inhalant under [Chapter 229, section 1.](http://www.leg.state.or.us/99orlaws/sess0200.dir/0229ses.html) It makes the possession of inhalants illegal "for the purpose of inducing intoxication".
 
INTERNATIONAL LAW #
 
Australia #
 
We believe that as of July 1, 2004, Australia now adds a number of police powers for searching and detaining individuals under 18 and seizing "volatile inhalants" from them. The Oct 2004 [Australian Government Institute of Criminology](http://www.aic.gov.au/research/drugs/types/inhalants.html) seems to have out of date information and doesn not mention the new rule. More up to date information can be found at the [Australian Drug Info Clearinghouse](http://www.druginfo.adf.org.au/article.asp?id=8053&ContainerID=561) . 
...
Nitrous chargers widely available over-the-counter. We have been told that many stores will only sell to people 25 and older. Other visitors describe buying whipe-cream chargers without being asked for ID. (unconfirmed) (thanks J) (last updated Sep 24, 2015)
 
Korea #
 
In July 2017, the Republic of Korea Ministry of Environment banned the inhalation, sales or possession of nitrous for inhalation purposes, with infractions punishable by three years in prison or a fine of up to 50 million won (~\$44,762), the ministry said. See [Govt. bans abuse of nitrous oxide](http://www.koreaherald.com/view.php?ud=20170725000401) .
 
Netherlands #
 
Nitrous chargers are widely available over-the-counter. The use of nitrous oxide for recreational purposes is legal (not prohibited). Nitrous oxide is legally sold to the general public for food use, though it is technically illegal to sell for recreational use (it is considered a prescription medicine when inhaled). Many stores regularly sell to people under 18. (thanks K, LB) (last updated Oct 11, 2012)
 
New Zealand #
 
In April, 2005, the New Zealand Ministry of Health reviewed the use of Nitrous Oxide and declared that much of the importation, sale, and possession was for "misuse" and in violation of the Medicines Act of 1981. Nitrous Oxide whip cream chargers have become difficult to buy over-the-counter as of May 1, 2005. See [Ministry of Health Background Information on Nitrous Oxide](http://www.moh.govt.nz/moh.nsf/0/2bf754585cd67838cc256fe700044e36?OpenDocument) and [Scoop.co.nz](http://www.scoop.co.nz/stories/GE0504/S00083.htm) .
 
U.K. #
 
Nitrous Oxide is widely available in the United Kingdom. In the UK possesion of nitrous for non-inhalant use is not controlled and is legal. It is illegal to sell or provide nitrous oxide to someone under 18 years old "if he knows or has reasonable cause to believe that the substance is, or its fumes are, likely to be inhaled by the person under the age of eighteen for the purpose of causing intoxication.". See [http://www.legislation.gov.uk/ukpga/1985/26/section/1](http://www.legislation.gov.uk/ukpga/1985/26/section/1) . One visitor tells us the law is only only enforced against locations such as night clubs that sell or allow to be sold nitrous oxide and have been warned by authorities. (thanks D) (last updated Jan 24, 2013)
...
- Created by Erowid - Mar 03, 1998 | Created by Erowid - Mar 03, 1998 | Modified - Sep 7, 2017
...
- NAME :: Nitrous Oxide
- ALT. CHEMICAL NAMES :: Dinitrogen monoxide; hyponitrous acid anydride; factitious air.
 ...
 **INFORMATION** 
 [Nitrous Material Safety Data Sheet](https://erowid.org/nitrous_data_sheet.shtml) (Univ. of Calif) 
 [Compare Nitrous molecule to another chemical](https://erowid.org/psychoactives/chemistry/chemistry_compare.php?rm=&lm=nitrous-oxide_3d) 
 
 
 [The Gas that Makes You Laugh](http://blog.modernmechanix.com/2006/03/07/the-gas-that-makes-you-laugh/) , Popular Science, 1949
...
Content & design © 1995-2025 Erowid.org. Permission required before publicly reproducing Erowid info.`,
  "isomerdesign": `# Nitrous
*Source: https://isomerdesign.com/PiHKAL/explore.php?id=3846*

## Chemical Data

**Names:** Nitrous oxide, Nitrous
...
- [923](https://www.chemspider.com/Chemical-Structure.923.html/)
- [948](https://pubchem.ncbi.nlm.nih.gov/compound/948)
- [Q905750](https://www.wikidata.org/wiki/Q905750)
- [Nitrous oxide](https://en.wikipedia.org/wiki/Nitrous_oxide)
`,
  "protestkit": `{
  "url": "https://psychonautwiki.org/wiki/Nitrous",
  "experiencesUrl": "https://www.reddit.com/search/?q=N2O",
  "name": "N2O",
  "aliases": [
    "hippy crack",
    "laughing gas",
  ...
  "aliasesStr": "hippy crack,laughing gas,laughing_gas,n20,nangs,nitro,nitrous,nitrous oxide,nos",
  ...
  "roas": [
    {
      ...
      "duration": [
        ...
        {
          "name": "Light",
          "value": "4 - 8 g (1/2 - 1 cartridges)"
        },
        {
          "name": "Common",
          "value": "8 - 16 g (1 - 2 cartridges)"
        },
        {
          "name": "Strong",
          "value": "16 - 40 g (2 - 5 cartridges)"
        },
        {
          "name": "Heavy",
          "value": "40 g + (>5 cartridges)"
        }
      ]
    }
  ],
  ...
  "psychonautwiki": `# Nitrous
*Source: https://psychonautwiki.org/wiki/Nitrous*
...
Frequent and/or chronic use can cause vitamin B 12 depletion, such as other rapidly vitamin B 12 depleting substance, may lead to severe nerve damage. We recommend that you **always supplement with vitamin B12** if you use this substance, regardless dose and frequency to be on the safe side. Especially those with "decreased vitamin B12 absorption, such as in those with small bowel resection, irritable bowel disease, and/or pernicious anemia, and those with reduced intake, such as in **vegans and vegetarians** ". Additionally, improper use puts the user at risk of oxygen deprivation. It is highly advised to use [harm reduction practices](https://psychonautwiki.org/wiki/Harm_reduction_practices) if using this substance.
**Nitrous oxide** (also known as **laughing gas** , **nitrous** , **NOS** , and informally as **hippy-crack** ). [Whipped cream chargers](https://en.wikipedia.org/wiki/Whipped-cream_charger) /cartridges are called whippits (also spelled “whippits”), nangs, or bulbs.

Nitrous oxide is an atypical [dissociative](https://psychonautwiki.org/wiki/Dissociative) substance that is found in the form of an inhalable gas. The exact mechanism of action of nitrous oxide is unknown, but it is thought to have an effect on [GABA](https://psychonautwiki.org/wiki/GABA) and [NMDA](https://psychonautwiki.org/wiki/NMDA_receptor_antagonist) [receptors](https://psychonautwiki.org/wiki/Receptors) in the brain.

Nitrous oxide was first identified in 1772 by the British chemist Joseph Priestly. In the 19th century, it was discovered to have anesthetic properties which made it suitable for dental and surgical procedures. It was given the name "laughing gas" by the British chemist Humphry Davy due to its exhilarating and laughter-inducing effects. Today, it is widely used in surgery and dentistry for its [anaesthetic](https://psychonautwiki.org/wiki/Tactile_suppression) and [analgesic](https://psychonautwiki.org/wiki/Analgesic) effects, and in motorsports for its performance boosting effect on internal combustion engines. Additionally, it has a number of industrial uses and is commonly sold as a whipped cream propellant in kitchen and household stores.

[Subjective effects](https://psychonautwiki.org/wiki/Subjective_effects) include [sedation](https://psychonautwiki.org/wiki/Sedation) , [pain relief](https://psychonautwiki.org/wiki/Pain_relief) , [motor control loss](https://psychonautwiki.org/wiki/Motor_control_loss) , [anxiety suppression](https://psychonautwiki.org/wiki/Anxiety_suppression) , [conceptual thinking](https://psychonautwiki.org/wiki/Conceptual_thinking) , [euphoria](https://psychonautwiki.org/wiki/Euphoria) , and [dissociation](https://psychonautwiki.org/wiki/Dissociation) .
...
Nitrous is used as an oxidiser in rocketry and in motor racing to increase the power output of engines. At elevated temperatures, nitrous oxide is a powerful oxidizer similar to molecular oxygen. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]

At room temperature, nitrous is a colorless and non-flammable gas with a slightly sweet odor and distinctive sweet taste.

## Pharmacology

Although N2O affects quite a few receptors, its [anesthetic](https://psychonautwiki.org/wiki/Pain_relief) , [hallucinogenic](https://psychonautwiki.org/wiki/Hallucinogen) , and [euphoriant](https://psychonautwiki.org/wiki/Physical_euphoria) effects are likely caused predominantly or fully via its effects as an [NMDA receptor antagonist](https://psychonautwiki.org/wiki/NMDA_receptor_antagonist) . NMDA receptors allow for electrical signals to pass between neurons in the brain and spinal column; for the signals to pass, the receptor must be open. Dissociatives close the NMDA receptors by blocking them. This disconnection of neurons leads to loss of feeling, difficulty moving, and eventually the famous “ [hole](https://psychonautwiki.org/wiki/Visual_disconnection#Holes.2C_spaces_and_voids) ”.
...
- - **[Neurotoxicity](https://psychonautwiki.org/wiki/Neurotoxicity)** - Long-term or recurrent use of nitrous oxide can result in serious neurological harm.
- **[Spontaneous physical sensations](https://psychonautwiki.org/wiki/Spontaneous_physical_sensations)** - The nitrous oxide "body high" starts off as the sensation of a diverse mixture of cold, warm, sharp, and soft tingles which begin across the head and face at lower dosages but spread out across the body at higher dosages.
- **[Changes in felt bodily form](https://psychonautwiki.org/wiki/Changes_in_felt_bodily_form)** - This usually occurs with higher dosages and can be described as feelings that in a non-painful fashion your body's physical form is being stretched into infinity, compressed into a singularity, or split into two separate halves.
- **[Dizziness](https://psychonautwiki.org/wiki/Dizziness)** - Although uncommon, some people report dizziness under the influence of nitrous.
- **[Headaches](https://psychonautwiki.org/wiki/Headaches)** - Although uncommon, a certain subset of people report headaches during the offset of nitrous oxide.
- **[Motor control loss](https://psychonautwiki.org/wiki/Motor_control_loss)** - A loss of gross and fine motor control alongside balance and coordination is prevalent within nitrous oxide and becomes especially active at higher dosages. This means that one should be sitting down before the onset unless they are experienced in case of falling over and injuring oneself.
- **[Perception of bodily lightness](https://psychonautwiki.org/wiki/Perception_of_bodily_lightness)** - This creates the sensation that the body is floating and has become entirely weightless. It is often accompanied by feelings of slowly falling or drifting.
- **[Physical euphoria](https://psychonautwiki.org/wiki/Physical_euphoria)** - This effect can range between mild pleasure to powerfully all-encompassing bliss. Anecdotal reports show that this sensation, which is taken advantage of by recreational users during sexual activities, can greatly enhance orgasm.
- **[Tactile suppression](https://psychonautwiki.org/wiki/Tactile_suppression)** - This effect partially to entirely suppresses one's sense of touch, creating feelings of numbness within the extremities. It is responsible for the anesthetic properties of this substance.
- **[Vitamin deficiency](/w/index.php?title=Vitamin_deficiency&action=edit&redlink=1)** - Repeated doses may induce vitamin B12 deficiency. However, this can be prevented with B12 supplements.
- **[Trouble Urinating](/w/index.php?title=Trouble_Urinating&action=edit&redlink=1)** ### Visual effects
 
- In comparison to other [dissociatives](https://psychonautwiki.org/wiki/Dissociatives) such as [ketamine](https://psychonautwiki.org/wiki/Ketamine) or [DXM](https://psychonautwiki.org/wiki/DXM) , the visual effects of nitrous oxide are comparatively simplistic. They progressively intensify proportional to dosage and can be broken down into five individual components which are listed and described below. 
#### Suppression
 
- **[Acuity suppression](https://psychonautwiki.org/wiki/Visual_acuity_suppression)** - Blurred vision to the point of all-encompassing blindness is a completely consistent effect within nitrous oxide even at moderate dosages.
- **[Frame rate suppression](https://psychonautwiki.org/wiki/Frame_rate_suppression)** - This effect can cause ones visual framerate to lag to such an extent that it can cause one's vision to "pause"
- **[Double vision](https://psychonautwiki.org/wiki/Double_vision)** - This component is also prevalent at moderate dosages and makes reading incapable unless one closes an eye.
- **[Pattern recognition suppression](https://psychonautwiki.org/wiki/Pattern_recognition_suppression)** - This effect occurs at higher dosages and makes one unable to recognize and interpret perceivable visual data.
 
#### Geometry
 
- **[Geometry](https://psychonautwiki.org/wiki/Geometry)** - Nitrous oxide geometry can be described as unique in its behaviour. It usually only occurs at higher dosages and as a static wall of geometry which appears in front of one's vision alongside the physical sensation of becoming and merging with it. It usually manifests as consistently incidental in its form but varies in its arrangement between people. In terms of its stylistic appearance it can be described as simplistic in complexity, organic in style, unstructured in arrangement, colourful in scheme, glossy in shading, soft and blurred in its edges, large in size, still in movement, rounded corners, immersive in depth, and often based on complex interlocking circles.
 
#### Hallucinatory states
 
- **[External hallucinations](https://psychonautwiki.org/wiki/External_hallucinations) and [Internal hallucinations](https://psychonautwiki.org/wiki/Internal_hallucinations)** - In comparison to other more classical [dissociatives](https://psychonautwiki.org/wiki/Dissociative) , hallucinations are particularly rare with nitrous but possible at high dosages. They exclusively occur at high levels, are capable of manifesting as both external and internal in style, and are usually delirious in believability (but commonly only include mundane scenarios such as perceiving and talking to people who are not currently present). ### Cognitive effects
 
- - **[Amnesia](https://psychonautwiki.org/wiki/Amnesia)** - At high dosages, it is often common for one to experience amnesia and memory loss after the experience has occurred. This is especially prevalent alongside ego death.
...
- **[Déjà vu](https://psychonautwiki.org/wiki/D%C3%A9j%C3%A0_vu)** - Although uncommon and inconsistent, a certain subset of people report strong feelings of deja-vu consistently when under the influence of nitrous oxide.
- **[Cognitive euphoria](https://psychonautwiki.org/wiki/Cognitive_euphoria)** - This can be described as feelings of mild to intense happiness and general positivity.
...
- **[Laughter fits](https://psychonautwiki.org/wiki/Laughter_fits)** - This effect is markedly pronounced with nitrous oxide and can be described as sudden bouts of intense laughter and giggling.
- **[Memory suppression](https://psychonautwiki.org/wiki/Memory_suppression)** - At higher dosages, level 3 [ego death](https://psychonautwiki.org/wiki/Ego_death) is an all-encompassing effect within nitrous oxide. In comparison to other hallucinogens, it is unique in style due to its rapid onset and quick comedown. This creates the experience that one's sense of self is rapidly disintegrated and then suddenly re-stacked through a process of regaining one's long-term memory. This is a remarkably identical process every time the experience is undergone.
...
- **[Vivid dreams](/w/index.php?title=Vivid_dreams&action=edit&redlink=1)** ### Auditory effects
 
- The auditory effects found with nitrous oxide, although simplistic, are widely known to be particularly intense and consistent in their manifestation when compared to other [hallucinogens](https://psychonautwiki.org/wiki/Hallucinogens) . These effects include: 
- **[Distortions](https://psychonautwiki.org/wiki/Auditory_distortion)** - These distortions are very powerful and loud enough in their volume to make the original sound completely unrecognizable. They include phasers, white noise, high pitch tones and notes, flanging, changes in pitch, echo effects, and stuttering. In particular, the frequency of the stuttering is proportionally related to the intensity of the effects, especially ego death which occurs when the stuttering becomes continuous.
- **[Suppression](https://psychonautwiki.org/wiki/Auditory_suppression)** - This effect can be described as a muffling and quieting of externally sourced sound which results in it sounding more indistinct and distant than it would usually be. ### Multi-sensory effects
 
- - **[Synaesthesia](https://psychonautwiki.org/wiki/Synaesthesia)** - This effect is reported to occur most commonly with auditory stimuli, like music translating into visual stimuli within closed eye visuals. ### Transpersonal effects
 
- - **[Unity and interconnectedness](https://psychonautwiki.org/wiki/Unity_and_interconnectedness)** - During high dosage states of ego death, this component is a common but inconsistent accompanying effect. It occurs at level 4 - 5 and creates experiences of becoming one with the greater whole. In comparison to other [hallucinogens](https://psychonautwiki.org/wiki/Hallucinogens) which induce this effect, it can be described as comparatively simpler and less profound due to its more basic accompanying cognitive effects.
- **[Perception of interdependent opposites](https://psychonautwiki.org/wiki/Perception_of_interdependent_opposites)** - During moderate to high doses, the effect may be described as having insight into the nature of two conflicting ideas, "battling" each other to maintain natural balance.
### Combinational effects

Nitrous is commonly combined with other [hallucinogens](https://psychonautwiki.org/wiki/Hallucinogens) for it which it acts as a brief but profound potentiator of their effects.

- **[Psychedelics](https://psychonautwiki.org/wiki/Psychedelics)** - When taken in combination with a psychedelic such as [LSD](https://psychonautwiki.org/wiki/LSD) or [psilocybin mushrooms](https://psychonautwiki.org/wiki/Psilocybin_mushrooms) , the effect will be a sudden and dramatic increase in perceived geometry to its maximum level of [8A](https://psychonautwiki.org/wiki/8A_Geometry) or [8B](https://psychonautwiki.org/wiki/8B_Geometry_-_Perceived_exposure_to_inner_mechanics_of_consciousness) . This is alongside a sudden and dramatic ego death.
- **[Dissociatives](https://psychonautwiki.org/wiki/Dissociatives)** - When taken in combination with a dissociative such as [MXE](https://psychonautwiki.org/wiki/MXE) or [DXM](https://psychonautwiki.org/wiki/DXM) , the effect will be a sudden and dramatic increase in [disconnective effects](https://psychonautwiki.org/wiki/Disconnective_effects) and the triggering of a sudden internal hallucinatory scenario.
- **[Cannabis](https://psychonautwiki.org/wiki/Cannabis)** - When taken in combination with cannabis, the overall effects of the nitrous itself are potentiated more so than the cannabis' effects.
- **[Alcohol](https://psychonautwiki.org/wiki/Alcohol)** - When taken in combination with alcohol, adverse side effects such as confusion, dizziness, and headaches are often significantly increased.
...
- [Experience:200 mg of MXP + N2O:20 chargers](https://psychonautwiki.org/wiki/Experience:200_mg_of_MXP_%2B_N2O:20_chargers)
- [Experience:2mg Etizolam & N2O - "Hippy Crack" Indeed](https://psychonautwiki.org/wiki/Experience:2mg_Etizolam_%26_N2O_-_%22Hippy_Crack%22_Indeed)
...
- [Experience:Nitrous oxide (approx. 50 puffs) - ~50 puffs nitrous oxide](https://psychonautwiki.org/wiki/Experience:Nitrous_oxide_(approx._50_puffs)_-_~50_puffs_nitrous_oxide)
...
### Nonmedical nitrous oxide

- **Tubes** - These are now commonly sold by web shops that are specializing in nitrous oxide.
- **Canned whipped cream** - These are found in any grocery store. They contain very minimal gas with one or two uses before the cream comes out.
- **[Whipped-cream charger](https://en.wikipedia.org/wiki/Whipped-cream_charger)** - These are readily available and cheap to purchase online. They are small metal canisters that can be used by a nitrous cracker to fill a balloon full of gas which is then inhaled. Some varieties contain industrial residue and strength vary (as it is food grade).
...
- [Hypoxia](https://en.wikipedia.org/wiki/Hypoxia) (abnormally low level of oxygen in the tissues), particularly the entity ' [diffusion hypoxia](https://en.wikipedia.org/wiki/Diffusion_hypoxia) '. 
...
### Risks with drug paraphernalia

#### Risk with whipping dispensers
Direct inhalation
...
- In June 2017, Rebecca Burger, 33, a fitness blogger and model, [died](https://en.wikipedia.org/wiki/List_of_unusual_deaths) after a whipped-cream charger exploded and struck her in the chest.
- In August 2017, another woman got wounded from a whipping dispenser.

#### Risks with nitrous charger crackers
...
- Balloon(s) are inflated with nitrous oxide.
- Sealing clips make it easy to fill multiple balloons without tying or holding them.

A regular balloon can typically hold a single 8 gram whipped-cream charger. However, jumbo balloons can hold about 3 cartridges.

### Gas filter

Cloth is used to filter the gas from whipped-cream chargers that contains often contains small amounts of impurities.

### Gas transfer equipment

A typical whipped cream cartridge contain 8 gram nitrous oxide.

#### Whipped-cream charger cracker

#### Tube valves and regulators

Simple plastic valves and gas pressure regulators, which display the gas pressure, are commonly used with nitrous oxide tanks. These devices are often sold by specialized online retailers that focus on nitrous oxide equipment.

#### Whipping dispensers

To use a half-pint or one-pint whipped cream dispenser, you will need one to two chargers, which is equivalent to 8–16 g (using standard 8 g cartridges). For a one-liter dispenser, you will need two to three chargers, which is equivalent to 16–24 g. The same quantity of gas can also be filled from a large tube with an attached gas pressure regulator connected to the whipping dispenser.

It is important not to overcharge your whipped cream dispenser.
...
- **India** : Nitrous oxide is available for general anesthesia purposes. India's gas cylinder rules (1985) permit the transfer of gas from one cylinder to another for breathing purposes. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
- **Netherlands** : Since 1 January 2023, the possession, importing, and sale of nitrous oxide is banned in the Netherlands, with exceptions for medical use, and the food industry. It is illegal under the [Opium Act](/w/index.php?title=Opium_Act_(Netherlands)&action=edit&redlink=1) .
- **New Zealand** : Nitrous oxide is a prescription medicine, and its sale or possession without a prescription is an offense under the Medicines Act. [*[citation needed](https://psychonautwiki.org/wiki/Citation_needed)*]
...
- [Inhalants](https://psychonautwiki.org/wiki/Inhalants)
- [Hallucinogen](https://psychonautwiki.org/wiki/Hallucinogen)
- [Dissociative](https://psychonautwiki.org/wiki/Dissociative)
...
## References
1. ↑ Flippo, T. S. (1 December 1993).["Neurologic Degeneration Associated With Nitrous Oxide Anesthesia in Patients With Vitamin B12 Deficiency"](http://archsurg.jamanetwork.com/article.aspx?doi=10.1001/archsurg.1993.01420240099018).*Archives of Surgery*.**128**(12): 1391.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1001/archsurg.1993.01420240099018](//doi.org/10.1001%2Farchsurg.1993.01420240099018).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0004-0010](//www.worldcat.org/issn/0004-0010).
2. ↑ Campdesuner, V; Teklie, Y; Alkayali, T; Pierce, D; George, J (9 July 2020).["Nitrous Oxide-Induced Vitamin B12 Deficiency Resulting in Myelopathy"](//www.ncbi.nlm.nih.gov/pmc/articles/PMC7366039).*Cureus*.**12**(7): e9088.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.7759/cureus.9088](//doi.org/10.7759%2Fcureus.9088).[PMC](http://en.wikipedia.org/wiki/PubMed_Central)[7366039](//www.ncbi.nlm.nih.gov/pmc/articles/PMC7366039).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[32685323](//www.ncbi.nlm.nih.gov/pubmed/32685323).
3. ↑ Tarendash, A. S. (July 2001).*Let’s Review: Chemistry, the Physical Setting*. Barrons Educational Series.[ISBN](http://en.wikipedia.org/wiki/International_Standard_Book_Number)[9780764116643](http://en.wikipedia.org/wiki/Special:BookSources/9780764116643).
4. ↑ Keys, T. E. (1 September 1941).["THE DEVELOPMENT OF ANESTHESIA"](https://pubs.asahq.org/anesthesiology/article/2/5/552/17582/THE-DEVELOPMENT-OF-ANESTHESIA).*Anesthesiology*.**2**(5): 552–574.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1097/00000542-194109000-00008](//doi.org/10.1097%2F00000542-194109000-00008).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0003-3022](//www.worldcat.org/issn/0003-3022).
5. ↑ 5.0 5.1 Erving, H. W. (May 1933). "The Discoverer of Anæsthesia: Dr. Horace Wells of Hartford".*The Yale Journal of Biology and Medicine*.**5**(5): 421–430.[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0044-0086](//www.worldcat.org/issn/0044-0086).
6. ↑ Goerig, M., Schulte am Esch, J. (1 September 2001).["History of nitrous oxide—with special reference to its early use in Germany"](https://www.sciencedirect.com/science/article/pii/S152168960190165X).*Best Practice & Research Clinical Anaesthesiology*.**15**(3): 313–338.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1053/bean.2001.0165](//doi.org/10.1053%2Fbean.2001.0165).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[1521-6896](//www.worldcat.org/issn/1521-6896).
7. ↑ Priestley, J., Johnson, J., Adams, J., John Adams Library (Boston Public Library) BRL (1775).[Experiments and observations on different kinds of air / by Joseph Priestly, LL.D.F.R.S](http://archive.org/details/experimentsobser01prie). London : Printed for J. Johnson ...
8. ↑ 8.0 8.1 8.2 Boyle, H. E. G. (27 January 1934).["NITROUS OXIDE: HISTORY AND DEVELOPMENT"](https://www.bmj.com/lookup/doi/10.1136/bmj.1.3812.153).*BMJ*.**1**(3812): 153–155.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1136/bmj.1.3812.153](//doi.org/10.1136%2Fbmj.1.3812.153).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0959-8138](//www.worldcat.org/issn/0959-8138).
9. ↑ Hardman, J. G., Hopkins, P. M., Struys, M. M. R. F., eds. (2017).*Oxford textbook of anaesthesia*. Oxford textbooks in anaesthesia. Oxford University Press.[ISBN](http://en.wikipedia.org/wiki/International_Standard_Book_Number)[9780199642045](http://en.wikipedia.org/wiki/Special:BookSources/9780199642045).
10. ↑ ["The Consumers Union on Licit and Illicit Drugs"](http://www.jstor.org/stable/3957382?origin=crossref).*Science News*.**102**(23): 357. 2 December 1972.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.2307/3957382](//doi.org/10.2307%2F3957382).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0036-8423](//www.worldcat.org/issn/0036-8423).
11. ↑ Desai, S., Desai, M., Pandav, C. (1 December 2007).["The Discovery of Modern Anaesthesia – Contributions of Davy, Clarke, Long, Wells and Morton"](https://escholarship.umassmed.edu/anesthesiology_pubs/157).*Anesthesiology and Perioperative Medicine Publications*.**51**(6).
12. ↑ 12.0 12.1 Miller, A. H. (1 July 1941).["TECHNICAL DEVELOPMENT OF GAS ANESTHESIA"](https://pubs.asahq.org/anesthesiology/article/2/4/398/17588/TECHNICAL-DEVELOPMENT-OF-GAS-ANESTHESIA).*Anesthesiology*.**2**(4): 398–409.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1097/00000542-194107000-00004](//doi.org/10.1097%2F00000542-194107000-00004).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0003-3022](//www.worldcat.org/issn/0003-3022).
13. ↑ Sneader, W. (2005).*Drug discovery: a history (Part 1: Legacy of the past, chapter 8: systematic medicine)*. Wiley.[ISBN](http://en.wikipedia.org/wiki/International_Standard_Book_Number)[9780471899792](http://en.wikipedia.org/wiki/Special:BookSources/9780471899792).
14. ↑ World Health Organization (2017),[WHO model list of essential medicines, 20th list (March 2017, amended August 2017)](https://apps.who.int/iris/handle/10665/273826), World Health Organization, retrieved 24 August 2017
15. ↑ [Nitrous Oxide](http://www.chm.bris.ac.uk/motm/n2o/n2oc.htm)
16. ↑ 16.0 16.1 Yamakura, T., Harris, R. A. (1 October 2000).["Effects of Gaseous Anesthetics Nitrous Oxide and Xenon on Ligand-gated Ion Channels"](https://pubs.asahq.org/anesthesiology/article/93/4/1095/38687/Effects-of-Gaseous-Anesthetics-Nitrous-Oxide-and).*Anesthesiology*.**93**(4): 1095–1101.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1097/00000542-200010000-00034](//doi.org/10.1097%2F00000542-200010000-00034).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0003-3022](//www.worldcat.org/issn/0003-3022).
17. ↑ Emmanouil, D. E., Quock, R. M. (2007). "Advances in understanding the actions of nitrous oxide".*Anesthesia Progress*.**54**(1): 9–18.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.2344/0003-3006(2007)54[9:AIUTAO]2.0.CO;2](//doi.org/10.2344%2F0003-3006%282007%2954%5B9%3AAIUTAO%5D2.0.CO%3B2).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0003-3006](//www.worldcat.org/issn/0003-3006).
18. ↑ Mennerick, S., Jevtovic-Todorovic, V., Todorovic, S. M., Shen, W., Olney, J. W., Zorumski, C. F. (1 December 1998). "Effect of nitrous oxide on excitatory and inhibitory synaptic transmission in hippocampal cultures".*The Journal of Neuroscience: The Official Journal of the Society for Neuroscience*.**18**(23): 9716–9726.[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0270-6474](//www.worldcat.org/issn/0270-6474).
19. ↑ Gruss, M., Bushell, T. J., Bright, D. P., Lieb, W. R., Mathie, A., Franks, N. P. (February 2004). "Two-pore-domain K+ channels are a novel target for the anesthetic gases xenon, nitrous oxide, and cyclopropane".*Molecular Pharmacology*.**65**(2): 443–452.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1124/mol.65.2.443](//doi.org/10.1124%2Fmol.65.2.443).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0026-895X](//www.worldcat.org/issn/0026-895X).
20. ↑ Evans EB, Evans MR (November 2021). "Nangs, balloons and crackers: Recreational nitrous oxide neurotoxicity".*Aust J Gen Pract*(Review).**50**(11): 834–838.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.31128/AJGP-10-20-5668](//doi.org/10.31128%2FAJGP-10-20-5668).[PMID](http://en.wikipedia.org/wiki/PubMed_Identifier)[34713284](//www.ncbi.nlm.nih.gov/pubmed/34713284). Unknown parameter |s2cid= ignored ( [help](/w/index.php?title=Help:CS1_errors&action=edit&redlink=1) )
21. ↑ Weimann, J. (March 2003).["Toxicity of nitrous oxide"](https://linkinghub.elsevier.com/retrieve/pii/S1521689602902648).*Best Practice & Research Clinical Anaesthesiology*.**17**(1): 47–61.[doi](http://en.wikipedia.org/wiki/Digital_object_identifier):[10.1053/bean.2002.0264](//doi.org/10.1053%2Fbean.2002.0264).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[1521-6896](//www.worldcat.org/issn/1521-6896).
22. ↑ Ok-Ad5515 (2021),[Warning about Nitrous Oxide](https://www.reddit.com/r/Drugs/comments/lkcykd/warning_about_nitrous_oxide/)
23. ↑ [https://pubmed.ncbi.nlm.nih.gov/3537624/](https://pubmed.ncbi.nlm.nih.gov/3537624/)
24. ↑ [http://www.erowid.org/chemicals/nitrous/nitrous_health.shtml](http://www.erowid.org/chemicals/nitrous/nitrous_health.shtml)
25. ↑ [https://www.dancewizensw.org.au/filtering-nangs](https://www.dancewizensw.org.au/filtering-nangs)
26. ↑ [http://www.erowid.org/chemicals/nitrous/nitrous_article2.shtml](http://www.erowid.org/chemicals/nitrous/nitrous_article2.shtml)
27. ↑ [https://www.independent.co.uk/news/world/woman-whipped-cream-canister-explosion-emilie-lada-skull-crack-award-ps990000-french-court-model-death-a7880461.html](https://www.independent.co.uk/news/world/woman-whipped-cream-canister-explosion-emilie-lada-skull-crack-award-ps990000-french-court-model-death-a7880461.html)
28. ↑ BtMG | [http://www.gesetze-im-internet.de/btmg_1981/BtMG.pdf](http://www.gesetze-im-internet.de/btmg_1981/BtMG.pdf)
29. ↑ NpSG | [https://www.gesetze-im-internet.de/npsg/NpSG.pdf](https://www.gesetze-im-internet.de/npsg/NpSG.pdf)
30. ↑ [§ 2 AMG - Einzelnorm](https://www.gesetze-im-internet.de/amg_1976/__2.html)
31. ↑ Anlage 1 AMVV | [https://www.bfarm.de/SharedDocs/Downloads/DE/Arzneimittel/Pharmakovigilanz/Gremien/Verschreibungspflicht/liste_stoffe_zubereitungen.pdf;jsessionid=B4E9C9724EA80BC179A1B9384A42240D.2_cid354?__blob=publicationFile&v=25](https://www.bfarm.de/SharedDocs/Downloads/DE/Arzneimittel/Pharmakovigilanz/Gremien/Verschreibungspflicht/liste_stoffe_zubereitungen.pdf;jsessionid=B4E9C9724EA80BC179A1B9384A42240D.2_cid354?__blob=publicationFile&v=25)
32. ↑ Rankin, Jennifer (2022-11-15).["Dutch to ban laughing gas over fears for health and road safety"](https://www.theguardian.com/society/2022/nov/15/dutch-to-ban-laughing-gas-over-fears-for-health-and-road-safety).*The Guardian*(in English).[ISSN](http://en.wikipedia.org/wiki/International_Standard_Serial_Number)[0261-3077](//www.worldcat.org/issn/0261-3077). Retrieved 2023-10-20.
33. ↑ ["Opium act (drugs)"](https://www.belastingdienst.nl/wps/wcm/connect/bldcontenten/belastingdienst/customs/safety_health_economy_and_environment/safety/opium_act_drugs/opium_act_drugs#:~:text=You%20are%20not%20allowed%20to,these%20licences%20for%20the%20Netherlands.).*www.belastingdienst.nl*(in English). Retrieved 2023-10-20.
34. ↑ Nyheter, S. V. T. (4 June 2025).["Ny lag: 18-årsgräns för köp av lustgas"](https://www.svt.se/nyheter/inrikes/forsaljning-av-lustgas-till-minderariga-forbjuds).*SVT Nyheter*(in Swedish).
35. ↑ [https://www.legislation.gov.uk/uksi/2023/1091/made](https://www.legislation.gov.uk/uksi/2023/1091/made)
36. ↑ "US Nitrous Oxide Laws (alphabetically) Based on a search of online free legal databases. Conducted May 2002" - [http://www.cognitiveliberty.org/dll/N20_state_laws.htm](http://www.cognitiveliberty.org/dll/N20_state_laws.htm)
37. ↑ [California Code, Penal Code - PEN § 381b](https://codes.findlaw.com/ca/penal-code/pen-sect-381b.html)NewPP limit report Cached time: 20251218075654 Cache expiry: 1209600 Dynamic content: false Complications: [] [SMW] In‐text annotation parser time: 0.046 seconds CPU time usage: 0.475 seconds Real time usage: 0.977 seconds Preprocessor visited node count: 2417/1000000 Post‐expand include size: 182099/2097152 bytes Template argument size: 30178/2097152 bytes Highest expansion depth: 12/40 Expensive parser function count: 0/100 Unstrip recursion depth: 0/20 Unstrip post‐expand size: 42240/5000000 bytes Lua time usage: 0.390/7 seconds Lua virtual size: 8.74 MB/50 MB Lua estimated memory usage: 0 bytes ExtLoops count: 11Transclusion expansion time report (%,ms,calls,template) 100.00% 802.320 1 -total 38.92% 312.281 15 Template:Cite_journal 13.43% 107.733 3 Template:Citation_needed 7.67% 61.512 4 Template:Cite_book 7.66% 61.448 1 Template:Fix 7.31% 58.628 5 Template:Citation 7.13% 57.229 1 Template:SubstanceBox/Nitrous 7.10% 56.968 2 Template:Category_handler 6.59% 52.912 1 Template:SubstanceBox 4.42% 35.452 1 Template:Effects/base`,
  "saferparty": `# Nitrous
...
## Dosage
Mild nausea, headache; in case of excessive and improper consumption, unconsciousness, drop in blood pressure, cardiac arrhythmia, in the worst case death by respiratory paralysis. Danger of suffocation if oxygen supply is insufficient, increased risk of injury from falling when "stepping away".

## Risks

### Long-term Risks
Continuous use of nitrous oxide stresses the nervous system and leads to vitamin B12 deficiency (risk of disturbed cell function and temporary infertility). Dependence with psychological symptoms is possible.
...
`,
  "thedrugclassroom": `# Nitrous oxide
*Source: https://thedrugclassroom.com/video/nitrous-oxide/*
...
[Erowid](https://erowid.org/experiences/subs/exp_Nitrous_Oxide.shtml)
...
From what I can tell, the work from Fievee that was referenced can be found [here](http://gallica.bnf.fr/ark:/12148/bpt6k1113180/f3.image) .
...
More statements from James are available on [Erowid](https://erowid.org/chemicals/nitrous/nitrous_article1.shtml) .
...
**(2016)** [Up: The rise of nitrous oxide abuse. An international survey of contemporary nitrous oxide use.](https://www.ncbi.nlm.nih.gov/pubmed/26912510)

**(2016)** [Nitrous oxide-induced slow and delta oscillations.](https://www.ncbi.nlm.nih.gov/pubmed/26118489)

**(2016)** [Nitrous oxide in modern anaesthetic practice](https://academic.oup.com/bjaed/article/16/3/87/2897753/Nitrous-oxide-in-modern-anaesthetic-practice)

**(2016)** [Potential Pathways Involved in the Rapid Antidepressant Effects of Nitrous Oxide](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5116381/)

**(2016)** [The increasing recreational use of nitrous oxide: history revisited](https://academic.oup.com/bja/article/116/3/321/2566058/The-increasing-recreational-use-of-nitrous-oxide)

**(2016)** [The Subjective Response to Nitrous Oxide is a Potential Pharmaco-Endophenotype for Alcohol Use Disorder: A Preliminary Study with Heavy Drinkers.](https://www.ncbi.nlm.nih.gov/pubmed/27401180)

**(2016)** [Nitrous Oxide, From the Operating Room to the Emergency Department](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4819505/)

**(2016)** [Neurologic, psychiatric, and other medical manifestations of nitrous oxide abuse: A systematic review of the case literature.](https://www.ncbi.nlm.nih.gov/pubmed/27037733)

**(2015)** [Subacute combined degeneration of the spinal cord in a patient abusing nitrous oxide and self-medicating with cyanocobalamin.](https://www.ncbi.nlm.nih.gov/pubmed/25987690)

**(2015)** [Treatment-Resistant Major Depression: Rationale for NMDA Receptors as Targets and Nitrous Oxide as Therapy.](https://www.ncbi.nlm.nih.gov/pubmed/26696909)

**(2015)** [Recreational nitrous oxide use: Prevalence and risks.](https://www.ncbi.nlm.nih.gov/pubmed/26496821)

**(2015)** [N-Methyl-d-Aspartate Receptor Channel Blocker–Like Discriminative Stimulus Effects of Nitrous Oxide Gas](http://jpet.aspetjournals.org/content/352/1/156)

**(2015)** [Nitrous Oxide for Treatment-Resistant Major Depression: A Proof-of-Concept Trial.](https://www.ncbi.nlm.nih.gov/pubmed/25577164)

**(2015)** [Nitrous Oxide for the Treatment of Chronic Low Back Pain.](https://www.ncbi.nlm.nih.gov/pubmed/26484463)

**(2015)** [Death from Nitrous Oxide.](https://www.ncbi.nlm.nih.gov/pubmed/26258592)

**(2015)** [Nitrous Oxide Abuse and Vitamin B12 Action in a 20-Year-Old Woman: A Case Report.](https://www.ncbi.nlm.nih.gov/pubmed/26489675)

**(2015)** [Combination of Nitrous Oxide with Isoflurane or Scopolamine for Treatment-resistant Major Depression](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4423157/)

**(2015)** [Nitrous Oxide and Serious Long-term Morbidity and Mortality in the Evaluation of Nitrous Oxide in the Gas Mixture for Anaesthesia (ENIGMA)-II Trial](http://anesthesiology.pubs.asahq.org/article.aspx?articleid=2466534)

**(2015)** [A Case Report on the Anxiolytic Properties of Nitrous Oxide during Labor](http://onlinelibrary.wiley.com/doi/10.1111/1552-6909.12522/pdf)

**(2014)** [κ-Opioid receptor mediates the antinociceptive effect of nitrous oxide in mice.](https://www.ncbi.nlm.nih.gov/pubmed/25086587)

**(2014)** [Nitrous oxide induced myeloneuropathy: a case report.](https://www.ncbi.nlm.nih.gov/pubmed/23996222)

**(2014)** [Nitrous oxide for the management of labor pain: a systematic review.](https://www.ncbi.nlm.nih.gov/pubmed/24356165)

**(2014)** [The effect of nitrous oxide anesthesia on early postoperative opioid consumption and pain.](https://www.ncbi.nlm.nih.gov/pubmed/24310050)

**(2014)** [Nitrous oxide myelopathy in a pediatric patient.](https://www.ncbi.nlm.nih.gov/pubmed/24694883)

**(2014)** [The effects of xenon and nitrous oxide gases on alcohol relapse.](https://www.ncbi.nlm.nih.gov/pubmed/24118055)

**(2014)** [Nitrous Oxide (N2O)-Induced Acute Psychosis.](https://www.ncbi.nlm.nih.gov/pubmed/25373825)

**(2014)** [Does anaesthesia with nitrous oxide affect mortality or cardiovascular morbidity? A systematic review with meta-analysis and trial sequential analysis.](https://www.ncbi.nlm.nih.gov/pubmed/24408738)

**(2014)** [Do we need to know whether nitrous oxide harms patients?](http://www.thelancet.com/journals/lancet/article/PIIS0140-6736(14)61061-8/fulltext?rss%3Dyes)

**(2014)** [The Neurotoxicity of Nitrous Oxide: The Facts and “Putative” Mechanisms](http://www.mdpi.com/2076-3425/4/1/73)

**(2014)** [Psychosis and low cyanocobalamin in a patient abusing nitrous oxide and cannabis.](https://www.ncbi.nlm.nih.gov/pubmed/24367897)

**(2014)** [The safety of addition of nitrous oxide to general anaesthesia in at-risk patients having major non-cardiac surgery (ENIGMA-II): a randomised, single-blind trial](http://thelancet.com/journals/lancet/article/PIIS0140-6736(14)60893-X/abstract)

**(2013)** [Recreational nitrous oxide abuse-induced vitamin B12 deficiency in a patient presenting with hyperpigmentation of the skin.](https://www.ncbi.nlm.nih.gov/pubmed/23898268)

**(2013)** [Horace Wells’ “Humbug Affair” occurred at Massachusetts General Hospital? Humbug!](https://www.ncbi.nlm.nih.gov/pubmed/23962966)

**(2013)** [Horace Wells’ Demonstration of Nitrous Oxide in Boston](http://anesthesiology.pubs.asahq.org/article.aspx?articleid=1918086)

**(2013)** [Modulation of Functional EEG Networks by the NMDA Antagonist Nitrous Oxide](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0056434)

**(2013)** [Nitrous oxide: are we still in equipoise? A qualitative review of current controversies.](https://www.ncbi.nlm.nih.gov/pubmed/23801743)

**(2011)** [Severe myeloneuropathy from acute high-dose nitrous oxide (N2O) abuse.](https://www.ncbi.nlm.nih.gov/pubmed/20605391)

**(2011)** [Safety and risks of nitrous oxide labor analgesia: a review.](https://www.ncbi.nlm.nih.gov/pubmed/22060215)

**(2011)** [Subacute Combined Degeneration Caused by Nitrous Oxide Intoxication: Case Reports](http://www.ant-tnsjournal.com/Mag_Files/20-2/8.c_2_9928.pdf)

**(2010)** [Systematic review: the use of nitrous oxide gas for lower gastrointestinal endoscopy.](https://www.ncbi.nlm.nih.gov/pubmed/20491748)

**(2010)** [Association between nitrous oxide and the incidence of postoperative nausea and vomiting in adults: a systematic review and meta-analysis.](https://www.ncbi.nlm.nih.gov/pubmed/20151955)

**(2010)** [Peripheral neuropathy following nitrous oxide abuse.](https://www.ncbi.nlm.nih.gov/pubmed/20152009)

**(2008)** [Nitrous oxide-antinociception is mediated by opioid receptors and nitric oxide in the periaqueductal gray region of the midbrain.](https://www.ncbi.nlm.nih.gov/pubmed/17683915)

**(2008)** [Inhalational conscious sedation with nitrous oxide enhances the cardiac parasympathetic component of heart rate variability.](https://www.ncbi.nlm.nih.gov/pubmed/19000603)

**(2008)** [Effect of nitrous oxide on neurologic and neuropsychological function after intracranial aneurysm surgery.](https://www.ncbi.nlm.nih.gov/pubmed/18362587)

**(2007)** [Psychotropic analgesic nitrous oxide for alcoholic withdrawal states.](https://www.ncbi.nlm.nih.gov/pubmed/17443576)

**(2007)** [Nitrous oxide (N2O) pre- and postsynaptically attenuates NMDA receptor-mediated neurotransmission in the amygdala.](https://www.ncbi.nlm.nih.gov/pubmed/17123554)

**(2006)** [Nitrous oxide “whippit” abuse presenting with cobalamin responsive psychosis.](https://www.ncbi.nlm.nih.gov/pubmed/18072118)

**(2005)** [Potentially neuroprotective and therapeutic properties of nitrous oxide and xenon.](https://www.ncbi.nlm.nih.gov/pubmed/16179534)

**(2005)** [Comparison of remifentanil and nitrous oxide in labour analgesia.](https://www.ncbi.nlm.nih.gov/pubmed/15777291)

**(2004)** [Two-pore-domain K+ channels are a novel target for the anesthetic gases xenon, nitrous oxide, and cyclopropane.](https://www.ncbi.nlm.nih.gov/pubmed/14742687)

**(2004)** [Toxicity after intermittent inhalation of nitrous oxide for analgesia](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC420294/)

**(2004)** [Nitrous oxide “whippit” abuse presenting as clinical B12 deficiency and ataxia.](https://www.ncbi.nlm.nih.gov/pubmed/15011232)

**(2004)** [A review of the risks and benefits of nitrous oxide in current anaesthetic practice.](https://www.ncbi.nlm.nih.gov/pubmed/15957712)

**(2004)** [Enlarged double-blind randomised trial of benzodiazepines against psychotropic analgesic nitrous oxide for alcohol withdrawal.](https://www.ncbi.nlm.nih.gov/pubmed/15236821)

**(2003)** [Toxicity of nitrous oxide.](https://www.ncbi.nlm.nih.gov/pubmed/12751548)

**(2003)** [Nitrous oxide has no effect in the treatment of alcohol withdrawal syndrome: a double-blind placebo-controlled randomized trial.](https://www.ncbi.nlm.nih.gov/pubmed/12640227)

**(2003)** [Nitrous oxide-oxygen: a new look at a very old technique.](https://www.ncbi.nlm.nih.gov/pubmed/12839232)

**(2003)** [Prolonged exposure to inhalational anesthetic nitrous oxide kills neurons in adult rat brain.](https://www.ncbi.nlm.nih.gov/pubmed/14622904)

**(2003)** [Reduction of Ischemic Brain Damage by Nitrous Oxide and Xenon](http://journals.sagepub.com/doi/abs/10.1097/01.WCB.0000087342.31689.18)

**(2002)** [Nitrous oxide for relief of labor pain: a systematic review.](https://www.ncbi.nlm.nih.gov/pubmed/12011877)

**(2002)** [Neurobiology of nitrous oxide-induced antinociceptive effects.](https://www.ncbi.nlm.nih.gov/pubmed/11936558)

**(2001)** [Nitrous oxide and vitamin B12](http://adc.bmj.com/content/85/6/510.7)

**(2001)** [A comparative evaluation of the neurotoxic properties of ketamine and nitrous oxide.](https://www.ncbi.nlm.nih.gov/pubmed/11259788)

**(2001)** [Efficacy and safety of nitrous oxide in alleviating pain and anxiety during painful procedures](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1718795/)

**(2000)** [Recent advances in understanding the actions and toxicity of nitrous oxide.](https://www.ncbi.nlm.nih.gov/pubmed/10781114)

**(2000)** [Acute neurologic decompensation in an infant with cobalamin deficiency exposed to nitrous oxide.](https://www.ncbi.nlm.nih.gov/pubmed/10969273)

**(1998)** [Nitrous oxide (laughing gas) is an NMDA antagonist, neuroprotectant and neurotoxin.](https://www.ncbi.nlm.nih.gov/pubmed/9546794)

**(1998)** [Myelopathy caused by nitrous oxide toxicity.](https://www.ncbi.nlm.nih.gov/pubmed/9613506)

**(1996)** [Severe combined degeneration of the spinal cord after nitrous oxide anaesthesia in a vegetarian.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1073874/)

**(1996)** [Frostbite of the face after recreational misuse of nitrous oxide.](https://www.ncbi.nlm.nih.gov/pubmed/8634126)

**(1995)** [Nitrous oxide and spontaneous abortion in female dental assistants.](https://www.ncbi.nlm.nih.gov/pubmed/7900720)

**(1995)** [Accidental death by nitrous oxide inhalation.](https://www.ncbi.nlm.nih.gov/pubmed/7797187)

**(1993)** [Neurologic degeneration associated with nitrous oxide anesthesia in patients with vitamin B12 deficiency.](https://www.ncbi.nlm.nih.gov/pubmed/8250714)

**(1992)** [Reduced Fertility among Women Employed as Dental Assistants Exposed to High Levels of Nitrous Oxide](http://www.nejm.org/doi/full/10.1056/NEJM199210013271405#t=article)

**(1992)** [Nitrous oxide abuse in perspective.](https://www.ncbi.nlm.nih.gov/pubmed/1516075)

**(1990)** [Mediation of nitrous oxide analgesia in mice by spinal and supraspinal kappa-opioid receptors.](https://www.ncbi.nlm.nih.gov/pubmed/2157601)

**(1990)** [Clinical pharmacology of nitrous oxide: an argument for its continued use.](https://www.ncbi.nlm.nih.gov/pubmed/2240627)

**(1990)** [Analgesic nitrous oxide for alcohol withdrawal: a critical appraisal after 10 years’ use.](https://www.ncbi.nlm.nih.gov/pubmed/2217011)

**(1989)** [Suicide by nitrous oxide poisoning.](https://www.ncbi.nlm.nih.gov/pubmed/2589295)

**(1988)** [Dental anesthetic death. An unusual autoerotic episode.](https://www.ncbi.nlm.nih.gov/pubmed/3354528)

**(1987)** [Clinical aspects of the interaction between nitrous oxide and vitamin B12.](https://www.ncbi.nlm.nih.gov/pubmed/3548788)

**(1986)** [Is nitrous oxide a dangerous anesthetic for vitamin B12-deficient subjects?](https://www.ncbi.nlm.nih.gov/pubmed/3951096)

**(1986)** [Adverse effects of nitrous oxide.](https://www.ncbi.nlm.nih.gov/pubmed/3537624)

**(1985)** [Tolerance to nitrous oxide in volunteers.](https://www.ncbi.nlm.nih.gov/pubmed/4061009)

**(1984)** [Nitrous oxide and the dental patient: a review of adverse reactions](http://jada.ada.org/article/S0002-8177(84)82023-1/abstract)

**(1983)** [Subacute toxic delirium following nitrous oxide abuse.](https://www.ncbi.nlm.nih.gov/pubmed/6860185)

**(1983)** [Nitrous oxide analgesia for refractory pain in the terminally ill.](https://www.ncbi.nlm.nih.gov/pubmed/6864950)

**(1983)** [Drug abuse by anesthesia personnel.](https://www.ncbi.nlm.nih.gov/pubmed/6601467)

**(1980)** [Paradoxical effect of naloxone on nitrous oxide analgesia in man.](https://www.ncbi.nlm.nih.gov/pubmed/6243567)

**(1980)** [Nitrous Oxide Sedation and Sexual Phenomena](http://jada.ada.org/article/S0002-8177(80)11017-5/abstract)

**(1980)** [Neuropathy after nitrous oxide abuse.](https://www.ncbi.nlm.nih.gov/pubmed/6253695)

**(1980)** [Cobalamins and nitrous oxide: a review.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1146285/)

**(1979)** [Abuse of nitrous oxide.](https://www.ncbi.nlm.nih.gov/pubmed/571232)

**(1965)** [A history of nitrous oxide and oxygen anesthesia Part 2: Davy’s researches in relation to inhalation anesthesia](https://www.ncbi.nlm.nih.gov/pubmed/5323380)

**(1965)** [A history of nitrous oxide and oxygen anesthesia Part 1: Joseph Priestley to Humphry Davy](https://oup.silverchair-cdn.com/oup/backfile/Content_public/Journal/bja/37/10/10.1093/bja/37.10.790/2/37-10-790.pdf?Expires=1489001407&Signature=LJfbNMum2GrOdjuqIvgAfdZ855ZKxwXP6IcLwNDtlrc7wtAgMSTCOkyjuMs7u0o8kS8iJ3rjPApG7zyI9ZKhN-sl0jSgwcvw7G4lLoP4G1pwlgCcZbPazWVVyOC4L8GfYnmXPQSV9mkVMi9EveYlWT9cWk2njvIs8cKaUOLmhs2hxLON6MhL1ab4Ek~8e8bjZ6VaY0u6wNtLIX1YUINYB49o2-SVn72IqPsGpthJYf5EpAV2LJmqt1p219qD5aYfGm13UnbvuPPc0-cd3Pszto0xj~Ospj~IRUQu6NY0~398ryMrXmNsZb0AD~r-hq4-iXlQlOVyIao0vIS~pmunMg__&Key-Pair-Id=APKAIUCZBIA4LVPAVW3Q)

**(1934)** [Nitrous oxide: History and development](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2444118/)
`,
  "tripsit-factsheets": `# N2O
*Source: https://tripbot.tripsit.me/api/tripsit/getDrug/nitrous*

## Classification
- **Categories:** dissociative, habit-forming, common
- **Also known as:** laughing_gas, n20, n2o, nos
...
`,
  "tripsit-wiki": `# Nitrous Oxide

*Source: https://wiki.tripsit.me/wiki/Nitrous_Oxide*
...
- Other [Dissociatives](https://wiki.tripsit.me/wiki/Category:Dissociative).

### Interactions

Check out our [Drug Combinations](https://wiki.tripsit.me/wiki/Drug_Combinations) page and chart for interactions and combinations of Nitrous Oxide with other drugs.
...
[/r/Drugs Wiki](https://www.reddit.com/r/drugs/wiki/nitrous)`,
...
The pharmacological mechanism of action of inhaled N2O is not fully known. However, it has been shown to directly modulate a broad range of ligand-gated ion channels, which likely plays a major role. It moderately blocks NMDAR and β2-subunit-containing nACh channels, weakly inhibits AMPA, kainate, GABAC and 5-HT3 receptors, and slightly potentiates GABAA and glycine receptors. It also has been shown to activate two-pore-domain K+ channels. While N2O affects several ion channels, its anaesthetic, hallucinogenic and euphoriant effects are likely caused mainly via inhibition of NMDA receptor-mediated currents. In addition to its effects on ion channels, N2O may act similarly to nitric oxide (NO) in the central nervous system. Nitrous oxide is 30 to 40 times more soluble than nitrogen.
...
Important atmospheric properties of N2O are summarized in the following table:
...
Automotive-grade liquid nitrous oxide differs slightly from medical-grade. A small amount of sulfur dioxide (SO2) is added to prevent substance abuse.
...
In 2024, under the street name "Galaxy Gas", nitrous oxide has exploded in popularity among young people for recreational use, partially driven by TikTok trends.
...
Global accounting of N2O sources and sinks over the decade ending 2016 indicates that about 40% of the average 17 TgN/yr (teragrams, or million metric tons, of nitrogen per year) of emissions originated from human activity, and shows that emissions growth chiefly came from expanding agriculture.

Nitrous oxide has significant global warming potential as a greenhouse gas. On a per-molecule basis, considered over a 100-year period, nitrous oxide has 265 times the atmospheric heat-trapping ability of carbon dioxide (CO2). However, because of its low concentration (less than 1/1,000 of that of CO2), its contribution to the greenhouse effect is less than one third that of carbon dioxide, and also less than methane. On the other hand, since about 40% of the N2O entering the atmosphere is the result of human activity, control of nitrous oxide is part of efforts to curb greenhouse gas emissions.
