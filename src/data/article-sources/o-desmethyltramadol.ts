...
export const substanceName = "O-Desmethyltramadol";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - O-Desmethyltramadol.json","displayName":"Protest Kit","size":6786},{"id":"thedrugclassroom","fileName":"THEDRUGCLASSROOM - O-Desmethyltramadol.md","displayName":"The Drug Classroom","size":41966},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - O-Desmethyltramadol.md","displayName":"TripSit Factsheets","size":812},{"id":"wikipedia","fileName":"WIKIPEDIA - O-Desmethyltramadol.md","displayName":"Wikipedia","size":3971}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://psychonautwiki.org/wiki/O-Desmethyltramadol",
  "experiencesUrl": "https://www.reddit.com/search/?q=O-Desmethyltramadol",
  ...
  "thedrugclassroom": `# O-Desmethyltramadol (O-DSMT)
*Source: https://thedrugclassroom.com/video/o-desmethyltramadol-o-dsmt/*
...
Molecular formula: C 15 H 23 NO 2
...
[Erowid](https://erowid.org/experiences/subs/exp_ODesmethyltramadol.shtml)
...
Show Papers(Kirchheiner, 2008) – CYP2D6 status correlates with plasma levels of O-DSMT, pain reduction, and miosis.
...
Show Papers(Hull, 2006) – Cross-reactive with the PCP immunoassay, but less so than tramadol.
...
- Pretreatment with tramadol 0.1-10 μM and O-DSMT 1-10 μM significantly suppressed AITC-induced Ca 2+ increases in HEK293 cells expressing hTRPA1 and a patch-clamp study confirmed that tramadol and O-DSMT (10 μM) decreased inward cation currents induced by AITC. 
...
- Results 
- O-DSMT inhibited serotonin-evoked Ca 2+ -activated chloride currents in oocytes expressing 5-HT2C. 
...
Show Papers(Arndt, 2011) – A Krypton user tested positive for kratom alkaloids and O-DSMT.
...
Show Papers(Elkalioubie, 2011) – Near-fatal response in an ultrarapid metabolizer who overdosed
...
Show Papers- (Kronstrand, 2011) – Series of nine fatalities involving a combination of kratom alkaloids and O-DSMT, always with other drugs present. 
- Background 
...
Show Papers(Arafa, 2018) – O-DSMT generation from tramadol is associated with hepatotoxicity in long-term use
...
## References
Show ReferencesArndt, T., Claussen, U., Güssregen, B., Schröfel, S., Stürzer, B., Werle, A., & Wolf, G. (2011). Kratom alkaloids and O-desmethyltramadol in urine of a “Krypton” herbal mixture consumer. *Forensic Science International* , *208* (1–3), 47–52. https://doi.org/10.1016/j.forsciint.2010.10.025
...
Valle, M., Garrido, M. J., Pavon, J. M., Calvo, R., & Troconiz, I. F. (2000). Pharmacokinetic-pharmacodynamic modeling of the antinociceptive effects of main active metabolites of tramadol, (+)-O-desmethyltramadol and (-)-O-desmethyltramadol, in rats. *J Pharmacol Exp Ther* .`,
  "tripsit-factsheets": `# O-Desmethyltramadol
*Source: TripSit Factsheets (tripsit.me)*

## Summary

An opioid analgesic which is the main active metabolite of tramadol. The drug is a µ full agonist and has additional affinity for δ (delta) and κ-opioid receptors.

## Classification
- **Categories:** opioid, research-chemical, habit-forming, tentative, depressant
- **Also known as:** odt, o-smt, o-dsmt
...
*Note:  NOTE: Insufflation is reported to be extremely painful.*
...
*Source: https://en.wikipedia.org/wiki/Desmetramadol*

Desmetramadol (INNTooltip International Nonproprietary Name), also known as O-desmethyltramadol (O-DSMT), is an opioid analgesic and the main active metabolite of tramadol. Tramadol is demethylated by the liver enzyme CYP2D6 to desmetramadol in the same way as codeine, and so similarly to the variation in effects seen with codeine, individuals who have a less active form of CYP2D6 will tend to have reduced analgesic effects from tramadol. Because desmetramadol itself does not need to be metabolized to induce an analgesic effect, it can be used in individuals with CYP2D6 inactivating mutations.
