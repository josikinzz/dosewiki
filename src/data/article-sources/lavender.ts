...
export const substanceName = "Lavender";
export const sources = [{"id":"drugusersbible","fileName":"DRUGUSERSBIBLE - Lavender.md","displayName":"Drug Users Bible","size":1022},{"id":"wikipedia","fileName":"WIKIPEDIA - Lavender.md","displayName":"Wikipedia","size":13479}];
export const contents: Record<string, string> = {
  "drugusersbible": `# Lavender
*Source: Drug Users Bible by Dominic Milton Trott*

*Section 3.4.11 - BOTSCAPE: A Botanical Journey*

## Quick Reference
- **Binomial / Botanical Name:** Lavandula
- **Street Names:** N/A
- **Major Active Compound:** Linalool; Linalyl (Unconfirmed)
- **Indigenous Source:** Africa, Europe, Asia
- **Form:** Flowers
- **RoA:** Vaped
...
This is frequently used as a mix with cannabis, generally instead of tobacco.
However, it is occasionally reported that when smoked alone it does have a gentle
calmative effect.

Contrary to expectation, this was indeed my own experience. Although it was
certainly nothing to write home about, there was a mild relaxing edge there,
somewhere. I should stress that mild is the operative word.

SAFETY WARNING
I have encountered claims that lavender is sometimes treated with toxic chemicals by
horticulturist vendors to preserve colour/odour. Particular care should therefore be
taken with respect to sourcing.
`,
  "wikipedia": `# Lavandula
...
Spanish nard (Old French: "spykenard de spayn le pays"), referring to L. stoechas, is listed as an ingredient in making a spiced wine, namely hippocras, in The Forme of Cury.
