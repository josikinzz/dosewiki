...
export const substanceName = "Lithium";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Lithium.json","displayName":"Protest Kit","size":18223},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Lithium.md","displayName":"TripSit Factsheets","size":2820},{"id":"wikipedia","fileName":"WIKIPEDIA - Lithium.md","displayName":"Wikipedia","size":49804}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/lithium",
  "experiencesUrl": "https://www.reddit.com/search/?q=Lithium",
  "name": "Lithium",
  "aliases": [],
  "aliasesStr": "",
  "summary": null,
  ...
  "tripsit-factsheets": `# Lithium
*Source: TripSit Factsheets (tripsit.me)*

## Interactions

### ⛔ Dangerous
- **2c-t-x**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **2c-x**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **dextromethorphan**: There is a risk of serotonin syndrome when combining Lithium with DXM.
- **dmt**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **dox**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **lithium**: There is a risk of serotonin syndrome when combining Lithium with MXE, as Lithium can induce serotonin syndrome in conjunction with other serotonergic drugs, and MXE has shown a notable affinity for the serotonin transporter.
- **lsd**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **mdma**: High risk of serotonin syndrome
- **mescaline**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **mushrooms**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **mxe**: There is a risk of serotonin syndrome when combining Lithium with MXE, as Lithium can induce serotonin syndrome in conjunction with other serotonergic drugs, and MXE has shown a notable affinity for the serotonin transporter.
- **nbomes**: There are a large number of reports indicating a high seizure and psychosis risk from this combination.
- **tramadol**: Tramadol and Lithium both increase the risk of seizures and serotonin syndrome.

### ⚡ Caution
- **diphenhydramine**: There is a concern of serotonin syndrome at higher dosages of this combination. Caution is recommended in restricting diphenhydramine to medical dosages (25-50mg). Lithium and diphenhydramine both have concerns of QT prolongation which may be increased when taken in combination; risks increase due to a variety of factors such as the health of the user and drug dosages. Additionally, the combination may increase each drug's side effects, such as dizziness and loss of consciousness.

### ↓ Low Risk & Decrease
- **cocaine**: Lithium may inhibit some of the recreational effects of cocaine.

### ✓ Low Risk & No Synergy
- **ketamine**: Lithium may enhance and prolong the antidepressant effects of ketamine.
- **nitrous**: We are unable to find a report of concerns for CNS depression caused by Lithium.
- **ssris**: This interaction is used in medical settings without reported issues. If this combination is taken, caution would be recommended if any other drugs are planned to be taken on top of these that may have serotonergic activity.
`,
  "wikipedia": `# Lithium
...
Chile is estimated (2020) to have the largest reserves by far (9.2 million tonnes), and Australia the highest annual production (40,000 tonnes). One of the largest reserve bases of lithium is in the Salar de Uyuni area of Bolivia, which has 5.4 million tonnes. Other major suppliers include Argentina and China. As of 2015, the Czech Geological Survey considered the entire Ore Mountains in the Czech Republic as lithium province. Five deposits are registered, one near Cínovec is considered as a potentially economical deposit, with 160 000 tonnes of lithium. In December 2019, Finnish mining company Keliber Oy reported its Rapasaari lithium deposit has estimated proven and probable ore reserves of 5.280 million tonnes.
...
In 2019, world production of lithium from spodumene was around 80,000 t per annum, primarily from the Greenbushes pegmatite and from some Chinese and Chilean sources. The Talison mine in Greenbushes is reported to be the largest and to have the highest grade of ore at 2.4% Li2O (2012 figures).
...
In 1998, the price of lithium metal was about 95 USD/kg (or US\$43/lb). After the 2008 financial crisis, major suppliers, such as Sociedad Química y Minera (SQM), dropped lithium carbonate pricing by 20%. Prices rose in 2012. A 2012 Business Week article outlined an oligopoly in the lithium space: "SQM, controlled by billionaire Julio Ponce, is the second-largest, followed by Rockwood, which is backed by Henry Kravis's KKR & Co., and Philadelphia-based FMC", with Talison mentioned as the biggest producer.
...
The manufacturing processes of lithium, including the solvent and mining waste of particular extraction processes can present environmental and health hazards.
Lithium extraction done poorly can be fatal to aquatic life due to water pollution.  The surface brine evaporation process has been known to cause surface water contamination, drinking water contamination, respiratory problems, ecosystem degradation and landscape damage, and could lead to unsustainable water consumption in arid regions (1.9 million liters per ton of lithium), such as in northwestern Argentina.  Massive byproduct generation of evaporative surface lithium extraction also presents unsolved problems, such as large amounts of magnesium and lime waste.
...
Lithium metal is corrosive and requires special handling to avoid skin contact. Breathing lithium dust or lithium compounds (which are often alkaline) initially irritate the nose and throat, while higher exposure can cause a buildup of fluid in the lungs, leading to pulmonary edema. The metal itself is a handling hazard because contact with moisture produces the caustic lithium hydroxide. Lithium metal is safely stored in non-reactive compounds such as naphtha.
`,
};
