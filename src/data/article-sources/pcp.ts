...
export const substanceName = "PCP";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - PCP.json","displayName":"Protest Kit","size":8700},{"id":"thedrugclassroom","fileName":"THEDRUGCLASSROOM - PCP.md","displayName":"The Drug Classroom","size":1396},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - PCP.md","displayName":"TripSit Factsheets","size":2631},{"id":"wikipedia","fileName":"WIKIPEDIA - PCP.md","displayName":"Wikipedia","size":15975}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://psychonautwiki.org/wiki/PCP",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_PCP.shtml",
  "name": "PCP",
  "aliases": [
    "angel",
    "angel dust",
  ...
  "aliasesStr": "angel,angel dust,angel_dust,angeldust,boat,dust,phencyclidine,sernyl,sherman,supergrass,tic tac,wet,zoom",
  ...
  "effects": "Auditory hallucination, Auditory distortion, Geometry, Pattern recognition suppression, Thought connectivity, Double vision, Scenery slicing, Perspective distortion, Environmental cubism, Environmental orbism, Cognitive disconnection, Physical disconnection, Nausea, Dizziness, Spontaneous bodily sensations, Physical autonomy, Physical euphoria, Thought acceleration, Increased libido, Ego inflation, External hallucination, Internal hallucination, Time distortion, Déjà vu, Conceptual thinking, Delusion, Cognitive euphoria, Visual disconnection, Thought deceleration, Thought disorganization, Memory suppression, Disinhibition, Stimulation, Tactile suppression, Perception of bodily lightness, Motor control loss, Pain relief, Anxiety suppression, Creativity enhancement, Feelings of impending doom, Depersonalization, Compulsive redosing, Derealization, Suicidal ideation, Amnesia, Visual acuity suppression, Psychosis, Optical sliding, Mania, Bowel movements, Immersion intensification, Appetite intensification, Auditory acuity suppression, Visual processing deceleration, Analysis depression, Increased introspection",
  "categorized_effects": {
    "Physical effects": [
      "Nausea",
      "Dizziness",
  ...
  "thedrugclassroom": `# Phencyclidine (PCP)
*Source: https://thedrugclassroom.com/video/phencyclidine-pcp/*

Phencyclidine (PCP) is a dissociative anesthetic which entered the market ~60 years ago as a medical drug, but most of its use has occurred in other settings. It’s a member of the arylcyclohexylamine class and it functions as an NMDA antagonist and a D2 partial agonist.
...
[Erowid](https://www.erowid.org/experiences/subs/exp_PCP.shtml)
...
`,
  "tripsit-factsheets": `# PCP
*Source: TripSit Factsheets (tripsit.me)*

## Summary

A strong dissociative drug.  PCP works primarily as an NMDA receptor antagonist. It is also referred to as "wet" or "angel dust". The drug is best known for stories of  strange and sometimes violent behaviour of those under its influence, though it is likely these are only in overdose cases. Caution is recommended due to reports of mania and psychosis.

## Classification
- **Categories:** dissociative, habit-forming
- **Also known as:** angeldust, phencyclidine, angel, dust, angel_dust, wet
...
*Note:  NOTE: Caution is strongly recommended, there are a high amount of reports for the drug inducing manic episodes and or related psychosis.*
