...
export const substanceName = "Diethyl ether";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Diethyl ether.json","displayName":"Protest Kit","size":872},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Diethyl ether.md","displayName":"TripSit Factsheets","size":689},{"id":"wikipedia","fileName":"WIKIPEDIA - Diethyl ether.md","displayName":"Wikipedia","size":4156}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/diethyl-ether",
  "experiencesUrl": "https://www.erowid.org/experiences/subs/exp_Ether.shtml",
  "name": "Diethyl ether",
  "aliases": [
    "ether"
  ],
  ...
  "tripsit-factsheets": `# Diethyl ether
*Source: TripSit Factsheets (tripsit.me)*

## Summary

An industrial solvent which is sometimes used recreationally as a dissociative anaesthetic. It has a short length of action. Effects are similar to alcohol. Leaves one's breath tasting and smelling strongly of Diethyl ether for much longer than the experience lasts.

## Classification
- **Categories:** depressant, habit-forming, tentative
- **Also known as:** ether

*Note: Rapid onset and short duration.*
...
## Summary
Diethyl ether, or simply ether (abbreviated as eth. or Et2O) is an organic compound with the chemical formula (CH3CH2)2O, belonging to the ether class. It is a colourless, highly volatile, sweet-smelling (termed "ethereal odour"), extremely flammable liquid. It is a common solvent and was formerly used as a general anesthetic.
