...
export const substanceName = "Benzydamine";
export const sources = [{"id":"drugbank","fileName":"DRUGBANK - Benzydamine.md","displayName":"DrugBank","size":28212},{"id":"protestkit","fileName":"PROTESTKIT - Benzydamine.json","displayName":"Protest Kit","size":3819},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Benzydamine.md","displayName":"TripSit Factsheets","size":523},{"id":"wikipedia","fileName":"WIKIPEDIA - Benzydamine.md","displayName":"Wikipedia","size":4510}];
export const contents: Record<string, string> = {
  "drugbank": `# Benzydamine
*Source: https://go.drugbank.com/drugs/DB09084*
...
Approximately 13 h after oral administration
6
, with a terminal half life of about 7.7 h
3
.
...
6
.
The official prescribing information for benzydamine generally suggest that benzydamine mouthwashes and sprays should not be used in pregnancy
6
,
7
. Similarly, the official prescribing information for benzydamine also generally suggest that benzydamine mouthwashes and sprays should not be used during lactation unless considered essential by a physician
6
,
7
.
...
Abacavir
Benzydamine may decrease the excretion rate of Abacavir which could result in a higher serum level.
Abciximab
The risk or severity of bleeding and hemorrhage can be increased when Benzydamine is combined with Abciximab.
Acebutolol
Benzydamine may decrease the antihypertensive activities of Acebutolol.
Aceclofenac
The risk or severity of adverse effects can be increased when Aceclofenac is combined with Benzydamine.
Acemetacin
The risk or severity of adverse effects can be increased when Benzydamine is combined with Acemetacin.
...
Benzydamine
is a locally-acting NSAID indicated for the symptomatic relief of pain in acute sore throat and for the symptomatic relief of oropharyngeal mucositis caused by radiation therapy.
...
Not applicable
Singapore
DIFFLAM SOLUTION 22.5 mg/15 ml
Mouthwash
22.5 mg/15ml
Oral
INOVA PHARMACEUTICALS (SINGAPORE) PTE. LIMITED
...
Not applicable
Singapore
ดีโทรท สเปรย์ 0.3% (กลิ่นมิ้นท์)
Spray
3 mg/1ml
Oral
บริษัท อินเตอร์ไทย ฟาร์มาซูติเคิ้ล แมนูแฟคเจอริ่ง จำกัด  จำกัด
2017-12-02
Not applicable
Thailand
...
Not applicable
Turkey
ANDOREX %0.15+%0.12 SPREY, ÇÖZELTİ 30 ML
Benzydamine hydrochloride
(0.3 mg/0.2mL)
+
Chlorhexidine gluconate
...
Not applicable
Colombia
BENZIRIN® VERDE ASEPTIC. TABLETA MASTICABLE
Benzydamine hydrochloride
(3 mg)
+
Cetylpyridinium chloride
...
Electronic Medicines Compedium Difflam (Benzydamine Hydrochloride) 3% Cream Monograph [
Link
]
...
Predicted GC-MS
splash10-0006-9220000000-be226c37efcc0d490030
Predicted MS/MS Spectrum - 10V, Positive (Annotated)
Predicted LC-MS/MS
splash10-03di-1009000000-c1979aa04235f7aae62e
Predicted MS/MS Spectrum - 10V, Negative (Annotated)
Predicted LC-MS/MS
splash10-0a4i-0009000000-6dcfc71c55d35e02845f
Predicted MS/MS Spectrum - 20V, Positive (Annotated)
Predicted LC-MS/MS
splash10-03di-9038000000-3d6ea7c9003842ca7479
Predicted MS/MS Spectrum - 20V, Negative (Annotated)
Predicted LC-MS/MS
splash10-0a59-2595000000-859a510f09f6024f0999
Predicted MS/MS Spectrum - 40V, Positive (Annotated)
Predicted LC-MS/MS
splash10-0006-9010000000-43ad2972d65e3271029f
Predicted MS/MS Spectrum - 40V, Negative (Annotated)
Predicted LC-MS/MS
splash10-001i-1900000000-8c64d511b7d3a35b9c11
...
`,
  "protestkit": `{
  "url": "https://psychonautwiki.org/wiki/Benzydamine",
  "experiencesUrl": "https://www.reddit.com/search/?q=Benzydamine",
  "name": "Benzydamine",
  "aliases": [
    "tantum",
    "tantum verde"
  ],
  "aliasesStr": "tantum,tantum verde",
  ...
  "roas": [
    {
      ...
      "duration": [
        ...
        {
          "name": "After effects",
          "value": "24.0 - 72.0 hours"
        }
      ]
    }
  ],
  "interactions": null,
  "effects": "Auditory hallucination, Auditory distortion, Geometry, Pattern recognition suppression, Double vision, Vibrating vision, Visual haze, Object alteration, Dehydration, Frequent urination, Dizziness, Thought acceleration, External hallucination, Autonomous entity, Settings, sceneries, and landscapes, Shadow people, Time distortion, Scenarios and plots, Delusion, Cognitive euphoria, Depression, Anxiety, Paranoia, Stimulation, Wakefulness, Tactile suppression, Motor control loss, Drifting, Increased heart rate, Peripheral information misinterpretation, After images, Feelings of impending doom, Abnormal heartbeat, Delirium, Unspeakable horrors, Gustatory hallucination, Visual acuity suppression, Psychosis, Object activation, Perspective hallucination",
  "categorized_effects": {
    "Physical effects": [
      "vasoconstriction",
  ...
  "tripsit-factsheets": `# Benzydamine
...
## Classification
- **Categories:** deliriant, tentative, stimulant
...
*Source: https://en.wikipedia.org/wiki/Benzydamine*
...
Benzydamine has been used recreationally. If taken in excess amounts, it acts as a deliriant and CNS stimulant. Such use, particularly among teenagers, has been reported in Brazil, Poland, Romania, and Turkey.
