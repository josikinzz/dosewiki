...
export const substanceName = "MDPHP";
export const sources = [{"id":"thedrugclassroom","fileName":"THEDRUGCLASSROOM - MDPHP.md","displayName":"The Drug Classroom","size":18294}];
export const contents: Record<string, string> = {
  "thedrugclassroom": `# MDPHP
*Source: https://thedrugclassroom.com/video/mdphp/*

MDPHP is a stimulant in the cathinone and pyrovalerone classes, making it structurally similar to α-PVP, α-PHP, and MDPV. It has a very limited history of use, having shown up primarily in Europe in the mid-2010s. There’s reason to believe the purity and content of MDPHP batches has been highly variable, sometimes involving other cathinones being sold as it, which makes it harder to characterize its effects.
...
There’s a small amount of evidence demonstrating alleged “MDPHP” batches are actually other substances or a combination of drugs. This is not surprising considering the nature of the cathinone market, which often sources from Chinese manufacturers of questionable reliability. A [sample](https://www.ecstasydata.org/view.php?id=5268) sent to EcstasyData was shown to contain a different cathinone, 3′,4′-Methylenedioxy-N-tert-butylcathinone (MDPT), and the differences between batches that are described by users indicate purity issues and misrepresentation are common.
...
Show Papers(Adamowicz, 2018) – A fetal death associated with MDPHP and α-PHP.
...
## References
Show ReferencesAdamowicz, P., & Hydzik, P. (2019). Fetal death associated with the use of 3,4-MDPHP and α-PHP. *Clinical Toxicology* , *57* (2), 112–116. https://doi.org/10.1080/15563650.2018.1502443
