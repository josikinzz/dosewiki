...
export const substanceName = "Propoxyphene";
export const sources = [{"id":"protestkit","fileName":"PROTESTKIT - Propoxyphene.json","displayName":"Protest Kit","size":3447},{"id":"tripsit-factsheets","fileName":"TRIPSIT_FACTSHEETS - Propoxyphene.md","displayName":"TripSit Factsheets","size":553},{"id":"wikipedia","fileName":"WIKIPEDIA - Propoxyphene.md","displayName":"Wikipedia","size":16957}];
export const contents: Record<string, string> = {
  "protestkit": `{
  "url": "https://drugs.tripsit.me/propoxyphene",
  "experiencesUrl": "https://www.reddit.com/search/?q=Propoxyphene",
  "name": "Propoxyphene",
  "aliases": [],
  "aliasesStr": "",
  ...
  "tripsit-factsheets": `# Propoxyphene
*Source: TripSit Factsheets (tripsit.me)*

## Summary

The drug is an analgesic in the opioid family. It is intended for mild pain and for its antitussive effects. The drug has been taken off the market in Europe and the US due to concerns of fatal overdoses and heart arrhythmias.
...
*Source: https://en.wikipedia.org/wiki/Dextropropoxyphene*
